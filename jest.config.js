...
module.exports = {
    ...
    coverageThreshold: {
        global: {
            ...
            // dropping the remaining Jest aggregate. Re-measured after merging develop with this branch; floors set
            // just below the measured global averages (statements ~81.7, lines ~83.4, functions ~67.8, branches ~76.2).
            statements: 81.2,
            branches: 72.9,
            functions: 67.3,
            lines: 82.9,
