...
module.exports = {
    ...
    collectCoverageFrom: [
        ...
        '!<rootDir>/src/main/webapp/app/shared/monaco-editor/inline-refinement-button/inline-refinement-button.component.ts', // inline-refinement-button uses Vitest (see vitest.config.ts)
    ...
    testPathIgnorePatterns: [
        ...
        '<rootDir>/src/main/webapp/app/shared/monaco-editor/inline-refinement-button/inline-refinement-button.component.spec.ts',
