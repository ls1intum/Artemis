...
module.exports = {
    ...
    collectCoverageFrom: [
        ...
        '!<rootDir>/src/main/webapp/app/ui/table-view/**', // table view module uses Vitest (see vitest.config.ts)
        '!<rootDir>/src/main/webapp/app/ui/components/buttons/**', // buttons module uses Vitest (see vitest.config.ts)
        ...
        '!<rootDir>/src/main/webapp/app/ui/search-filter/**', // search-filter component uses Vitest (see vitest.config.ts)
    ...
    coveragePathIgnorePatterns: [
        ...
        '<rootDir>/src/main/webapp/app/ui/components/buttons/', // buttons module uses Vitest
        ...
        '<rootDir>/src/main/webapp/app/ui/search-filter/', // search-filter uses Vitest
    ...
    testPathIgnorePatterns: [
        ...
        '<rootDir>/src/main/webapp/app/ui/components/buttons/', // shared/buttons components
        '<rootDir>/src/main/webapp/app/ui/table-view/', // shared/table-view component
        ...
        '<rootDir>/src/main/webapp/app/ui/search-filter/', // search-filter (Vitest)
