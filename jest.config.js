...
module.exports = {
    ...
    coveragePathIgnorePatterns: [
        ...
        '<rootDir>/src/main/webapp/app/core/account/', // account module uses Vitest
    ],
    ...
    testPathIgnorePatterns: ['<rootDir>/src/main/webapp/app/fileupload/', '<rootDir>/src/main/webapp/app/core/account/'],
    testTimeout: 3000,
    testMatch: [
