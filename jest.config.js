...
module.exports = {
    ...
    coverageThreshold: {
        global: {
            statements: 83,
            branches: 72.9,
            functions: 71.7, // lowered 72.5 -> 72.2 (#12817 logos/sharing/app-shell) -> 71.7: foundation Jest->Vitest migration moved 41 specs out of Jest scope; measured actual 72.22%, ~0.5pp below per convention; take minimum of in-flight thresholds
            lines: 84,
        },
    },
