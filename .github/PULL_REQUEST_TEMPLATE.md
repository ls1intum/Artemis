...
- [ ] Following the [theming guidelines](https://docs.artemis.ase.in.tum.de/dev/guidelines/client-design/), I did not specify colors anywhere other than the theming variable files and checked that the changes look consistent in both the light and the dark theme.
