...
- [ ] Client: I translated all the newly inserted strings into English and German using neutral, gender-inclusive language (for further instructions read the [guidlines for inclusive, diversity-sensitive, and appreciative language](https://artemis-platform.readthedocs.io/en/latest/dev/guidelines/language-guidelines.html))
