...
# Reduced timeouts for local execution (33% of CI values for faster feedback)
export TEST_TIMEOUT_SECONDS="${TEST_TIMEOUT_SECONDS:-100}"
export TEST_RETRIES="${TEST_RETRIES:-1}"
export TEST_WORKER_PROCESSES="${TEST_WORKER_PROCESSES:-2}"
export SLOW_TEST_TIMEOUT_SECONDS="${SLOW_TEST_TIMEOUT_SECONDS:-100}"
export FAST_TEST_TIMEOUT_SECONDS="${FAST_TEST_TIMEOUT_SECONDS:-20}"
# Custom timeouts for page objects and commands (33% of CI defaults)
export BUILD_RESULT_TIMEOUT_MS="${BUILD_RESULT_TIMEOUT_MS:-30000}"    # CI: 90000
export BUILD_FINISH_TIMEOUT_MS="${BUILD_FINISH_TIMEOUT_MS:-20000}"    # CI: 60000
export EXAM_DASHBOARD_TIMEOUT_MS="${EXAM_DASHBOARD_TIMEOUT_MS:-20000}" # CI: 60000
