...
Details regarding the scaling of Artemis can be found in the `corresponding section of the documentation <https://ls1intum.github.io/Artemis/admin/production-setup/multiple-artemis-instances>`_.
