...
- **Enable complaints**: Whether complaints should be enabled in this course. More information can be found `here <https://ls1intum.github.io/Artemis/instructor/assessment#handling-complaints>`__.
- **Enable more feedback requests**: Whether more feedback requests should be enabled in this course. More information can be found `here <https://ls1intum.github.io/Artemis/instructor/assessment#more-feedback-requests>`__.
