...
They can also then link exercises and lecture units to competencies and define competency relations. These relations determine the basic order of content for the students' learning paths.
