...
- Within the second correction round review instructors and tutors can highlight which feedback was created for which correction round. The enabel this be a button at the top of the review page. This is displayed as a badge at the bottom of every feedback. This view can be enabled or disabled any time during a second correction round review. The feature is currently available for text, modeling and fileupload exercises.
