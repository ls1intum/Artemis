...
- Within the second correction round assessment instructors and tutors can highlight which feedback was created for which correction round. This is displayed as a batch at the bottom of every feedback. This view can be enabled or disabled any time during a second correction round assessment. The feature is currently possible for text, modeling and fileupload exercises.
