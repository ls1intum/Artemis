...
This section describes how to set up a programming exercise environment based on Integrated Code Lifecycle which includes a local Version Control system and a local Continuous Integration system.
