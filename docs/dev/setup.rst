...
* **Artems (Server, LocalVC & LocalCI):** The server will be started separated from the client with the profiles ``dev,jira,localci,localvc,artemis`` instead of ``dev,bamboo,bitbucket,jira,artemis``.
