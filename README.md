...
```shell
java -jar build/libs/*.war --spring.profiles.active=dev,artemis,localci,localvc,core
```
...
```shell
./artemis-server-cli deploy username@artemistest.ase.in.tum.de -w build/libs/Artemis-6.9.2.war
```
