...
public record UpdateFileUploadExerciseDTO(long id, String title, @Nullable String channelName, @Nullable String shortName, @Nullable String problemStatement,
        ...
        @Nullable Boolean presentationScoreEnabled, @Nullable Boolean allowTutorScoreRowActions, @Nullable Boolean secondCorrectionEnabled,
        @Nullable String feedbackSuggestionModule, @Nullable String gradingInstructions, @Nullable ZonedDateTime releaseDate, @Nullable ZonedDateTime startDate,
