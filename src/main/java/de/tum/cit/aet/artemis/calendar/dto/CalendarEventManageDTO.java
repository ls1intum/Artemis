...
public record CalendarEventManageDTO(@Nullable String id, @NotNull(message = "Calendar events must have a title.") String title, @Nullable String courseName,
    ...
    public CalendarEventManageDTO(CourseCalendarEvent event) {
