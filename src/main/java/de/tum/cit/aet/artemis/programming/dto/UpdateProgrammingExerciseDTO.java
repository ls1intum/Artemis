...
public record UpdateProgrammingExerciseDTO(
        ...
        Boolean secondCorrectionEnabled, String feedbackSuggestionModule, ExerciseAthenaConfigDTO athenaConfig, String gradingInstructions,
    ...
    public static UpdateProgrammingExerciseDTO of(ProgrammingExercise exercise) {
        ...
        ExerciseAthenaConfigDTO athenaConfigDTO = exercise.getAthenaConfig() != null && Hibernate.isInitialized(exercise.getAthenaConfig())
        ...
        return new UpdateProgrammingExerciseDTO(exercise.getId(), exercise.getTitle(), exercise.getChannelName(), exercise.getShortName(), exercise.getProblemStatement(),
                ...
                exercise.getSecondCorrectionEnabled(), exercise.getFeedbackSuggestionModule(), athenaConfigDTO, exercise.getGradingInstructions(), exercise.getReleaseDate(),
