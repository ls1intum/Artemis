...
public record ExamUpdateDTO(@Nullable Long id, @NotNull String title, @NotNull ExamType examType, boolean examWithAttendanceCheck, @NotNull ZonedDateTime visibleDate,
