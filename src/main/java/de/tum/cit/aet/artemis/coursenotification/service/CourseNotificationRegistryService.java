...
import de.tum.cit.aet.artemis.coursenotification.annotations.CourseNotificationType;
...
public class CourseNotificationRegistryService {
     ...
     * with {@link CourseNotificationType} in the {@code coursenotification.domain.notifications} directory. The
    ...
    public CourseNotificationRegistryService() {
        ...
        String basePackage = "de.tum.cit.aet.artemis.coursenotification.domain.notifications";
