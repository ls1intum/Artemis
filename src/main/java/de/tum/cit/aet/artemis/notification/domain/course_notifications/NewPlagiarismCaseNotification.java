...
import de.tum.cit.aet.artemis.notification.dto.payload.NewPlagiarismCasePayload;
...
public class NewPlagiarismCaseNotification extends CourseNotification {
    ...
    private final NewPlagiarismCasePayload payload;
    ...
    public NewPlagiarismCaseNotification(Long courseId, String courseTitle, String courseImageUrl, Long exerciseId, String exerciseTitle, String exerciseType,
        ...
        this.payload = new NewPlagiarismCasePayload(exerciseId, exerciseTitle, exerciseType, postMarkdownContent, examId);
    }
    ...
    public NewPlagiarismCaseNotification(Long notificationId, Long courseId, ZonedDateTime creationDate, Map<String, String> parameters) {
        ...
        this.payload = CourseNotificationPayloads.parse(parameters, NewPlagiarismCasePayload.class);
    }
    ...
    @Override
    public NewPlagiarismCasePayload payload() {
        return payload;
    }
}
