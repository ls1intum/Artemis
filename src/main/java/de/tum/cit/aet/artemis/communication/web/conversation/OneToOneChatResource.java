...
public class OneToOneChatResource extends ConversationManagementResource {
    ...
    /**
     * POST /api/communication/courses/:courseId/one-to-one-chats/: Starts a new one to one chat in a course
     *
    ...
    /**
     * POST /api/communication/courses/:courseId/one-to-one-chats/:userId: Starts a new one to one chat in a course
     *
     * @param courseId the id of the course
