...
public record ImportTextExerciseDTO(Long id, String title, String channelName, String shortName, String problemStatement, Set<String> categories, DifficultyLevel difficulty,
        ...
        Boolean allowFeedbackRequests, Boolean presentationScoreEnabled, Boolean allowTutorScoreRowActions, Boolean secondCorrectionEnabled, String feedbackSuggestionModule,
        ...
        ZonedDateTime exampleSolutionPublicationDate, String exampleSolution, Long courseId, Long exerciseGroupId, TeamAssignmentConfigDTO teamAssignmentConfig,
    ...
    public static ImportTextExerciseDTO of(TextExercise exercise) {
        ...
        return new ImportTextExerciseDTO(exercise.getId(), exercise.getTitle(), exercise.getChannelName(), exercise.getShortName(), exercise.getProblemStatement(),
                ...
                exercise.getExampleSolution(), courseId, exerciseGroupId, teamAssignmentConfig, plagiarismDetectionConfig, gradingCriterionDTOs, competencyLinkDTOs);
    }
}
