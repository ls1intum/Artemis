...
public class AthenaFeedbackSuggestionsService {
    ...
    // TODO: This functionality should be moved to submission repository
     ...
     */
    // TODO: This functionality should be moved to learner profile service/repository
    ...
    public List<TextFeedbackDTO> getTextFeedbackSuggestions(TextExercise exercise, TextSubmission submission, boolean isGraded) throws NetworkingException {
        ...
        log.info("--------------------------------");
        log.info("--------------------------------");
        log.info("Course Competencies: {}", competencies);
        log.info("--------------------------------");
        log.info("--------------------------------");
