 ...
 */
public record PresentationAssessmentInstanceDTO(Long id, @NotNull ZonedDateTime presentationDate, @PositiveOrZero @DecimalMax("10000") Double resultPoints,
        @NotEmpty List<String> studentLogins, @Size(max = 10) String language, PresentationAssessmentMode mode, @Size(max = 255) String location,
        @Size(max = 1000) String meetingLink, @Size(max = 1000) String remark) {
    ...
    public static PresentationAssessmentInstanceDTO of(PresentationAssessmentInstance instance) {
        return new PresentationAssessmentInstanceDTO(instance.getId(), instance.getPresentationDate(), instance.getResultPoints(),
                ...
                instance.getMeetingLink(), instance.getRemark());
    }
}
