...
public record Result(String ruleId, Integer ruleIndex, ReportingDescriptorReference rule, de.tum.cit.aet.artemis.localci.service.scaparser.format.sarif.Result.Kind kind,
        Level level, Message message, List<Location> locations) {
