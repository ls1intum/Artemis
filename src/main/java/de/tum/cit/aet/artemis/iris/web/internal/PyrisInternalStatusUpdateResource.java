...
public class PyrisInternalStatusUpdateResource {
     ...
     * timestamp
     * in the combined view) and return synchronously whether it was carried out. The call blocks until the client acknowledges or a timeout elapses, so the Pyris agent tool learns
     * the real outcome before formulating its answer.
     * <p>
     * Uses custom token based authentication.
     *
     * @param runId   the ID of the job
