...
import de.tum.cit.aet.artemis.notification.dto.UserCourseNotificationSettingPresetDTO;
...
public class CourseNotificationSettingPresetRegistryService {
    ...
    public CourseNotificationSettingPresetRegistryService() {
        ...
        String basePackage = UserCourseNotificationSettingPreset.class.getPackageName();
