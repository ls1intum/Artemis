 ...
 * ({@link AgentSystemPrompt#buildStage(de.tum.cit.aet.artemis.hyperion.service.worker.toolchain.javagradle.GenerationInput, GenerationStage)}). The orchestrator runs the stages in
 * this
