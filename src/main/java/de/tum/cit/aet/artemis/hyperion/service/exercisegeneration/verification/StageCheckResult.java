 ...
 *                        the executable-build differential self-check observation, or a legacy TEMPLATE stage noting it correctly fails its tests) — empty when there is nothing to
 *                        add
