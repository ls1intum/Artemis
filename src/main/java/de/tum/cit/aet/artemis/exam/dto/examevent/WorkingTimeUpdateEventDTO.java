...
public record WorkingTimeUpdateEventDTO(Long id, Instant createdDate, int newWorkingTime, int oldWorkingTime, boolean courseWide, Instant newStartDate, Instant newEndDate)
