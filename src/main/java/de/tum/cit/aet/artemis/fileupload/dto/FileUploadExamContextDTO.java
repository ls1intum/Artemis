...
public record FileUploadExamContextDTO(Long id, @Nullable FileUploadCourseContextDTO course) {
     ...
     */
    public static @Nullable FileUploadExamContextDTO of(@Nullable Exam exam) {
        if (exam == null) {
            return null;
        }
