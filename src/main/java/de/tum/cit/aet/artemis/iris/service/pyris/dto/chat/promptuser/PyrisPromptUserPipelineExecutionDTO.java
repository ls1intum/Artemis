...
public record PyrisPromptUserPipelineExecutionDTO(IrisChatMode chatMode, List<PyrisMessageDTO> chatHistory, PyrisPipelineExecutionSettingsDTO settings,
        @Nullable String sessionTitle, PyrisUserDTO user, PyrisCourseDTO course, PyrisProgrammingExerciseDTO exercise, PyrisSubmissionDTO submission, int minQuestions,
