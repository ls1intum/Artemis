...
public record ExerciseUpdatedPayload(Long exerciseId, String exerciseTitle, Long examId, Long exerciseGroupId, String exerciseType) implements CourseNotificationPayload {
}
