...
public class MailService {
    ...
    public void sendSuccessfulDataExportsEmailToAdmin(MailRecipientDTO admin, String templateName, String titleKey, Set<DataExportEmailDTO> dataExports) {
     ...
     */
    public void sendDataExportFailedEmailToAdmin(MailRecipientDTO admin, DataExportEmailDTO dataExport, Exception reason) {
        ...
        prepareTemplateAndSendEmailWithArgumentInSubject(admin, "mail/dataExportFailedAdminEmail", "email.dataExportFailedAdmin.title", dataExport.userLogin(), context);
    }
     ...
     *
     * @param admin      the admin user to notify
     * @param dataExport the data export whose notification email failed
     * @param reason     the exception that caused the failure
     */
    public void sendDataExportEmailFailedEmailToAdmin(MailRecipientDTO admin, DataExportEmailDTO dataExport, Exception reason) {
        log.debug("Sending data export email failed email to admin email address '{}'", admin.email());
        Locale locale = Locale.forLanguageTag(admin.langKey());
        Context context = createBaseContext(admin, locale);
        context.setVariable(DATA_EXPORT, dataExport);
        context.setVariable(REASON, reason.getMessage());
        prepareTemplateAndSendEmailWithArgumentInSubject(admin, "mail/dataExportEmailFailedAdminEmail", "email.dataExportEmailFailedAdmin.title", dataExport.userLogin(), context);
    }
     ...
     */
    public void sendDataExportCreatedEmail(MailRecipientDTO recipient, DataExportEmailDTO dataExport) {
    ...
    public void sendSuccessfulDataExportsEmailToAdmin(MailRecipientDTO admin, Set<DataExportEmailDTO> dataExports) {
