...
public record QuizExerciseForCourseDTO(long id, @NotEmpty String title, boolean quizStarted, boolean quizEnded, boolean isEditable, int duration, double maxPoints,
        ...
        @Nullable Set<QuizBatchForCourseDTO> quizBatches, @NotNull QuizMode quizMode, Set<String> categories, boolean hasDragAndDropQuestions) {
     ...
     * @param hasDragAndDropQuestions Whether the quiz contains at least one drag-and-drop question
     * @return The converted QuizExerciseForCourseDTO
     */
    public static QuizExerciseForCourseDTO of(QuizExercise quizExercise, boolean isEditable, boolean hasDragAndDropQuestions) {
        return of(quizExercise, isEditable, quizExercise.isQuizEnded(), hasDragAndDropQuestions);
    }
     ...
     * @return The converted QuizExerciseForCourseDTO
     */
    public static QuizExerciseForCourseDTO of(QuizExercise quizExercise, boolean isEditable, boolean effectiveQuizEnded, boolean hasDragAndDropQuestions) {
        ...
        return new QuizExerciseForCourseDTO(quizExercise.getId(), quizExercise.getTitle(), quizExercise.isQuizStarted(), effectiveQuizEnded, isEditable, quizExercise.getDuration(),
                ...
                batches, quizExercise.getQuizMode(), quizExercise.getCategories(), hasDragAndDropQuestions);
    }
}
