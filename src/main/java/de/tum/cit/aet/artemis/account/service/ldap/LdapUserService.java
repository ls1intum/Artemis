...
public class LdapUserService {
    ...
    public LdapUserService(LdapUserRepository ldapUserRepository, UserCreationService userCreationService) {
     ...
     */
    public void syncUserDetails(User user, LdapUserDto ldapUserDto) {
        if (ldapUserDto != null) {
