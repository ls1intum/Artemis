...
public record QuizQuestionGenerationRequestDTO(@NotBlank @Size(max = 500) @Schema(description = "Main topic for the generated quiz") String topic,
        ...
        @NotNull @Schema(description = "Target language for the generated quiz") QuizQuestionGenerationLanguageDTO language,
        @NotEmpty @Schema(description = "Question types to include") Set<@NotNull QuizQuestionGenerationTypeDTO> questionTypes,
