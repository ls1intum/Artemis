...
/**
 * The gaps between the instructor's brief and the produced tests — the quality axes the differential oracle (the differential verifier) is structurally blind to.
 * <p>
...
public record SpecFidelityReport(@JsonInclude List<Finding> findings) {

    public SpecFidelityReport {
