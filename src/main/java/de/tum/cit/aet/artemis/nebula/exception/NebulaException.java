...
public class NebulaException extends HttpStatusException {
    ...
    public NebulaException(String defaultMessage, Status status, String entityName, String translationKey, Map<String, Object> translationParams) {
