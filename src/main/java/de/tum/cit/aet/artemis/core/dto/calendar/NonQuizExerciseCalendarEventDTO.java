...
public record NonQuizExerciseCalendarEventDTO(@NotNull long originEntityId, @NotNull CalendarEventRelatedEntity type, @NotNull String title, @Nullable ZonedDateTime releaseDate,
