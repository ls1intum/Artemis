...
public record IrisDashboardOverviewDTO(long totalSessions, long activeSessions, double engagementRate, long totalMessages, long uniqueUsers, double noResponseRate,
        ...
        long sessionsWithThumbsUp, long sessionsWithThumbsDown, double avgResponseTimeSeconds, double p50ResponseTimeSeconds, double p95ResponseTimeSeconds,
        double totalTokenCostEur) {
}
