...
public enum UserDeletionReferencePolicy {
    ...
    EXERCISE_VERSION_AUTHOR("exercise_version", "author_id", UserDeletionDataCategory.ASSESSMENT, UserDeletionAction.PRESERVE_RECOVERY, true),
    HYPERION_AUTHORING_OWNER("hyperion_authoring_run", "owner_id", UserDeletionDataCategory.ASSESSMENT, UserDeletionAction.DETACH_ACTOR, true),
