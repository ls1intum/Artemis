...
public enum UserDeletionReferencePolicy {
    ...
    COMPETENCY_JUDGEMENT("competency_jol", "user_id", UserDeletionDataCategory.LEARNING_ANALYTICS, UserDeletionAction.DELETE, true),
    ...
    EXERCISE_VERSION_AUTHOR("exercise_version", "author_id", UserDeletionDataCategory.ASSESSMENT, UserDeletionAction.DETACH_ACTOR, true),
    ...
    SUBMISSION_VERSION_AUTHOR("submission_version", "author_id", UserDeletionDataCategory.ASSESSMENT, UserDeletionAction.DETACH_ACTOR, true),
    ...
    EXTERNAL_GROUP("user_groups", "user_id", UserDeletionDataCategory.ACCOUNT, UserDeletionAction.REMOVE_MEMBERSHIP, false),
