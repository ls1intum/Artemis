...
@Configuration
@Lazy
@EnableJpaRepositories(basePackages = { "de.tum.cit.aet.artemis.account.repository", "de.tum.cit.aet.artemis.assessment.repository", "de.tum.cit.aet.artemis.atlas.repository",
        ...
        "de.tum.cit.aet.artemis.text.repository", "de.tum.cit.aet.artemis.tutorialgroup.repository",
        "de.tum.cit.aet.artemis.deimos.repository" }, repositoryBaseClass = RepositoryImpl.class)
