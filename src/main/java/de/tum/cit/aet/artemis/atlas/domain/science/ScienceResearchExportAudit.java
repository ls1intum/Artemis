...
@AggregateRoot("Immutable audit record of a research export. It outlives every course and event it describes, which is the point: the record of who exported what, and why, has to survive the data being deleted.")
@Entity
