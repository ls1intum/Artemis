...
public class TutorialGroupFreePeriodResource {
    ...
    public ResponseEntity<TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO> getOneOfConfiguration(@PathVariable Long courseId, @PathVariable Long tutorialGroupsConfigurationId,
        ...
        return ResponseEntity.ok(TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO.from(freePeriod));
    }
    ...
    @EnforceAtLeastInstructor
    public ResponseEntity<TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO> update(@PathVariable Long courseId, @PathVariable Long tutorialGroupsConfigurationId,
        ...
        return ResponseEntity.ok(TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO.from(updatedFreePeriod));
    }
    ...
    @EnforceAtLeastInstructor
    public ResponseEntity<TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO> create(@PathVariable Long courseId, @PathVariable Long tutorialGroupsConfigurationId,
        ...
        return ResponseEntity.created(new URI("/api/tutorialgroup/courses/" + courseId + "/tutorial-groups-configuration/" + tutorialGroupsConfigurationId
                ...
                .body(TutorialGroupResponseDTO.TutorialGroupFreePeriodDTO.from(persistedTutorialGroupFreePeriod));
    }
