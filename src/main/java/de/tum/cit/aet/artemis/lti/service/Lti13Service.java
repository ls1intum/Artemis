...
public class Lti13Service {
    ...
    public Lti13Service(UserRepository userRepository, ExerciseRepository exerciseRepository, Optional<LectureApi> lectureApi, CourseRepository courseRepository,
