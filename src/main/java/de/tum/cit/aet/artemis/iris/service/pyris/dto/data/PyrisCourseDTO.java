...
/**
 * A unified course DTO for Pyris containing both basic and extended course information.
 * Extended fields (exercises, exams, competencies, etc.) are nullable and only populated
 * when the full course context is needed (e.g. course chat).
 */
