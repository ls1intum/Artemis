 ...
 *                                         from the sandbox
 * @param producedTestPlan             test-plan.json captured with the produced repository files; {@code null} only for tests and callers without an approved specification
