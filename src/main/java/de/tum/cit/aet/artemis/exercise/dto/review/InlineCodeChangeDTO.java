...
public record InlineCodeChangeDTO(@Schema(description = "First line number (inclusive) of the replacement range.") @NotNull Integer startLine,
        ...
        @Schema(description = "Code expected in the replacement range before applying the change.") @NotBlank @Size(max = 10000) String expectedCode,
        @Schema(description = "Code that replaces the expected code within the range.") @NotBlank @Size(max = 10000) String replacementCode,
