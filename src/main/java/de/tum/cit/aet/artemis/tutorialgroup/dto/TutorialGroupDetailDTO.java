...
public record TutorialGroupDetailDTO(@NotNull Long id, @NotNull String title, @NotNull String language, @NotNull Boolean isOnline, @NotNull String tutorName,
    ...
    public static TutorialGroupDetailDTO from(RawTutorialGroupDTO rawDto, List<TutorialGroupSessionDTO> sessions, Long tutorChatId) {
        return new TutorialGroupDetailDTO(rawDto.groupId(), rawDto.title(), rawDto.language(), rawDto.isOnline(), rawDto.tutorName(), rawDto.tutorLogin(), rawDto.tutorId(),
