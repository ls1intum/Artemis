...
public enum FilePathType {
    ...
    SLIDE,
    TEMPORARY, DRAG_AND_DROP_BACKGROUND, DRAG_ITEM, PROFILE_PICTURE, COURSE_ICON, EXAM_USER_SIGNATURE, EXAM_ATTENDANCE_CHECK_STUDENT_IMAGE,
    ...
    FILE_UPLOAD_SUBMISSION, ATTACHMENT_UNIT
}
