package de.tum.cit.aet.artemis.localvc.web.ssh;
...
import de.tum.cit.aet.artemis.localvc.config.LocalVCLegacyRestPaths;
...
@Lazy
@RestController
@RequestMapping({ "api/localvc/", LocalVCLegacyRestPaths.PROGRAMMING_PREFIX })
