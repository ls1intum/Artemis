...
public record GlobalSearchLectureRequestDTO(@NotBlank String query, @Min(1) @Max(20) int limit, @Nullable List<Long> courseIds, @Nullable List<Long> excludeCourseIds) {
}
