...
public record MultipleChoiceSubmittedAnswerWithSolutionDTO(Set<AnswerOptionWithSolutionDTO> selectedOptions) {
    ...
    public static MultipleChoiceSubmittedAnswerWithSolutionDTO of(MultipleChoiceSubmittedAnswer multipleChoiceSubmittedAnswer) {
        return new MultipleChoiceSubmittedAnswerWithSolutionDTO(
                multipleChoiceSubmittedAnswer.getSelectedOptions().stream().map(AnswerOptionWithSolutionDTO::of).collect(Collectors.toSet()));
    }
