package de.tum.cit.aet.artemis.core.service.connectors.gitlab;
...
import de.tum.cit.aet.artemis.core.service.connectors.vcs.VcsTokenManagementService;
...
public class GitLabUserManagementService implements VcsUserManagementService {
    ...
    public void updateCoursePermissions(Course updatedCourse, String oldInstructorGroup, String oldEditorGroup, String oldTeachingAssistantGroup) {
        ...
        final Set<User> allUsers = userRepository.findAllWithGroupsAndAuthoritiesByIsDeletedIsFalseAndGroupsContains(oldInstructorGroup);
