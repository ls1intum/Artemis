...
public record CalendarEventReadDTO(@Nullable String id, @NotNull String title, @NotNull String courseName, @NotNull ZonedDateTime startDate, @Nullable ZonedDateTime endDate,
        @Nullable String location, @Nullable String facilitator) {

    public CalendarEventReadDTO(TutorialGroupSession session, ZoneId clientTimeZone) {
    ...
    public CalendarEventReadDTO(CourseCalendarEvent courseCalendarEvent, ZoneId clientTimeZone) {
