package de.tum.cit.aet.artemis.localci.service.ci.notification.dto;
...
import de.tum.cit.aet.artemis.localci.service.ci.notification.BuildLogParseUtils;
...
public record TestResultsDTO(@JsonProperty("successful") int successful, @JsonProperty("skipped") int skipped, @JsonProperty("errors") int errors,
    ...
    public static TestResultsDTO convert(Object someResult) {
        return JsonObjectMapper.get().convertValue(someResult, TestResultsDTO.class);
    }
