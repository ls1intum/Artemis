...
import static de.tum.cit.aet.artemis.web.websocket.ResultWebsocketService.getExerciseIdFromNonPersonalExerciseResultDestination;
import static de.tum.cit.aet.artemis.web.websocket.ResultWebsocketService.isNonPersonalExerciseResultDestination;
import static de.tum.cit.aet.artemis.web.websocket.localci.LocalCIWebsocketMessagingService.isBuildAgentDestination;
import static de.tum.cit.aet.artemis.web.websocket.localci.LocalCIWebsocketMessagingService.isBuildQueueAdminDestination;
import static de.tum.cit.aet.artemis.web.websocket.localci.LocalCIWebsocketMessagingService.isBuildQueueCourseDestination;
import static de.tum.cit.aet.artemis.web.websocket.team.ParticipationTeamWebsocketService.getParticipationIdFromDestination;
import static de.tum.cit.aet.artemis.web.websocket.team.ParticipationTeamWebsocketService.isParticipationTeamDestination;
...
import de.tum.cit.aet.artemis.validation.InetSocketAddressValidator;
