...
/**
 * A unified PyrisJob for all Iris chat sessions (exercise, text exercise, course, lecture).
 * Replaces the four separate job types: ExerciseChatJob, TextExerciseChatJob, CourseChatJob, LectureChatJob.
 */
