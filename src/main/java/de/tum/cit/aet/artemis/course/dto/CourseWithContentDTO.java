...
public record CourseWithContentDTO(@JsonUnwrapped CourseManagementDTO course, @JsonIgnoreProperties("course") Set<CourseManagementExerciseDTO> exercises,
        Set<LectureForCourseManagementDTO> lectures, Set<CourseCompetencyResponseDTO> competencies, Set<CoursePrerequisiteDTO> prerequisites) {
