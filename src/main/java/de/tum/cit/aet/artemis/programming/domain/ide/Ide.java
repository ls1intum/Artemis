package de.tum.cit.aet.artemis.programming.domain.ide;
...
public class Ide extends DomainObject {
    ...
    public static Ide[] PREDEFINED_IDES = { new Ide("VS Code", "vscode://vscode.git/clone?url={cloneUrl}"),
                                            new Ide("Cursor", "cursor://vscode.git/clone?url={cloneUrl}"),
                                            ...
                                            new Ide("CLion", "jetbrains://clion/checkout/git?idea.required.plugins.id=Git4Idea&checkout.repo={cloneUrl}"),
                                            new Ide("XCode", "xcode://clone?repo={cloneUrl}"), };
}
