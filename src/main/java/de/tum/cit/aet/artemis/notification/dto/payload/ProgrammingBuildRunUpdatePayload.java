...
public record ProgrammingBuildRunUpdatePayload(Long exerciseId, String exerciseTitle, Long examId, Long exerciseGroupId) implements CourseNotificationPayload {
}
