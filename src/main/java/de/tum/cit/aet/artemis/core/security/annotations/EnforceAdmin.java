...
/**
 * This annotation is used to enforce that the user is an admin authenticated with a passkey.
...
@PreAuthorize("hasRole('ADMIN') and @passkeyAuthenticationService.isAuthenticatedWithPasskey()")
