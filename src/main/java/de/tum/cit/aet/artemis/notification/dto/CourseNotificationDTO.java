 ...
 * <p>
 * The type specific values live in {@link CourseNotificationPayload}, one record per notification type, so that a
...
public record CourseNotificationDTO(String notificationType, long notificationId, long courseId, ZonedDateTime creationDate, CourseNotificationCategory category,
        String courseTitle, String courseIconUrl, CourseNotificationPayload payload, UserCourseNotificationStatusType status, String relativeWebAppUrl) implements Serializable {
    ...
    public CourseNotificationDTO(String notificationType, long notificationId, long courseId, ZonedDateTime creationDate, CourseNotificationCategory category, String courseTitle,
            String courseIconUrl, CourseNotificationPayload payload, String relativeWebAppUrl) {
