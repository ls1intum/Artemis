...
public record PyrisChatPipelineExecutionDTO(ChatContext context, List<PyrisMessageDTO> chatHistory, PyrisPipelineExecutionSettingsDTO settings, @Nullable String sessionTitle,
