 ...
 *
 * @param absoluteScore        the points credited to the student (variant points capped at their group's maxPoints).
 * @param absoluteScoreTotal   the points the student achieved without the variant cap; equals {@code absoluteScore} when no group exceeds its cap.
