...
/**
 * Keeps the most recent ingestion log events in memory so an administrator can read them in the admin UI.
 * <p>
 ...
 * <p>
 * It is attached to the ingestion loggers at DEBUG in {@code logback-spring.xml}, not to the root logger:
 * rooting it would bury the ingestion story in unrelated request traffic and would capture records from
 * every other part of Artemis, which is both noisier and a wider exposure than the question needs.
 */
