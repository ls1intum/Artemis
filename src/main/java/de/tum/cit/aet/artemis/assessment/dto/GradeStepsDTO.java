...
public record GradeStepsDTO(String title, GradeType gradeType, Set<GradeStepDTO> gradeSteps, Integer maxPoints, String plagiarismGrade, String noParticipationGrade,
