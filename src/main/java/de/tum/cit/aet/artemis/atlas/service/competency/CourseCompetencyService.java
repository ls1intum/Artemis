...
public class CourseCompetencyService {
    ...
    public SearchResultPageDTO<CourseCompetency> getOnPageWithSizeForImport(final CompetencyPageableSearchDTO search, final User user) {
        ...
        competencyPage = courseCompetencyRepository.findForImportAndUserHasAccessToCourse(title, description, courseTitle, semester, user.getId(),
                authCheckService.isCurrentUserAdminAccessEnabled(), pageable);
