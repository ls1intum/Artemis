 ...
 */
public record FaqSearchableEntityDTO(Long faqId, Long courseId, String courseTitle, String questionTitle, String questionAnswer, String faqState) {
    ...
    public static FaqSearchableEntityDTO fromFaq(Faq faq) {
        return new FaqSearchableEntityDTO(faq.getId(), faq.getCourse().getId(), faq.getCourse().getTitle(), faq.getQuestionTitle(), faq.getQuestionAnswer(),
