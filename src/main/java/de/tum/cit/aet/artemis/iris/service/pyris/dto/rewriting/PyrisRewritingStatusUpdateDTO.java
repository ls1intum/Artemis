...
public record PyrisRewritingStatusUpdateDTO(@NotNull List<PyrisStageDTO> stages, @NotNull String result, List<LLMRequest> tokens, List<String> inconsistencies,
        List<String> suggestions, String improvement) {
}
