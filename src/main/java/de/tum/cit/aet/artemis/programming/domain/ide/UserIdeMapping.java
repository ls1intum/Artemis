...
public class UserIdeMapping {
    ...
    @Embeddable
    public record UserIdeMappingId(Long userId, @Column(name = "programming_language", nullable = false) @Enumerated(EnumType.STRING) ProgrammingLanguage programmingLanguage) {
