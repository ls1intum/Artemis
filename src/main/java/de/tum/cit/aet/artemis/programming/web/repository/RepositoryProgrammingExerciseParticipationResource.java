...
public class RepositoryProgrammingExerciseParticipationResource extends RepositoryResource {
    ...
    public RepositoryProgrammingExerciseParticipationResource(UserRepository userRepository, AuthorizationCheckService authCheckService,
            ...
            RepositoryParticipationService repositoryParticipationService, ProgrammingExerciseMutationGuard programmingExerciseMutationGuard) {
    ...
    OptionalLong getExerciseIdForMutation(Long participationId) {
        ...
        repositoryAccessService.checkAccessRepositoryElseThrow(programmingParticipation, userRepository.getUserWithGroupsAndAuthorities(), exercise, RepositoryActionType.WRITE);
