...
public class RepositoryProgrammingExerciseParticipationResource extends RepositoryResource {
    ...
    Repository getRepository(Long participationId, RepositoryActionType repositoryActionType, boolean pullOnGet, boolean writeAccess)
        ...
        repositoryAccessService.checkAccessRepositoryElseThrow(programmingParticipation, userRepository.getUserWithCourseRolesAndAuthorities(), programmingExercise,
    ...
    public ResponseEntity<Map<String, String>> getFilesAtCommit(@RequestParam(name = "commitId", required = false) String commitIdQuery,
        ...
        repositoryAccessService.checkAccessRepositoryElseThrow(participation, userRepository.getUserWithCourseRolesAndAuthorities(), programmingExercise,
    ...
    @Override
    @PostMapping(value = { "participations/{participationId}/repository/file", "repository/{participationId}/file" }, produces = MediaType.APPLICATION_JSON_VALUE)
