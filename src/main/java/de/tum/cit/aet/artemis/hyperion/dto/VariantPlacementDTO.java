...
public record VariantPlacementDTO(PlacementType type, @Nullable Long existingGroupId, @Nullable CreateExerciseVariantGroupDTO newGroup) implements Serializable {
