...
public enum UserFeature {
    ...
    HYPERION_CODE_GENERATION(ProductArea.AI_AUTHORING), HYPERION_VARIANT_GENERATION(ProductArea.AI_AUTHORING), HYPERION_QUIZ_GENERATION(ProductArea.AI_AUTHORING),
    ...
    // Build system
    BUILD_OVERVIEW(ProductArea.BUILD_SYSTEM), BUILD_AGENTS(ProductArea.BUILD_SYSTEM),
    ...
    IRIS_ADMIN_DASHBOARD(ProductArea.ADMINISTRATION), INGESTION_DASHBOARD(ProductArea.ADMINISTRATION), UPCOMING_EXAMS_AND_EXERCISES(ProductArea.ADMINISTRATION);
