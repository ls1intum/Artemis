...
public class LocalCIProgrammingLanguageFeatureService extends ProgrammingLanguageFeatureService {
    ...
    protected Map<ProgrammingLanguage, ProgrammingLanguageFeature> getSupportedProgrammingLanguageFeatures() {
        ...
        programmingLanguageFeatures.put(DART, new ProgrammingLanguageFeature(DART, false, false, false, false, false, List.of(), true));
        ...
        programmingLanguageFeatures.put(RUBY, new ProgrammingLanguageFeature(RUBY, false, false, false, false, false, List.of(), true));
