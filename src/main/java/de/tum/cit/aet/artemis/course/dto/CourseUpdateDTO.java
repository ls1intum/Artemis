...
public record CourseUpdateDTO(
        ...
        // Course features
        boolean learningPathsEnabled, Integer presentationScore, Integer maxPoints, @Min(0) @Max(5) Integer accuracyOfScores, boolean athenaGradingFeedbackEnabled,
    ...
    public static CourseUpdateDTO of(Course course) {
        return new CourseUpdateDTO(course.getId(), course.getTitle(), course.getShortName(), course.getDescription(), course.getSemester(), course.getStudentGroupName(),
                ...
                course.getLearningPathsEnabled(), course.getPresentationScore(), course.getMaxPoints(), course.getAccuracyOfScores(),
