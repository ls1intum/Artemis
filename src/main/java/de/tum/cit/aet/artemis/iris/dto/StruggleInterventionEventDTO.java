 ...
 * confidence, forwarded for the client eval log (spec §12) on both actions. {@code anchorFile}/{@code anchorLine}/
 * {@code inlineHint} are set only when the gate localized the nudge to a single line (spec §4/§8); the client renders
