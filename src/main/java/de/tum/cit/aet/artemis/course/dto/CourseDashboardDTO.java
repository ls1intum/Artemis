...
public record CourseDashboardDTO(long id, String title, String shortName, @Nullable String description, @Nullable String semester, @Nullable ZonedDateTime startDate,
        ...
        @Nullable String color, @Nullable String courseIcon, @Nullable Boolean enrollmentEnabled, boolean unenrollmentEnabled, @Nullable ZonedDateTime enrollmentEndDate,
        @Nullable ZonedDateTime unenrollmentEndDate, boolean onlineCourse, @Nullable CourseInformationSharingConfiguration courseInformationSharingConfiguration,
        ...
        boolean athenaFormativeFeedbackEnabled, boolean learningPathsEnabled, boolean trainingEnabled, Set<CourseDashboardExerciseDTO> exercises,
        Set<LectureForCourseManagementDTO> lectures, Set<ExamDTO> exams, Set<CourseCompetencyResponseDTO> competencies, Set<CoursePrerequisiteDTO> prerequisites) {
    ...
    public static CourseDashboardDTO of(Course course) {
        ...
        return new CourseDashboardDTO(course.getId(), course.getTitle(), course.getShortName(), course.getDescription(), course.getSemester(), course.getStartDate(),
                ...
                course.getCourseIcon(), course.isEnrollmentEnabled(), course.isUnenrollmentEnabled(), course.getEnrollmentEndDate(), course.getUnenrollmentEndDate(),
                course.isOnlineCourse(), course.getCourseInformationSharingConfiguration(), course.getCourseInformationSharingMessagingCodeOfConduct(), course.getMaxComplaints(),
                ...
                course.isTrainingEnabled(), exercises, lectures, exams, competencies, prerequisites);
    }
