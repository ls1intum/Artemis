 ...
 *                                  to every tab of the user (see {@code IrisCommandService}). Not persisted and never sent to Pyris.
 */
...
public record IrisMessageRequestDTO(@NonNull List<IrisMessageContentDTO> content, @Nullable Integer messageDifferentiator, @NonNull Map<String, String> uncommittedFiles,
        @Valid @Nullable IrisPendingContextDTO pendingContext, @Valid @Nullable List<IrisMessageContextDTO> context, @Nullable String clientId) {
