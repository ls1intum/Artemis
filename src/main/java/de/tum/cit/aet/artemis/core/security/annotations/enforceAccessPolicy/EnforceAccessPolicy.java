 ...
 * then evaluates the policy via the {@link de.tum.cit.aet.artemis.core.security.policy.PolicyEngine}.
 ...
 * &#64;EnforceAccessPolicy(value = ProgrammingExerciseVisibilityPolicy.class, resourceIdFieldName = "exerciseId")
...
public @interface EnforceAccessPolicy {
    ...
    /**
     * The {@link PolicyProvider} class that provides the {@link de.tum.cit.aet.artemis.core.security.policy.AccessPolicy} to enforce.
     * This enables type-safe, IDE-navigable policy references.
     *
