...
public record CourseForQuizExerciseDTO(Long id, String title, String description, String shortName, ZonedDateTime startDate, ZonedDateTime endDate,
        ...
        boolean complaintsEnabled, boolean requestMoreFeedbackEnabled, Integer accuracyOfScores, boolean athenaGradingFeedbackEnabled, boolean athenaFormativeFeedbackEnabled) {
    ...
    public static CourseForQuizExerciseDTO of(final Course course) {
        ...
        return new CourseForQuizExerciseDTO(course.getId(), course.getTitle(), course.getDescription(), course.getShortName(), course.getStartDate(), course.getEndDate(),
