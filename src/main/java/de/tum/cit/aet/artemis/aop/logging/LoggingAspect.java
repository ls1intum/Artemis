package de.tum.cit.aet.artemis.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(de.tum.cit.aet.artemis.repository..*)" + " || within(de.tum.cit.aet.artemis.service..*)" + " || within(de.tum.cit.aet.artemis.web.rest..*)")
