...
public class TextExerciseFeedbackService {
    ...
    public TextExerciseFeedbackService(AthenaFeedbackApi athenaFeedbackApi, SubmissionService submissionService, ResultService resultService, ResultRepository resultRepository,
            ResultWebsocketService resultWebsocketService, ParticipationService participationService) {
    ...
    public void generateAutomaticNonGradedFeedback(StudentParticipation participation, TextExercise textExercise) {
        ...
        try {
            ...
            var athenaResponse = athenaFeedbackApi.getTextFeedbackSuggestions(textExercise, (TextSubmission) submission, false);
