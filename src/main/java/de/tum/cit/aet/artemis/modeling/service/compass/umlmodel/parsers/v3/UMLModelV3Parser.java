...
public class UMLModelV3Parser {
    ...
    public static UMLDiagram buildModelFromJSON(JsonObject root, long modelSubmissionId) throws IOException {
        ...
        JsonObject modelElements = root.getAsJsonObject(ELEMENTS);
        JsonObject relationships = root.getAsJsonObject(RELATIONSHIPS);
        ...
        return switch (diagramType) {
            ...
            case BPMN -> BPMNDiagramParser.buildBPMNDiagramFromJSON(modelElements, relationships, modelSubmissionId);
        };
    }
}
