...
public record IrisResponseNeedsReviewPayload(String postMarkdownContent, String postCreationDate, String postAuthorName, Long postId, String replyMarkdownContent,
        String replyCreationDate, Long replyId, Double replyConfidence, String channelName, Long channelId) implements CourseNotificationPayload {
}
