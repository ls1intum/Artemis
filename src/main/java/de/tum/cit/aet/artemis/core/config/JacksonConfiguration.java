...
public class JacksonConfiguration {
    ...
    // Do NOT declare a @Bean here — that would cause double registration (once via ServiceLoader, once via bean),
    // leading to the AnnotationIntrospector being appended twice and "_valueDeserializer assigned" errors.
