...
public record PostContextFilterDTO(@NotBlank Long courseId, Long plagiarismCaseId, long[] conversationIds, long[] authorIds, String searchText, Boolean filterToCourseWide,
        Boolean filterToUnresolved, Boolean filterToOwn, Boolean filterToAnsweredOrReacted, PostSortCriterion postSortCriterion, SortingOrder sortingOrder, Boolean pinnedOnly) {
