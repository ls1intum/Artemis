 ...
 *                                                 history) are purged.
 * @param notEnrolledUsersInactivityMonths     Months of inactivity (by last modification) required before a user enrolled in
 *                                                 no course is soft-deleted and anonymized.
...
public record DataCleanupProperties(@DefaultValue("5") @Positive int gradeRelevantRetentionYears, @DefaultValue("1") @Positive int nonGradeRelevantRetentionYears,
        ...
        @DefaultValue("false") boolean oldCoursesWarningScheduleEnabled, @DefaultValue("false") boolean oldCoursesResetScheduleEnabled,
        @DefaultValue("false") boolean oldFeedbackScheduleEnabled, @DefaultValue("false") boolean oldSubmissionVersionsScheduleEnabled,
