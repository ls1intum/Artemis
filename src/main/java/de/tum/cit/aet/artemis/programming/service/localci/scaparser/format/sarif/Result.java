...
public record Result(String ruleId, Integer ruleIndex, ReportingDescriptorReference rule,
        de.tum.cit.aet.artemis.programming.service.localci.scaparser.format.sarif.Result.Kind kind,
        de.tum.cit.aet.artemis.programming.service.localci.scaparser.format.sarif.Result.Level level, Message message, List<Location> locations) {
    ...
    public Result(String ruleId, Integer ruleIndex, ReportingDescriptorReference rule, Kind kind, Level level, Message message, List<Location> locations) {
        ...
        this.level = Objects.requireNonNullElse(level, Level.WARNING);
