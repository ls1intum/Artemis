...
/**
 * All classes or methods annotated with this will check (used for controller classes) if the current user has the specified role in the target lecture unit course.
 * This is done using a custom aspect
 *
 * @see EnforceRoleInLectureUnitAspect
 */
@Target({ ElementType.METHOD, ElementType.TYPE })
@Retention(RetentionPolicy.RUNTIME)
@Inherited
@Documented
public @interface EnforceRoleInLectureUnit {
