...
public interface BuildJobRepository extends ArtemisJpaRepository<BuildJob, Long>, JpaSpecificationExecutor<BuildJob> {
    ...
    @Query("""
            SELECT new de.tum.cit.aet.artemis.service.connectors.localci.dto.DockerImageBuild(
                b.dockerImage,
    ...
    @Query("""
             SELECT new de.tum.cit.aet.artemis.service.connectors.localci.dto.ResultBuildJob(
                 b.result.id,
                 b.buildJobId
             )
             FROM BuildJob b
