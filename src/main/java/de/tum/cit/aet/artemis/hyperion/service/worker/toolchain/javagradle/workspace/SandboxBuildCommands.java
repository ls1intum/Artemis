package de.tum.cit.aet.artemis.hyperion.service.worker.toolchain.javagradle.workspace;
 ...
 */
public class SandboxBuildCommands {

    private static final Pattern CLEAN_TASK = Pattern.compile("(?<![\\w-])clean(?![\\w-])\\s*");
    ...
    public static final String PRISTINE_VERIFY_DIR = "/opt/aiworker";
    ...
    public static final String READINESS_FIXTURE_DIR = "/opt/aiworker-readiness-fixture";
    ...
    public SandboxBuildCommands(GenerationResources resources) {
    ...
    public String pristineSolutionBuildCommand() {
        return pristineVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.SOLUTION));
    }

    public String pristineTemplateBuildCommand() {
        return pristineVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.TEMPLATE));
    }

    public String behavioralSolutionBuildCommand() {
        return laneVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.SOLUTION), "behavior-isolated");
    }

    public String behavioralTemplateBuildCommand() {
        return laneVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.TEMPLATE), "behavior-isolated");
    }

    public String trustedStructuralSolutionBuildCommand() {
        return laneVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.SOLUTION), "trusted-structural");
    }

    public String trustedStructuralTemplateBuildCommand() {
        return laneVerifyInvocation(GenerationWorkspace.directoryFor(RepositoryRole.TEMPLATE), "trusted-structural");
    }
    ...
    private static String buildIsolatedGradlePhaseSection(BuildRecipe recipe) {
        ...
        for (String phase : recipe.phases()) {
            ...
            String execute = CLEAN_TASK.matcher(matcher.replaceFirst(task)).replaceFirst("") + gradleProducerExclusions(task);
