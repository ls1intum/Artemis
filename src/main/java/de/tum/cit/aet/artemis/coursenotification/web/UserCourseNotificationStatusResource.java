...
import de.tum.cit.aet.artemis.coursenotification.dto.UserCourseNotificationStatusUpdateRequestDTO;
import de.tum.cit.aet.artemis.coursenotification.service.UserCourseNotificationStatusService;

@Profile(PROFILE_CORE)
@RestController
@RequestMapping("api/coursenotification/")
public class UserCourseNotificationStatusResource {
    ...
    /**
     * PUT coursenotification/courses/{courseId}/notifications/status : Update status of multiple notifications for the current user
     *
