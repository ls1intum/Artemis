...
public record SystemNotificationDTO(Long id, String title, String text, ZonedDateTime notificationDate, ZonedDateTime expireDate, SystemNotificationType type) {
