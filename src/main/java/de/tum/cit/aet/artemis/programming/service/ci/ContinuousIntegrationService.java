...
public interface ContinuousIntegrationService {
    ...
    enum RepositoryCheckoutPath implements CustomizableCheckoutPath {
        ASSIGNMENT {
            ...
            public String forProgrammingLanguage(ProgrammingLanguage language) {
                return switch (language) {
                    case JAVA, PYTHON, C, HASKELL, KOTLIN, VHDL, ASSEMBLER, SWIFT, OCAML, EMPTY, RUST, JAVASCRIPT, TYPESCRIPT -> "assignment";
                    case C_SHARP, C_PLUS_PLUS, SQL, R, GO, MATLAB, BASH, RUBY, POWERSHELL, ADA, DART, PHP ->
        ...
        TEST {
            ...
            public String forProgrammingLanguage(ProgrammingLanguage language) {
                return switch (language) {
                    case JAVA, PYTHON, HASKELL, KOTLIN, SWIFT, EMPTY, RUST, JAVASCRIPT, TYPESCRIPT -> "";
