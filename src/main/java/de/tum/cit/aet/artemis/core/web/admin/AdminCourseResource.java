...
public class AdminCourseResource {
    ...
    public ResponseEntity<Course> createCourse(@RequestPart Course course, @RequestPart(required = false) MultipartFile file) throws URISyntaxException {
        ...
        if (file != null) {
            ...
            createdCourse.setCourseIcon(FilePathService.publicPathForActualPathOrThrow(savePath, FilePathType.COURSE_ICON, createdCourse.getId()).toString());
    ...
    public ResponseEntity<Void> deleteCourse(@PathVariable long courseId) {
        ...
        if (course.getCourseIcon() != null) {
            fileService.schedulePathForDeletion(FilePathService.actualPathForPublicPath(URI.create(course.getCourseIcon()), FilePathType.COURSE_ICON), 0);
        }
