 ...
 * <p>
 * Individual schema definitions live in their own classes (e.g. {@link SearchableEntitySchema}).
...
public final class WeaviateSchemas {
     ...
     */
    public static final List<WeaviateCollectionSchema> ALL_SCHEMAS = List.of(SearchableEntitySchema.SCHEMA);
