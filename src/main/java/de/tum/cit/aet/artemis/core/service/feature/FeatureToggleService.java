...
public class FeatureToggleService {
    ...
    private void initFeatures() {
        ...
        // This ensures that all features (except the Science API, TutorSuggestions, AtlasML, Memiris, AtlasAgent and AutonomousTutor) are enabled once the system starts up
        for (Feature feature : Feature.values()) {
            if (!features.containsKey(feature) && feature != Feature.Science && feature != Feature.TutorSuggestions && feature != Feature.AtlasML && feature != Feature.Memiris
                    && feature != Feature.AtlasAgent && feature != Feature.AutonomousTutor) {
