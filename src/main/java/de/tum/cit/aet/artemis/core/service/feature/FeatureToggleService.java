...
public class FeatureToggleService {
    ...
    private void initFeatures() {
        ...
        // This ensures that all features (except Science, TutorSuggestions, AtlasML, AtlasAgent, Memiris, RateLimit, GlobalSearch, AutonomousTutor, and
        // AutomaticCompetencyManagement) are enabled once the system starts up
        for (Feature feature : Feature.values()) {
            if (!features.containsKey(feature) && feature != Feature.Science && feature != Feature.TutorSuggestions && feature != Feature.AtlasML && feature != Feature.AtlasAgent
                    ...
                    && feature != Feature.AutomaticCompetencyManagement) {
        ...
        if (!features.containsKey(Feature.AutomaticCompetencyManagement)) {
            features.put(Feature.AutomaticCompetencyManagement, false);
        }
