 ...
 * <p>
 * This request DTO intentionally has no {@code @JsonInclude(NON_EMPTY)}: request DTOs must round-trip empty/blank values
 * unchanged so the client can send them verbatim.
 *
