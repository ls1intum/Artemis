...
public class BuildJobManagementService {
    ...
    public BuildJobManagementService(RedissonClient redissonClient, BuildJobExecutionService buildJobExecutionService, BuildAgentConfiguration buildAgentConfiguration,
