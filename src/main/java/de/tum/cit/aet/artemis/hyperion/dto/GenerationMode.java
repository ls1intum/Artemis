 ...
 * <p>
 * The mode selects the seed, the prompt framing, and the adaptation-specific destructive-rewrite guardrails. The obvious heuristic — infer "adapt" from a present problem
 * statement — is wrong, because a from-scratch {@link #GENERATE} run may legitimately start against a drafted statement.
 */
