...
public class AutonomousTutorForwardingService {
    ...
    public void onNewMessage(Post post, Conversation conversation, Course course) {
        ...
        pyrisPipelineService.executeAutonomousTutorPipeline(variant, author.getSelectedLLMUsage(), new PyrisPostDTO(post), course, new PyrisUserDTO(author), null, null, null,
                stages -> {
                });
    }
    ...
    public void onNewAnswerMessage(AnswerPost answerPost, Post parentPost, Conversation conversation, Course course) {
        ...
        pyrisPipelineService.executeAutonomousTutorPipeline(variant, author.getSelectedLLMUsage(), new PyrisPostDTO(parentPost), course, new PyrisUserDTO(author), null, null, null,
                stages -> {
                });
    }
}
