...
public class ExampleParticipation extends Participation {
    ...
    @ManyToMany(mappedBy = "trainedExampleParticipations")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JsonIgnoreProperties({ "trainedExampleParticipations", "assessedExercise" })
    ...
    public void addTutorParticipation(TutorParticipation tutorParticipation) {
        ...
        tutorParticipation.getTrainedExampleParticipations().add(this);
    }
    ...
    public void removeTutorParticipation(TutorParticipation tutorParticipation) {
        ...
        tutorParticipation.getTrainedExampleParticipations().remove(this);
    }
