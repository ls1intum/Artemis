package de.tum.cit.aet.artemis.core.service.connectors.pyris.dto.chat.course;

import java.util.List;

import com.fasterxml.jackson.annotation.JsonInclude;

import de.tum.cit.aet.artemis.core.service.connectors.pyris.dto.PyrisPipelineExecutionSettingsDTO;
import de.tum.cit.aet.artemis.core.service.connectors.pyris.dto.data.PyrisExtendedCourseDTO;
import de.tum.cit.aet.artemis.core.service.connectors.pyris.dto.data.PyrisMessageDTO;
import de.tum.cit.aet.artemis.core.service.connectors.pyris.dto.data.PyrisUserDTO;
