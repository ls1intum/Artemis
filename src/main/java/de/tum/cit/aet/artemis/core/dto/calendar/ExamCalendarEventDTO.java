...
public record ExamCalendarEventDTO(@NotNull String title, @NotNull ZonedDateTime visibleDate, @NotNull ZonedDateTime startDate, @NotNull ZonedDateTime endDate,
