...
public class AthenaResource {
    ...
    public ResponseEntity<List<TextFeedbackDTO>> getTextFeedbackSuggestions(@PathVariable long exerciseId, @PathVariable long submissionId) {
        var api = textRepositoryApi.orElseThrow(() -> new TextExerciseNotPresentException(TextApi.class));
        var submissionApi = textSubmissionApi.orElseThrow(() -> new TextExerciseNotPresentException(TextSubmissionApi.class));
