...
public class BambooService {
    ...
    public CliClient.ExitCode clonePlan(String baseProject, String basePlan, String name) throws BambooException {
        ...
        String[] args = new String[]{"--action", "clonePlan",
            ...
            "--toPlan", baseProject + "-" + buildPlanKey(name),
            "--name", baseProject + "-" + buildPlanKey(name),
            "--disable",
    ...
    public CliClient.ExitCode enablePlan(String projectKey, String planKey) throws BambooException {
        ...
        String[] args = new String[]{"--action", "enablePlan",
            "--plan", projectKey + "-" + buildPlanKey(planKey),
            "-s", BAMBOO_SERVER.toString(),
            "--user", BAMBOO_USER,
            "--password", BAMBOO_PASSWORD,
        };
    ...
    public CliClient.ExitCode updatePlanRepository(String bambooProject, String bambooPlan, String bambooRepositoryName, String bitbucketProject, String bitbucketRepository) throws BambooException {
        ...
        String[] args = new String[]{
            ...
            "--plan", bambooProject + "-" + buildPlanKey(bambooPlan),
        ...
        log.debug("Executing BambooClient with arguments: " + StringUtils.arrayToDelimitedString(args, " "));
        CliClient.ExitCode exitCode = client.doWork(args);
        if (!exitCode.equals(CliClient.ExitCode.SUCCESS)) {
     ...
     */
    @Async
    public void retrieveAndSaveBuildResult(String projectKey, String planKey, Participation participation) {
        ...
        Map buildResults = retrieveLatestBuildResult(projectKey, planKey);
     ...
     */
    private Map<String, Object> retrieveLatestBuildResult(String projectKey, String planKey) {
        ...
        try {
            response = restTemplate.exchange(
                BAMBOO_SERVER + "/rest/api/latest/result/" + projectKey + "-" + buildPlanKey(planKey) + "/latest.json?expand=testResults",
                HttpMethod.GET,
                entity,
                Map.class);
        } catch (Exception e) {
     ...
     * @return
     */
    public Map<String, Object> retrieveLatestBuildResultDetails(String projectKey, String planKey) {
        HttpHeaders headers = HeaderUtil.createAuthorization(BAMBOO_USER, BAMBOO_PASSWORD);
        HttpEntity<?> entity = new HttpEntity<>(headers);
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<Map> response = null;
        try {
            ...
            response = restTemplate.exchange(
                BAMBOO_SERVER + "/rest/api/latest/result/" + projectKey + "-" + buildPlanKey(planKey) + "-JOB1/latest.json?expand=testResults.failedTests.testResult.errors",
                HttpMethod.GET,
                entity,
                Map.class);
        } catch (Exception e) {
     ...
     */
    public Map<String, Boolean> retrieveBuildStatus(String projectKey, String planKey) {
        HttpHeaders headers = HeaderUtil.createAuthorization(BAMBOO_USER, BAMBOO_PASSWORD);
        HttpEntity<?> entity = new HttpEntity<>(headers);
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<Map> response = null;
        try {
            response = restTemplate.exchange(
                BAMBOO_SERVER + "/rest/api/latest/plan/" + projectKey + "-" + buildPlanKey(planKey) + ".json",
                HttpMethod.GET,
                entity,
                Map.class);
        } catch (Exception e) {
    ...
    private String buildPlanKey(String name) {
