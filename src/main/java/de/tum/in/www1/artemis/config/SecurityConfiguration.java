...
public class SecurityConfiguration {
    ...
    protected SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        ...
        .and()
            .authorizeHttpRequests(auth -> auth
                ...
                .antMatchers("/management/prometheus/**").access(this::prometheusAccessChecker)
    ...
    private AuthorizationDecision prometheusAccessChecker(final Supplier<Authentication> authentication, final RequestAuthorizationContext context) {
        // Only allow the configured IP address to access the prometheus endpoint, or allow 127.0.0.1 if none is specified
        return new AuthorizationDecision(context.getRequest().getRemoteAddr().equals(monitoringIpAddress.orElse("127.0.0.1")));
    }
