...
public class SecurityConfiguration {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/register").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/activate").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/{version:v\\d+}/activate").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/authenticate").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/authenticate").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/authenticate").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/{version:v\\d+}/authenticate").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/account/reset-password/init").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/account/reset-password/init").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/account/reset-password/finish").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/account/reset-password/finish").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/lti/launch/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/lti/launch/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/lti13/auth-callback").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/lti13/auth-callback").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/system-notifications").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/{version:v\\d+}/api/system-notifications/active").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/programming-exercises/new-result").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/programming-exercises/new-result").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/programming-submissions/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/programming-submissions/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/programming-exercises/test-cases-changed/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/api/programming-exercises/test-cases-changed/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/athene-result/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/{version:v\\d+}/api/athene-result/*").permitAll()
