...
public class IrisExercisePlanMessageContent extends IrisMessageContent {
    ...
    public String getContentAsString() {
        return asMap().entrySet().stream().map(entry -> entry.getKey().name() + ": " + entry.getValue()).collect(Collectors.joining(",\n", "Exercise Generation Plan:\n", ""));
    }
    ...
    public String toString() {
        return "IrisExercisePlanMessageContent{" + "message=" + (message == null ? "null" : message.getId()) + ", problemStatementPlan='" + problemStatementPlan + '\''
                + ", solutionRepositoryPlan='" + solutionRepositoryPlan + '\'' + ", templateRepositoryPlan='" + templateRepositoryPlan + '\'' + ", testRepositoryPlan='"
                + testRepositoryPlan + '\'' + '}';
    }
}
