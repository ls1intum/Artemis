...
public interface CourseRepository extends JpaRepository<Course, Long> {
    ...
    @EntityGraph(type = LOAD, attributePaths = { "exercises", "lectures", "lectures.lectureUnits", "learningGoals", "prerequisites", "onlineCourseConfiguration" })
    Optional<Course> findWithEagerExercisesAndLecturesAndLectureUnitsAndLearningGoalsAndOnlineConfigurationById(long courseId);
    ...
    @NotNull
    default Course findByIdWithExercisesAndLecturesAndLectureUnitsAndLearningGoalsAndOnlineConfigurationElseThrow(long courseId) {
        return findWithEagerExercisesAndLecturesAndLectureUnitsAndLearningGoalsAndOnlineConfigurationById(courseId)
                .orElseThrow(() -> new EntityNotFoundException("Course", courseId));
    }
