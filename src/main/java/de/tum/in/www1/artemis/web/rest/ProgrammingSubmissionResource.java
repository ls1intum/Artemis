...
@RestController
@RequestMapping("/api")
public class ProgrammingSubmissionResource extends GenericSubmissionResource<ProgrammingSubmission> {
    ...
    public ProgrammingSubmissionResource(ProgrammingSubmissionService programmingSubmissionService, ExerciseService exerciseService, CourseService courseService,
            ProgrammingExerciseService programmingExerciseService, AuthorizationCheckService authCheckService, ParticipationService participationService,
    ...
    public ResponseEntity<ProgrammingSubmission> getProgrammingSubmissionWithoutAssessment(@PathVariable Long exerciseId) {
        ...
        hideDetails(programmingSubmission, user);
