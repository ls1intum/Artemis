...
/** REST controller for managing TransformationModelingExercise. */
@RestController
@RequestMapping(TransformationModelingExerciseResource.Endpoints.ROOT)
public class TransformationModelingExerciseResource {

    private final Logger log = LoggerFactory.getLogger(TransformationModelingExerciseResource.class);

    private static final String ENTITY_NAME = "transformationModelingExercise";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final TransformationModelingExerciseRepository transformationModelingExerciseRepository;
    ...
    public TransformationModelingExerciseResource(TransformationModelingExerciseRepository transformationModelingExerciseRepository, UserRepository userRepository,
            AuthorizationCheckService authCheckService, CourseRepository courseRepository, ModelingExerciseService modelingExerciseService,
            ...
            ExampleSubmissionRepository exampleSubmissionRepository, InstanceMessageSendService instanceMessageSendService) {
        this.transformationModelingExerciseRepository = transformationModelingExerciseRepository;
    ...
    @PostMapping("/transformation-modeling-exercises")
    @PreAuthorize("hasRole('EDITOR')")
    public ResponseEntity<ModelingExercise> createModelingExercise(@RequestBody TransformationModelingExercise modelingExercise) throws URISyntaxException {
        log.debug("REST request to save TransformationModelingExercise : {}", modelingExercise);
        ...
        TransformationModelingExercise result = transformationModelingExerciseRepository.save(modelingExercise);
        ...
        return ResponseEntity.created(new URI("/api/transformation-modeling-exercises/" + result.getId()))
     ...
     */
    @GetMapping("/transformation-modeling-exercises")
    @PreAuthorize("hasRole('EDITOR')")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/transformation-modeling-exercises")
    @PreAuthorize("hasRole('EDITOR')")
    public ResponseEntity<ModelingExercise> updateModelingExercise(@RequestBody TransformationModelingExercise modelingExercise,
        ...
        ModelingExercise modelingExerciseBeforeUpdate = transformationModelingExerciseRepository.findByIdElseThrow(modelingExercise.getId());
        ModelingExercise updatedModelingExercise = transformationModelingExerciseRepository.save(modelingExercise);
     ...
     */
    @GetMapping(value = "/courses/{courseId}/transformation-modeling-exercises")
    @PreAuthorize("hasRole('TA')")
    public ResponseEntity<List<TransformationModelingExercise>> getModelingExercisesForCourse(@PathVariable Long courseId) {
        ...
        List<TransformationModelingExercise> exercises = transformationModelingExerciseRepository.findByCourseId(courseId);
     ...
     */
    @GetMapping(value = "/transformation-modeling-exercises/{exerciseId}/statistics")
    @PreAuthorize("hasRole('TA')")
    public ResponseEntity<String> getModelingExerciseStatistics(@PathVariable Long exerciseId) {
        ...
        var modelingExercise = transformationModelingExerciseRepository.findByIdElseThrow(exerciseId);
     ...
     */
    @GetMapping("/transformation-modeling-exercises/{exerciseId}/print-statistic")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Void> printCompassStatisticForExercise(@PathVariable Long exerciseId) {
        TransformationModelingExercise modelingExercise = transformationModelingExerciseRepository.findByIdElseThrow(exerciseId);
     ...
     */
    @GetMapping("/transformation-modeling-exercises/{exerciseId}")
    @PreAuthorize("hasRole('TA')")
    public ResponseEntity<ModelingExercise> getModelingExercise(@PathVariable Long exerciseId) {
        ...
        var modelingExercise = transformationModelingExerciseRepository.findWithEagerExampleSubmissionsByIdElseThrow(exerciseId);
        authCheckService.checkHasAtLeastRoleForExerciseElseThrow(Role.TEACHING_ASSISTANT, modelingExercise, null);
     ...
     */
    @DeleteMapping("/transformation-modeling-exercises/{exerciseId}")
     ...
     * @return the ResponseEntity with status 200 (OK)
     */
    @DeleteMapping("/transformation-modeling-exercises/{exerciseId}/clusters")
    @PreAuthorize("hasRole('ADMIN')")
     ...
     * @return the ResponseEntity with status 200 (OK)
     */
    @PostMapping("/transformation-modeling-exercises/{exerciseId}/trigger-automatic-assessment")
    @PreAuthorize("hasRole('ADMIN')")
     ...
     */
    @PostMapping("/transformation-modeling-exercises/import/{sourceExerciseId}")
    @PreAuthorize("hasRole('EDITOR')")
    public ResponseEntity<ModelingExercise> importExercise(@PathVariable long sourceExerciseId, @RequestBody TransformationModelingExercise importedExercise)
            throws URISyntaxException {
        if (sourceExerciseId <= 0 || (importedExercise.getCourseViaExerciseGroupOrCourseMember() == null && importedExercise.getExerciseGroup() == null)) {
            log.debug("Either the courseId or exerciseGroupId must be set for an import");
            return badRequest();
        }
        final var originalModelingExercise = transformationModelingExerciseRepository.findByIdWithExampleSubmissionsAndResultsElseThrow(sourceExerciseId);
        ...
        transformationModelingExerciseRepository.save((TransformationModelingExercise) newModelingExercise);
     ...
     */
    @PostMapping("/transformation-modeling-exercises/{exerciseId}/export-submissions")
    @PreAuthorize("hasRole('TA')")
     ...
     */
    @GetMapping("/transformation-modeling-exercises/{exerciseId}/plagiarism-result")
    @PreAuthorize("hasRole('EDITOR')")
    public ResponseEntity<ModelingPlagiarismResult> getPlagiarismResult(@PathVariable long exerciseId) {
        ...
        ModelingExercise modelingExercise = transformationModelingExerciseRepository.findByIdWithStudentParticipationsSubmissionsResultsElseThrow(exerciseId);
     ...
     */
    @GetMapping("/transformation-modeling-exercises/{exerciseId}/check-plagiarism")
    @PreAuthorize("hasRole('INSTRUCTOR')")
    public ResponseEntity<ModelingPlagiarismResult> checkPlagiarism(@PathVariable long exerciseId, @RequestParam float similarityThreshold, @RequestParam int minimumScore,
        ...
        var modelingExercise = transformationModelingExerciseRepository.findByIdWithStudentParticipationsSubmissionsResultsElseThrow(exerciseId);
    ...
    /**
     * PUT /transformation-modeling-exercises/{exerciseId}/re-evaluate : Re-evaluates and updates an existing modelingExercise.
     *
    ...
    @PreAuthorize("hasRole('EDITOR')")
    public ResponseEntity<ModelingExercise> reEvaluateAndUpdateModelingExercise(@PathVariable long exerciseId, @RequestBody TransformationModelingExercise modelingExercise,
        ...
        transformationModelingExerciseRepository.findByIdWithStudentParticipationsSubmissionsResultsElseThrow(exerciseId);
    ...
    public static final class Endpoints {
        ...
        public static final String TRANSFORMATION_MODELING_EXERCISES = "/transformation-modeling-exercises";

        public static final String MODELING_EXERCISE = TRANSFORMATION_MODELING_EXERCISES + "/{exerciseId}";
