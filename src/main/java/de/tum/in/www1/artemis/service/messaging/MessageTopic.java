...
public enum MessageTopic {
    ...
    PROGRAMMING_EXERCISE_UNLOCK_UNSEALED_REPOSITORIES_AND_PARTICIPATIONS("programming-exercise-unlock-sealed-repositories-and-participations"),
    PROGRAMMING_EXERCISE_UNLOCK_UNSEALED_PARTICIPATIONS("programming-exercise-unlock-sealed-participations"),
    ...
    PROGRAMMING_EXERCISE_LOCK_SEALED_REPOSITORIES_AND_PARTICIPATIONS("programming-exercise-lock-sealed-repositories-and-participations"),
    PROGRAMMING_EXERCISE_LOCK_SEALED_PARTICIPATIONS("programming-exercise-lock-sealed-participations"),
