...
public class BambooProgrammingLanguageFeatureService extends ProgrammingLanguageFeatureService {
    ...
    public BambooProgrammingLanguageFeatureService() {
        ...
        programmingLanguageFeatures.put(JAVA, new ProgrammingLanguageFeature(JAVA, true, true, true, true, false, List.of()));
        ...
        programmingLanguageFeatures.put(SWIFT, new ProgrammingLanguageFeature(SWIFT, false, false, false, false, false, List.of()));
    }
}
