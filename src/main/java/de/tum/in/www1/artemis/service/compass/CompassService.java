...
public class CompassService {
     ...
     */
    // TODO CZ: make static?
    private Map<Long, Result> automaticResultMap = new ConcurrentHashMap<>();
    ...
    private void assessAutomatically(long submissionId, long exerciseId) {
        ...
        if (engine == null || modelingExercise == null || modelingSubmission == null) {
            log.error("Submission with ID {} could not be assessed automatically", exerciseId);
            return;
        }
