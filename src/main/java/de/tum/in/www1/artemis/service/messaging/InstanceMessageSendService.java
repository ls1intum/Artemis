...
public interface InstanceMessageSendService {
    ...
    /**
     * Send a message to the main server that the exam live statistics was updated and a (re-)scheduling has to be performed
     * @param examId the id of the exam that should be scheduled
     */
    void sendExamLiveStatisticsSchedule(Long examId);

    /**
     * Send a message to the main server that the exam live statistics was cancelled and the scheduling should be cancelled
     * @param examId the id of the exam that should be scheduled
     */
    void sendExamLiveStatisticsScheduleCancel(Long examId);
}
