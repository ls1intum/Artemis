...
public abstract class AbstractQuizSubmissionService<T extends AbstractQuizSubmission> {
     ...
     *
     * @param quizConfiguration the quiz configuration for which the submission for the exam mode should be done
     ...
     */
    public T saveSubmissionForExamMode(QuizConfiguration quizConfiguration, T quizSubmission, User user) {
        ...
        T savedQuizSubmission = this.save(quizConfiguration, quizSubmission, user);
