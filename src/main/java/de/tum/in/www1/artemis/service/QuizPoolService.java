...
public class QuizPoolService extends QuizService<QuizPool> {
    ...
    @Override
    protected void preSaveReturn(QuizPool quizConfiguration) {
        // There is nothing to do before returning the saved configuration for quiz pool
    }

    @Override
    protected void preSave(QuizPool quizConfiguration) {
        // There is nothing to do before saving configuration for quiz pool
    }
}
