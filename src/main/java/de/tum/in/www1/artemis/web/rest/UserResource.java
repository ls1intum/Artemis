...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody ManagedUserVM managedUserVM) throws URISyntaxException {
        ...
        var username = managedUserVM.getLogin();
        var password = managedUserVM.getPassword();
        ...
        // Note: the password can be null, then a random one will be generated. If the password is not null, its length has to be at least PASSWORD_MIN_LENGTH
