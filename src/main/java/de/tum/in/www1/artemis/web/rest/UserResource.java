...
public class UserResource {
    ...
    */
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        return ResponseUtil.wrapOrNotFound(
                updatedUser, HeaderUtil.createAlert("userManagement.updated", managedUserVM.getLogin()));
    }
    ...
    */
    ...
    @Secured({
        ...
        AuthoritiesConstants.TEACHING_ASSISTANT
    })
    ...
    */
    ...
    public ResponseEntity<UserDTO> updateUserNotificationDate() {
        ...
        Optional<UserDTO> updatedUser =
                Optional.of(userService.updateUserNotificationReadDate()).map(UserDTO::new);
