...
public record ExerciseStudentMetricsDTO(Map<Long, ExerciseInformationDTO> exerciseInformation, Map<Long, ZonedDateTime> latestSubmission, Map<Long, ZonedDateTime> exerciseStart,
        Map<Long, Set<SubmissionTimestampDTO>> submissionTimestamps) {
}
