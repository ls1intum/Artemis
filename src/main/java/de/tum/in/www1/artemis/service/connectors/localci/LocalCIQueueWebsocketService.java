...
public class LocalCIQueueWebsocketService {
    ...
    @PostConstruct
    public void init() {
        IQueue<LocalCIBuildJobItem> queue = hazelcastInstance.getQueue("buildJobQueue");
    ...
    private class QueuedBuildJobItemListener implements ItemListener<LocalCIBuildJobItem> {
