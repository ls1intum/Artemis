...
public class ModelingExerciseResource {
    ...
    /**
     * PUT modeling-exercises/:exerciseId : Updates an existing modelingExercise.
     *
     * @param modelingExercise the modelingExercise to update
     * @param exerciseId id of the exercise to be updated
    ...
    /**
     * GET modeling-exercises/:exerciseId/print-statistic : Prints the Compass statistic regarding the automatic assessment of the modeling exercise with the given id.
     *
    ...
    public ResponseEntity<ModelingExercise> reEvaluateAndUpdateModelingExercise(@PathVariable long exerciseId, @RequestBody ModelingExercise modelingExercise,
        ...
        return updateModelingExercise(modelingExercise.getId(), modelingExercise, null);
    }
