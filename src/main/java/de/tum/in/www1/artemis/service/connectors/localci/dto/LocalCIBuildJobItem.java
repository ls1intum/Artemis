...
public record LocalCIBuildJobItem(String id, String name, String buildAgentAddress, long participationId, long courseId, long exerciseId, int retryCount, int priority,
     ...
     */
    public LocalCIBuildJobItem(LocalCIBuildJobItem queueItem, ZonedDateTime buildCompletionDate, BuildStatus status) {
     ...
     */
    public LocalCIBuildJobItem(LocalCIBuildJobItem queueItem, String hazelcastMemberAddress) {
    ...
    public LocalCIBuildJobItem(LocalCIBuildJobItem queueItem, ResultDTO submissionResult) {
        this(queueItem.id(), queueItem.name(), queueItem.buildAgentAddress(), queueItem.participationId(), queueItem.courseId(), queueItem.exerciseId(), queueItem.retryCount(),
