...
public class NotificationTitleTypeConstants {
    ...
    public static final String CONVERSATION_CREATE_GROUP_CHAT_TITLE = "New group chat";

    public static final String CONVERSATION_ADD_USER_CHANNEL_TITLE = "You have been added to a channel";

    public static final String CONVERSATION_ADD_USER_GROUP_CHAT_TITLE = "You have been added to a group chat";

    public static final String CONVERSATION_REMOVE_USER_GROUP_CHAT_TITLE = "You have been removed from a group chat";

    public static final String CONVERSATION_REMOVE_USER_CHANNEL_TITLE = "You have been removed from a channel";

    public static final String CONVERSATION_DELETE_CHANNEL_TITLE = "Channel deleted";

    public static final String CONVERSATION_DELETE_GROUP_CHAT_TITLE = "Group chat deleted";
    ...
    private static final BiMap<NotificationType, String> NOTIFICATION_TYPE_AND_TITLE_MAP = new ImmutableBiMap.Builder<NotificationType, String>()
            ...
            .put(CONVERSATION_DELETE_CHANNEL, CONVERSATION_DELETE_CHANNEL_TITLE).put(CONVERSATION_DELETE_GROUP_CHAT, CONVERSATION_DELETE_GROUP_CHAT_TITLE).build();
