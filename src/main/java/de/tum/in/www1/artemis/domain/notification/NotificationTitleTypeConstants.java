...
public class NotificationTitleTypeConstants {
    ...
    public static final String NEW_ANSWER_POST_FOR_COURSE_POST_TITLE = "New Reply to Course-wide Post";
    ...
    private static final BiMap<NotificationType, String> NOTIFICATION_TYPE_AND_TITLE_MAP = new ImmutableBiMap.Builder<NotificationType, String>()
            ...
            .put(NotificationType.NEW_ANSWER_POST_FOR_LECTURE, NEW_ANSWER_POST_FOR_LECTURE_TITLE).put(NotificationType.NEW_COURSE_POST, NEW_COURSE_POST_TITLE)
