...
public class IrisExerciseCreationSessionResource {
    ...
    /**
     * GET courses/{courseId}/sessions/current: Retrieve the current iris session for the course.
     *
     ...
     */
    @GetMapping("courses/{courseId}/sessions/exercise-creations-current")
    ...
    /**
     * GET courses/{courseId}/sessions: Retrieve all Iris Sessions for the programming exercise
     *
     * @param courseId of the exercise
     ...
     */
    @GetMapping("courses/{courseId}/exercise-creations-sessions")
    @EnforceAtLeastEditor
     ...
     */
    @PostMapping("courses/{courseId}/exercise-creations-sessions")
    @EnforceAtLeastEditor
