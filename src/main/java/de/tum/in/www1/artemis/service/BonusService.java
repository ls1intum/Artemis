...
public class BonusService {
     ...
     * @param reachablePointsOfSource points that can be achieved by the student in the source exam/course
    ...
    public BonusExampleDTO calculateGradeWithBonus(IBonusStrategy bonusStrategy, GradingScale bonusToGradingScale, Double achievedPointsOfBonusTo, GradingScale sourceGradingScale,
            Double achievedPointsOfSource, Double reachablePointsOfSource, double calculationSign) {
        double reachablePointsOfBonusTo = bonusToGradingScale.getMaxPoints();
        ...
        return bonusStrategy.calculateBonusForStrategy(gradingScaleRepository, bonusToGradingScale, achievedPointsOfBonusTo, sourceGradingScale, achievedPointsOfSource,
                reachablePointsOfSource, calculationSign);
    }
     ...
     */
    public BonusExampleDTO calculateGradeWithBonus(Bonus bonus, Double achievedPointsOfBonusTo, Double achievedPointsOfSource, Double reachablePointsOfSource) {
        return calculateGradeWithBonus(bonus.getBonusToGradingScale().getBonusStrategy(), bonus.getBonusToGradingScale(), achievedPointsOfBonusTo, bonus.getSourceGradingScale(),
                achievedPointsOfSource, reachablePointsOfSource, bonus.getWeight());
    }
}
