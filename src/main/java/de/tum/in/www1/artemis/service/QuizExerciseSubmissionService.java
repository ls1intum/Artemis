...
@Service
public class QuizExerciseSubmissionService extends QuizSubmissionService<QuizSubmission> {

    private final Logger log = LoggerFactory.getLogger(QuizExerciseSubmissionService.class);
    ...
    /**
     * Find participation of the given quiz exercise that was done by the given user
     *
     * @param quizExercise   the quiz exercise of which the participation belongs to
     * @param quizSubmission the quiz submission of which the participation to be set to
     ...
     *
     * @param quizSubmission the quiz submission to be saved
     * @param user           the user by which the submission was made
