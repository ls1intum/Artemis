...
public class BitbucketService extends AbstractVersionControlService {
    ...
    private Map<Integer, String> getExistingWebHooks(String projectKey, String repositorySlug) throws BitbucketException {
        ...
        if (response.getStatusCode().equals(HttpStatus.OK) && response.getBody() != null && response.getBody().getSize() > 0) {
            ...
            for (BitbucketWebHookDTO rawWebHook : rawWebHooks) {
                webHooks.put(rawWebHook.getId(), rawWebHook.getNotificationUrl());
