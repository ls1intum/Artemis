...
public class    SystemNotificationResource {
     ...
     * or with status 400 (Bad Request) if the system notification is not valid,
     * or with status 500 (Internal Server Error) if the system notification couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
