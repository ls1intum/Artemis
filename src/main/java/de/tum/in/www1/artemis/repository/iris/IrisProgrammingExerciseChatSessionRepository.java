 ...
 */
public interface IrisProgrammingExerciseChatSessionRepository extends ArtemisJpaRepository<IrisProgrammingExerciseChatSession, Long> {
    ...
    default List<IrisProgrammingExerciseChatSession> findByExerciseIdAndUserIdElseThrow(long exerciseId, long userId) throws EntityNotFoundException {
        ...
        if (result.isEmpty()) {
            throw new EntityNotFoundException("Iris Programming Exercise Chat Session");
        }
        return result;
    }
}
