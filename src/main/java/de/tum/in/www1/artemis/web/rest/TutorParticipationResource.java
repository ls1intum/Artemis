...
public class TutorParticipationResource {
    ...
    /**
     * POST /exercises/:exerciseId/tutorParticipations/:participationId/exampleSubmission: add an example submission to the tutor participation The tutor has read (if it is a
     * tutorial) or assessed an example submission. If it is a tutorial, the method just records that the tutor has read it. If it is not, the method checks if the assessment given
     * by the tutor is close enough to the instructor one. If yes, then it returns the participation, if not, it returns an error
     *
