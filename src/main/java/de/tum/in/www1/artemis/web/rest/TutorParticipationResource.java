...
public class TutorParticipationResource {
    ...
    /**
     * POST /exercises/:exerciseId/exampleSubmission: Add an example submission to the tutor participation of the given exercise.
     * If it is just for review (not used for tutorial), the method just records that the tutor has read it.
     * If it is a tutorial, the method checks if the assessment given by the tutor is close enough to
