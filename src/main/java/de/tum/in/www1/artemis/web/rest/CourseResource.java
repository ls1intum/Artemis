...
public class CourseResource {
    ...
    public CourseResource(UserRepository userRepository, CourseService courseService, CourseRepository courseRepository, ExerciseService exerciseService,
            ...
            StudentParticipationRepository studentParticipationRepository, ParticipantScoreService participantScoreService) {
    ...
    public List<CourseForDashboardDTO> getAllCoursesForDashboard() {
        long start = System.currentTimeMillis();
        log.debug(
                "REST request to get all Courses the user has access to with exercises, participations and results + the calculated scores the user achieved in each of those courses");
        User user = userRepository.getUserWithGroupsAndAuthorities();
