...
public final class Constants {
    ...
    public static final long LIVE_STATISTICS_CACHE_RESET_DELAY = 60 * 30; // 30 minutes in seconds

    public static final String HAZELCAST_LIVE_STATISTICS_PREFIX = "live-statistics-";
