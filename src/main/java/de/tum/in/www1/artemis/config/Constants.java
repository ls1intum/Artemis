...
public final class Constants {
    ...
    public static final String PROGRAMMING_EXERCISE_SUCCESSFUL_LOCK_STASH_OPERATION_NOTIFICATION = "The student repositories for this programming exercise were locked successfully and all not submitted changes were stashed when the due date has passed.";
