...
public final class Constants {
    ...
    public static final String TEST_CASES_DUPLICATE_NOTIFICATION = "There are duplicated test cases in this programming exercise. All test cases should be unique and not have the same name. The following test cases are duplicated: ";
