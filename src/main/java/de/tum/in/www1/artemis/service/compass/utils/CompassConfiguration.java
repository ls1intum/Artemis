...
public class CompassConfiguration {
    ...
    public final static double RELATION_TYPE_WEIGHT = 0.2;
    public final static double RELATION_ELEMENT_WEIGHT = 0.4;
    ...
    public final static double EQUALITY_THRESHOLD = 0.97;
    public final static double POORLY_ASSESSED_MODEL_THRESHOLD = 0.8;

    public final static double PARTIALLY_NAME_WEIGHT = 0.7;
