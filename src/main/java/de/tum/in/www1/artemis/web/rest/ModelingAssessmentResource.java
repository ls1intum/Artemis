...
public class ModelingAssessmentResource extends AssessmentResource {
  ...
  public ResponseEntity<String> getPartialAssessment(@PathVariable Long submissionId) {
    ...
    checkAuthorization(modelingExercise);
    JsonObject partialAssessment =
        compassService.getPartialAssessment(participation.getExercise().getId(), submissionId);
  ...
  public ResponseEntity<String> getAssessmentBySubmissionId(@PathVariable Long submissionId) {
    ModelingSubmission submission = modelingSubmissionService.findOne(submissionId);
    Participation participation = submission.getParticipation();
    ...
    String assessment =
        modelingAssessmentService.findLatestAssessment(exerciseId, studentId, submissionId);
    if (assessment == null) {
      throw new ResponseStatusException(
          HttpStatus.NOT_FOUND, "no assessment for given submission available");
    }
