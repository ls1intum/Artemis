...
import de.tum.in.www1.artemis.service.connectors.lti.oauth.OAuthAccessor;
import de.tum.in.www1.artemis.service.connectors.lti.oauth.OAuthException;
import de.tum.in.www1.artemis.service.connectors.lti.oauth.signature.pem.PEMReader;
import de.tum.in.www1.artemis.service.connectors.lti.oauth.signature.pem.PKCS1EncodedKeySpec;
...
public class RSA_SHA1 extends OAuthSignatureMethod {
    ...
    private PrivateKey loadPrivateKey(Object privateKeyObject) throws IOException, GeneralSecurityException {
        ...
        if (privateKeyObject instanceof PrivateKey) {
            ...
            throw new IllegalArgumentException(
                    "Private key set through RSA_SHA1.PRIVATE_KEY must be of " + "type PrivateKey, String or byte[] and not " + privateKeyObject.getClass().getName());
        }
    ...
    private PublicKey loadPublicKey(Object publicKeyObject, boolean isCert) throws IOException, GeneralSecurityException {
        ...
        if (publicKeyObject instanceof PublicKey) {
            ...
            throw new IllegalArgumentException(
                    "Public key or certificate set through " + source + " must be of " + "type PublicKey, String or byte[], and not " + publicKeyObject.getClass().getName());
        }
