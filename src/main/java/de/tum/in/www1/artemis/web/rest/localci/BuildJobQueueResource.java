...
public class BuildJobQueueResource {
    ...
    public ResponseEntity<List<LocalCIBuildJobItem>> getQueuedBuildJobsForCourse(@PathVariable long courseId) {
        ...
        List<LocalCIBuildJobItem> buildJobQueue = localCIBuildJobQueueService.getQueuedJobsForCourse(courseId);
    ...
    @EnforceAtLeastInstructor
    public ResponseEntity<List<LocalCIBuildJobItem>> getRunningBuildJobsForCourse(@PathVariable long courseId) {
        ...
        List<LocalCIBuildJobItem> runningBuildJobs = localCIBuildJobQueueService.getProcessingJobsForCourse(courseId);
