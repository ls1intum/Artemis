...
public class LoggingConfiguration {
    ...
    private void addLogstashTcpSocketAppender(LoggerContext context) {
        ...
        logstashAppender
                .addDestinations(new InetSocketAddress(this.jHipsterProperties.getLogging().getLogstash().getHost(), this.jHipsterProperties.getLogging().getLogstash().getPort()));
    ...
    /**
     * Logback configuration is achieved by configuration file and API. When configuration file change is detected, the configuration is reset. This listener ensures that the
