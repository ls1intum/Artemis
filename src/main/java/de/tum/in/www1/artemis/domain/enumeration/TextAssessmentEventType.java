...
public enum TextAssessmentEventType {
    ADD_FEEDBACK_AUTOMATICALLY_SELECTED_BLOCK, ADD_FEEDBACK_MANUALLY_SELECTED_BLOCK, HOVER_OVER_IMPACT_WARNING, VIEW_AUTOMATIC_SUGGESTION_ORIGIN, DELETE_FEEDBACK,
    EDIT_AUTOMATIC_FEEDBACK, SUBMIT_ASSESSMENT, ASSESS_NEXT_SUBMISSION
}
