...
public class RegistrationNumbersNotFoundException extends BadRequestAlertException {
    ...
    public RegistrationNumbersNotFoundException(List<String> registrationNumbers) {
        super(ErrorConstants.REGISTRATION_NUMBER_NOT_FOUND, "Users with registration numbers could not be found.", TeamResource.ENTITY_NAME, ERROR_KEY, getParameters(registrationNumbers));
    }
