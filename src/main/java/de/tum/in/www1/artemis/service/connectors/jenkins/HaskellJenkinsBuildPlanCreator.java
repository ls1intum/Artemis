...
@Profile("jenkins")
@Component
public class HaskellJenkinsBuildPlanCreator extends AbstractJenkinsBuildPlanCreator {

    public HaskellJenkinsBuildPlanCreator(ResourceLoader resourceLoader) {
        super(resourceLoader);
    }

    @Override
    public Document buildBasicConfig(URL testRepositoryURL, URL assignmentRepositoryURL) {
        final var resourcePath = Path.of("templates", "jenkins", "haskell", "config.xml");
    ...
    public Document buildConfigWithStaticCodeAnalysis(URL testRepositoryURL, URL assignmentRepositoryURL) {
        throw new UnsupportedOperationException("Jenkins builds with static code analysis not yet supported for Haskell!");
    }
    ...
    public Document buildBasicConfig(URL testRepositoryURL, URL assignmentRepositoryURL, boolean isSequential) {
        ...
        throw new UnsupportedOperationException("Sequential Jenkins builds not yet supported for Haskell!");
    }
}
