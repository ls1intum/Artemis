...
import { MoreFeedbackForTutorComponent } from './more-feedback-for-tutor.component';
...
@NgModule({
    ...
    exports: [MoreFeedbackForTutorComponent],
    providers: [
        JhiAlertService,
        ComplaintService,
...
export class ArTEMiSMoreFeedbackForTutorModule {
