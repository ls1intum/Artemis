ReEvaluateDragAndDropQuestionController.$inject = ['$translate', '$translatePartialLoader', '$scope', 'FileUpload', '$document', 'MAX_FILE_SIZE', 'ArtemisMarkdown', 'DragAndDropQuestionUtil'];

function ReEvaluateDragAndDropQuestionController($translate, $translatePartialLoader, $scope, FileUpload, $document, MAX_FILE_SIZE, ArtemisMarkdown, DragAndDropQuestionUtil) {
    ...
    function deleteDragItem(dragItemToDelete) {
        ...
        deleteMappingsForDropLocation(dragItemToDelete);
    }
...
angular.module('artemisApp').component('reEvaluateDragAndDropQuestion', {
    ...
    controller: ReEvaluateDragAndDropQuestionController,
    controllerAs: 'vm',
    bindings: {
        question: '=',
        onDelete: '&',
