import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, OnInit, Output, ViewEncapsulation, inject, model, viewChild } from '@angular/core';
...
export class MultipleChoiceQuestionEditComponent implements OnInit, QuizQuestionEdit {
    ...
    readonly question = model.required<MultipleChoiceQuestion>();
    readonly questionIndex = model<number>(undefined!);
