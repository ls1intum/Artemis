...
import {StudentQuestionAnswerComponent} from "app/overview/student-questions/student-question-answer.component";
import { ArtemisMarkdownEditorModule } from 'app/shared/markdown-editor/markdown-editor.module';

@NgModule({
    imports: [ArtemisSharedModule, ArtemisSidePanelModule, ArtemisConfirmIconModule, ArtemisMarkdownEditorModule],
    declarations: [StudentQuestionsComponent, StudentQuestionRowComponent, StudentQuestionAnswerComponent],
