...
@NgModule({
    imports: [ArtemisAppRoutingModule, ArtemisSharedModule, ArtemisSharedCommonModule, ArtemisSharedComponentModule, ArtemisExamSharedModule, ArtemisSidebarModule],
