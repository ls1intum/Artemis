...
@NgModule({
    imports: [RouterModule.forChild(routes), ArtemisCompetenciesModule, CourseRegistrationButtonModule, CoursePrerequisitesButtonModule, CourseRegistrationComponent],
})
