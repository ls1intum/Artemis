(function() {
    ...
    angular.module('artemisApp').config(stateConfig);

    stateConfig.$inject = ['$stateProvider'];

    function stateConfig($stateProvider) {
        $stateProvider.state('instructor-dashboard', {
            parent: 'app',
            url: '/course/{courseId}/exercise/{exerciseId}/dashboard',
            data: {
                authorities: [
                    'ROLE_ADMIN', 'ROLE_INSTRUCTOR', 'ROLE_TA'
                ],
                ...
                function($stateParams, $state, $uibModal) {
                    $uibModal.open({
                        ...
                        resolve: {
                            ...
                            entity: function() {
                                return {resultString: null, completionDate: new Date(), successful: true, score: 100, id: null};
                            },
                            translatePartialLoader: [
                                '$translate',
                                '$translatePartialLoader',
        ...
        }).state('instructor-dashboard.exportRepos', {
            parent: 'instructor-dashboard',
            url: '/exportRepos',
            data: {
                authorities: ['ROLE_ADMIN', 'ROLE_INSTRUCTOR', 'ROLE_TA']
            ...
            onEnter: [
                ...
                function($stateParams, $state, $uibModal) {
                    $uibModal.open({
                        templateUrl: 'app/instructor-dashboard/instructor-dashboard-repo-export-dialog.html',
                        controller: 'RepoExportController',
                        controllerAs: 'vm',
                        size: 'md',
                        resolve: {
                            entity: [
