...
@Component({
    selector: 'jhi-exercise-row-columnar',
    templateUrl: './exercise-row-columnar.component.html',
    styleUrl: './exercise-row-columnar.component.scss',
    imports: [
        RouterLink,
        FormsModule,
        CdkDragHandle,
...
export class ExerciseRowColumnarComponent {
    ...
    /** Hidden in the Type view, where the type icon already sits in the group header. */
