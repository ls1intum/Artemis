...
export class CourseExercisePerformanceComponent implements OnInit {
    ...
    readonly yourScoreLabel = computed(() => this.translateService.instant('artemisApp.courseStudentDashboard.exercisePerformance.yourScoreLabel'));
    readonly averageScoreLabel = computed(() => this.translateService.instant('artemisApp.courseStudentDashboard.exercisePerformance.averageScoreLabel'));
