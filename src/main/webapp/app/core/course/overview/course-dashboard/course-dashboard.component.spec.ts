...
describe('CourseDashboardComponent', () => {
    ...
    it('should show loading spinner when isLoading is true', () => {
        // isLoading is set to true by loadMetrics which is called due to mock course having studentCourseAnalyticsDashboardEnabled
        fixture.changeDetectorRef.detectChanges();

        const spinner = debugElement.query(By.css('.spinner-border'));
        // isLoading is true because loadMetrics was called
