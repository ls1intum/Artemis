...
/**
 * Builds the shared field mapping common to both create and update DTOs.
 */
function courseToBaseDTO(course: Course): CourseCreateDTO {
    return {
        title: course.title!,
...
export function toCourseUpdateDTO(course: Course): CourseUpdateDTO {
    const base = courseToBaseDTO(course);
