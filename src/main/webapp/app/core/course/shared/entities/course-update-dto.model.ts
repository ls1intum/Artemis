...
/**
 * Extracts the fields shared between CourseCreateDTO and CourseUpdateDTO from a Course entity.
 */
function toCourseBaseFields(course: Course): Omit<CourseCreateDTO, never> {
    return {
        title: course.title!,
...
export function toCourseCreateDTO(course: Course): CourseCreateDTO {
    return toCourseBaseFields(course);
}
