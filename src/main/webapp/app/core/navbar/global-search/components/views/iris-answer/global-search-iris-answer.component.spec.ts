...
const SOURCES: LectureSearchResult[] = [
    { course: { id: 1, name: 'Course A' }, lecture: { id: 1, name: 'L1' }, lectureUnit: { id: 1, name: 'Unit 1', link: '/u/1', pageNumber: 1 } },
    { course: { id: 1, name: 'Course A' }, lecture: { id: 1, name: 'L1' }, lectureUnit: { id: 2, name: 'Unit 2', link: '/u/2', pageNumber: 2 } },
    { course: { id: 1, name: 'Course A' }, lecture: { id: 1, name: 'L1' }, lectureUnit: { id: 3, name: 'Unit 3', link: '/u/3', pageNumber: 3 } },
];
...
describe('GlobalSearchIrisAnswerComponent', () => {
    ...
    describe('ask() pipeline integration', () => {
        ...
        it('should set irisThinking to true when a thinking update is received', () => {
            ...
            askSubject.next({ isThinking: true });
            fixture.detectChanges();
        ...
        it('should set irisResult with the answer when the final update is received', () => {
            ...
            askSubject.next({ isThinking: false, answer: 'Signals are reactive.', sources: [] });
            fixture.detectChanges();
        ...
        it('should set irisResult to undefined if the final update has no answer', () => {
            ...
            askSubject.next({ isThinking: false });
            fixture.detectChanges();
        ...
        it('should reset irisResult and irisThinking when a new query is debounced', () => {
            ...
            askSubject.next({ isThinking: false, answer: 'First answer', sources: [] });
            fixture.detectChanges();
