...
describe('CalendarEventFilterComponent', () => {
    ...
    describe('desktop variant', () => {
        beforeEach(() => {
            fixture.componentRef.setInput('variant', CalendarEventFilterComponentVariant.DESKTOP);
    ...
    describe('mobile variant', () => {
        beforeEach(() => {
            fixture.componentRef.setInput('variant', CalendarEventFilterComponentVariant.MOBILE);
            fixture.detectChanges();
        });
