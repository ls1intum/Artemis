...
export const LANDING_SECTIONS: LandingFeatureSection[] = [
    ...
    },
    {
        ...
        reverse: true,
        visualType: 'illustration',
        illustrationIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>`,
        bullets: ['0', '1', '2'],
    },
    {
        id: 'modeling',
        ...
        variant: 'narrative',
        visualType: 'illustration',
        illustrationIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 17h7"/><path d="M17.5 14v7"/></svg>`,
        bullets: ['0', '1', '2'],
    },
    {
        id: 'exams',
    ...
    },
    {
        ...
        variant: 'deep-dive',
        visualType: 'illustration',
        illustrationIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>`,
        bullets: ['0', '1', '2'],
