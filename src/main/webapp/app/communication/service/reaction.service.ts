...
import { Reaction, toReactionDTO } from 'app/communication/shared/entities/reaction.model';
...
export class ReactionService {
    ...
    create(courseId: number, reaction: Reaction): Observable<EntityResponseType> {
        return this.http
            .post<Reaction>(`${this.resourceUrl}${courseId}/postings/reactions`, toReactionDTO(reaction), { observe: 'response' })
