...
describe('PostingContentComponent', () => {
    ...
    it('should calculate correct pattern matches for content without reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do not want to reference a Post.');
            expect(component.getPatternMatches()).toEqual([]);
            component.content = input<string>('I do not want to reference a Post - #yolo.');
            expect(component.getPatternMatches()).toEqual([]);
            component.content = input<string>('##I do not want to reference a Post.');
            expect(component.getPatternMatches()).toEqual([]);
            component.content = input<string>('## 1. do not want to reference a Post.');
            expect(component.getPatternMatches()).toEqual([]);
        });
    });
    ...
    it('should calculate correct pattern matches for content with one post reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference #4!');
    ...
    it('should calculate correct pattern matches for content with post references', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference #4 and #10 in my posting content.');
            const firstMatch = { startIndex: 23, endIndex: 25, referenceType: ReferenceType.POST } as PatternMatch;
    ...
    it('should calculate correct pattern matches for content with one file upload exercise reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [file-upload](courses/1/exercises/1)File Upload Exercise[/file-upload]!');
            const firstMatch = {
                startIndex: 23,
                endIndex: 93,
    ...
    it('should calculate correct pattern matches for content with one modeling exercise reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [modeling](courses/1/exercises/1)Modeling Exercise[/modeling]!');
    ...
    it('should calculate correct pattern matches for content with one quiz exercise reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [quiz](courses/1/exercises/1)Quiz Exercise[/quiz]!');
    ...
    it('should calculate correct pattern matches for content with one programming exercise reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [programming](courses/1/exercises/1)Programming Exercise[/programming]!');
            const firstMatch = {
                startIndex: 23,
                endIndex: 93,
    ...
    it('should calculate correct pattern matches for content with one text exercise reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [text](courses/1/exercises/1)Text Exercise[/text]!');
    ...
    it('should calculate correct pattern matches for content with one lecture reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [lecture](courses/1/lectures/1)Lecture[/lecture]!');
    ...
    it('should calculate correct pattern matches for content with one attachment reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [attachment](attachmentPath/attachment.pdf)PDF File[/attachment]!');
            const firstMatch = {
                startIndex: 23,
                endIndex: 87,
    ...
    it('should calculate correct pattern matches for content with one user reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [user]name(login)[/user]!');
    ...
    it('should calculate correct pattern matches for content with one channel reference', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>('I do want to reference [channel]test(1)[/channel]!');
    ...
    it('should calculate correct pattern matches for content with post, multiple exercise, lecture and attachment references', () => {
        runInInjectionContext(fixture.debugElement.injector, () => {
            component.content = input<string>(
    ...
    describe('Computing posting content parts', () => {
        ...
        it('should include content before and reference as well as a linked reference within an exercise context', fakeAsync(() => {
            ...
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference #${idOfExercisePostToReference} in the same exercise context.`);
        ...
        it('should include content before and reference as well as a linked reference within a lecture context', fakeAsync(() => {
            ...
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference #${idOfLecturePostToReference} in the same lecture context.`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a post with course-wide context while being at a lecture page', fakeAsync(() => {
            ...
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference #${idOfCourseWidePostToReference} with course-wide context while currently being at a lecture page.`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a post with lecture context while being at a lecture page', fakeAsync(() => {
            ...
            const idOfExercisePostToReference = metisExercisePosts[0].id!;
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference #${idOfExercisePostToReference} with exercise context while currently being at a lecture page.`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a file upload exercise', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [file-upload]File Upload Exercise(courses/1/exercises/1)[/file-upload].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a modeling exercise', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [modeling]Modeling Exercise(courses/1/exercises/1)[/modeling].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a quiz exercise', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [quiz]Quiz Exercise(courses/1/exercises/1)[/quiz].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a programming exercise', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [programming]Programming Exercise(courses/1/exercises/1)[/programming].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a text exercise', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [text]Text Exercise(courses/1/exercises/1)[/text].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a lecture', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [lecture]Lecture 1(courses/1/lectures/1)[/lecture].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing an attachment', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [attachment]PDF File(attachmentPath/attachment.pdf)[/attachment].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
        ...
        it('should compute parts when referencing an lecture unit', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [lecture-unit]PDF File lecture unit(attachmentPath/attachmentUnit.pdf)[/lecture-unit].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                // the attachment directory that is removed when showing the text in edit mode
                const attachmentDirectory = 'api/core/files/attachments/';
        ...
        it('should compute parts when referencing a single slide', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [slide]PDF File Slide 7(slides/attachment-unit/123/slide/9)[/slide].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                // the attachment directory that is removed when showing the text in edit mode
                const attachmentDirectory = 'api/core/files/attachments/';
        ...
        it('should compute parts when referencing a user', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`This message is important for [user]Test(test_login)[/user].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a faq', () => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`I want to reference [faq]faq(/courses/1/faq?faqId=45)[/faq].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should compute parts when referencing a channel', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`This topic belongs to [channel]test(1)[/channel].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
        ...
        it('should set channelID undefined if referenced a channel id is not a number', fakeAsync(() => {
            runInInjectionContext(fixture.debugElement.injector, () => {
                component.content = input<string>(`This topic belongs to [channel]test(abc)[/channel].`);
                const matches = component.getPatternMatches();
                component.computePostingContentParts(matches);
                expect(component.postingContentParts()).toEqual([
                    {
