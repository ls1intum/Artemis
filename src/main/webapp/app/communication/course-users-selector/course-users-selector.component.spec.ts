...
describe('CourseUsersSelectorComponent', () => {
    ...
    const courseManagementServiceMock = { searchUsers: vi.fn() } as unknown as CourseManagementService;
    ...
    testCases.forEach((testCase) => {
        it('changing connected wrapper should update the component property', async () => {
        ...
        it('should convert undefined to empty array', async () => {
            userSelectorComponent.writeValue(undefined);
            wrapperComponent.multiSelect = testCase.multiSelect;
            fixture.changeDetectorRef.detectChanges();
            await fixture.whenStable();
        ...
        it('searching, selecting and deleting a user should update the selectedUsers property', async () => {
            wrapperComponent.selectedUsers = [];
            wrapperComponent.multiSelect = testCase.multiSelect;
            ...
            const searchStub = vi.spyOn(courseManagementServiceMock, 'searchUsers').mockReturnValue(of(searchResponse));
        ...
        it('should block the input field and not show delete button', async () => {
            wrapperComponent.multiSelect = testCase.multiSelect;
            const exampleUserPublicInfoDTO = generateExampleUserPublicInfoDTO({});
            wrapperComponent.selectedUsers = [exampleUserPublicInfoDTO];
        ...
        it('should render profile picture for users in dropdown', async () => {
            const user = generateExampleUserPublicInfoDTO({});
