...
describe('AnswerPostComponent', () => {
    ...
    it('should have correct content in posting-content component', () => {
        ...
        const contentInput = ngMocks.input(postingContentDebugElement, 'content');
        const content = typeof contentInput === 'function' ? contentInput() : contentInput;
    ...
    it('should close previous dropdown when another is opened', () => {
        ...
        vi.spyOn(window, 'getComputedStyle').mockReturnValue({ cursor: 'default' } as CSSStyleDeclaration);
