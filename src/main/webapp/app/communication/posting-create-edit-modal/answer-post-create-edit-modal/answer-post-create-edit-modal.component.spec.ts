...
describe('AnswerPostCreateEditModalComponent', () => {
    ...
    it('should invoke metis service with created answer post', fakeAsync(() => {
        ...
        component.confirm();
        expect(metisServiceCreateSpy).toHaveBeenCalledWith(Object.assign({}, component.posting, { content: newContent }));
        tick();
    ...
    it('should invoke metis service with updated answer post', fakeAsync(() => {
        ...
        component.confirm();
        expect(metisServiceCreateSpy).toHaveBeenCalledWith(Object.assign({}, component.posting, { content: updatedContent }));
        tick();
        expect(component.isLoading).toBeFalsy();
    }));
