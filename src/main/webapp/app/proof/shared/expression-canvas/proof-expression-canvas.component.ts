...
import { MathNodeComponent, MathNodeContext } from '../../manage/update/proof-math-node/proof-math-node.component';

@Component({
    selector: 'jhi-proof-expression-canvas',
    templateUrl: './proof-expression-canvas.component.html',
    imports: [MathNodeComponent],
})
export class ProofExpressionCanvasComponent {
