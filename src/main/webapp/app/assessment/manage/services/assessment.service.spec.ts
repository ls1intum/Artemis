import { isAllowedToModifyFeedback, isAllowedToRespondToComplaintAction } from 'app/assessment/manage/services/assessment.service';
...
describe('Assessment Service', () => {
    ...
    const complaintOnAutomaticResult = Object.assign({}, complaint, { result: automaticResult });
    const feedbackRequestOnAutomaticResult = Object.assign({}, feedbackRequest, { result: automaticResult });
