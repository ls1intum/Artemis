...
import { InstructorConflictResolutionComponent } from './instructor-conflict-resolution/instructor-conflict-resolution.component';
...
@NgModule({
    declarations: [
        ...
        InstructorConflictResolutionComponent,
    ],
