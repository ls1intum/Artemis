...
import { convertRenderedSVGToPNG } from 'app/apollon-diagrams/exercise-generation/svg-renderer';
...
import { ScoringType } from 'app/entities/quiz-question/quiz-question.model';
