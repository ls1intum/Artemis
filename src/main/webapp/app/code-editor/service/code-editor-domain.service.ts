...
import { Participation, SolutionProgrammingExerciseParticipation, StudentParticipation, TemplateProgrammingExerciseParticipation } from 'app/entities/participation';
