...
import { StudentWithTeam, Team, TeamAssignmentPayload, TeamImportStrategyType } from 'app/exercise/entities/team.model';
import { TeamSearchUser } from 'app/exercise/entities/team-search-user.model';
