...
describe('ResultHistoryDropdownComponent', () => {
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            ...
            .then(() => {
                ...
                translateService.setTranslation('en', { artemisApp: { result: { aiTooltip: 'Generated by Athena AI' } } });
    ...
    describe('AI feedback indicator', () => {
        it('should render an accessible indicator for Athena results', () => {
            ...
            expect(indicator?.getAttribute('aria-label')).toBe('Generated by Athena AI');
        });
