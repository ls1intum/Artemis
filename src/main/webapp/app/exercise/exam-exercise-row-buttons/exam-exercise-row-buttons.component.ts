...
export class ExamExerciseRowButtonsComponent implements OnInit {
    ...
    /** Controls the AI variant generation wizard opened via the "Create Variant with AI" button. */
    readonly aiVariantModalVisible = signal(false);
    /** Exposed to the template: only some exercise types can be varied by the generator. */
