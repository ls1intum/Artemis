...
describe('ExerciseFeedbackSuggestionOptionsComponent', () => {
    ...
    it('should initialize with available modules', async () => {
        ...
        fixture.componentRef.setInput('exercise', { type: ExerciseType.TEXT, dueDate: futureDueDate, feedbackSuggestionModule: undefined } as Exercise);
    ...
    it('should disable input controls for programming exercises with automatic assessment type or read-only', () => {
        fixture.componentRef.setInput('exercise', { type: ExerciseType.PROGRAMMING, assessmentType: AssessmentType.AUTOMATIC, dueDate: futureDueDate } as Exercise);
    ...
    it('should disable input controls if due date has passed', () => {
        fixture.componentRef.setInput('exercise', { type: ExerciseType.TEXT, dueDate: pastDueDate } as Exercise);
