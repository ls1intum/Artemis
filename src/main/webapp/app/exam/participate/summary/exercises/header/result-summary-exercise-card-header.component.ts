...
@Component({
    ...
    templateUrl: './result-summary-exercise-card-header.component.html',
    styleUrls: ['./result-summary-exercise-card-header.component.scss'],
})
export class ResultSummaryExerciseCardHeaderComponent {
    @Input() index: number;
