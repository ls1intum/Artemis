...
describe('ExamRequestAiFeedbackButtonComponent', () => {
    ...
    const exam = { id: 1, title: 'ExamForTesting', examType: ExamType.REAL, course } as Exam;
    const testExam = { id: 2, title: 'TestExam for Testing', examType: ExamType.TEST, course } as Exam;
