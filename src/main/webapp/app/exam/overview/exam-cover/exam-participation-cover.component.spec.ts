...
describe('ExamParticipationCoverComponent', () => {
    ...
    it('should start exam', async () => {
        ...
        examWithStartDate.examType = ExamType.REAL;
        ...
        examFutureStart.examType = ExamType.REAL;
        ...
        examNoStart.id = 123;
        examNoStart.examType = ExamType.REAL;
        ...
        testExamFuture.examType = ExamType.TEST;
        ...
        testExamNoStart.examType = ExamType.TEST;
    ...
    it('should update displayed times if exam suddenly started', () => {
        ...
        examWithDate.id = 123;
        examWithDate.examType = ExamType.REAL;
    ...
    it('should get start button enabled and end button enabled', () => {
        ...
        examVisible.id = 123;
        examVisible.examType = ExamType.REAL;
    ...
    it('should disable exam button', () => {
        ...
        examFuture.id = 123;
        examFuture.examType = ExamType.REAL;
