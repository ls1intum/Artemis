...
@Component({
    ...
    `,
    imports: [ExamResultSummaryComponent, CourseTitleBarTitleDirective, CourseTitleBarActionsDirective, TumAetUiButtonDirective, FaIconComponent, TranslateDirective],
})
