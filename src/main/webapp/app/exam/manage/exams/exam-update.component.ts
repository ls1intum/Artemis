...
export class ExamUpdateComponent implements OnInit, OnDestroy {
    ...
    get examDefaultStartText(): string {
        ...
        const checkForPlagiarismText =
            "All your submissions will be checked for plagiarism. If you happen to copy code, for example, from a book or a website, you must cite the reference by adding a note at the relevant places, e.g. <span class='fw-bold text-primary'>adapted from https://sourcemaking.com/design_patterns/bridge</span>. Failing to do so is classified as plagiarism. Copying code from other students is not allowed and is classified as plagiarism.\n\n";
