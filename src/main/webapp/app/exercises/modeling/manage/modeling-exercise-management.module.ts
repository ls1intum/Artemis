...
@NgModule({
    imports: [ArtemisExampleModelingSubmissionModule, ArtemisModelingExerciseModule, ArtemisSharedCommonModule, ArtemisSharedComponentModule, ArtemisSharedPipesModule],
})
