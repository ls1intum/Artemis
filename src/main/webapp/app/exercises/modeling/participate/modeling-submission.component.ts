...
export class ModelingSubmissionComponent implements OnInit, OnDestroy, ComponentCanDeactivate {
    ...
    private subscribeToNewResultsWebsocket(): void {
        ...
        this.resultUpdateListener = this.participationWebsocketService.subscribeForLatestResultsOfParticipation(this.participation.id, true).subscribe((newResult: Result) => {
