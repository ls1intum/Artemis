...
@Component({
    ...
    standalone: true,
    imports: [NgbDropdown, NgbDropdownToggle, FaIconComponent, TranslateDirective, NgbDropdownMenu, RouterLink, NgClass, ArtemisSharedModule, ArtemisSharedPipesModule],
})
