...
@Component({
    ...
    standalone: true,
    imports: [FaIconComponent, FormsModule, NgbTooltip, NgbCollapse, TranslateDirective, ArtemisMarkdownEditorModule, CdkDropList, CdkDrag, CdkDragHandle, ArtemisTranslatePipe],
})
