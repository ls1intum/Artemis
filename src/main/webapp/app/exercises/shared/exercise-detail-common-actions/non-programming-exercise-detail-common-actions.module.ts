...
@NgModule({
    ...
    imports: [ArtemisSharedCommonModule, ArtemisExerciseScoresModule, RouterModule, ArtemisAssessmentSharedModule, NonProgrammingExerciseDetailCommonActionsComponent],
})
