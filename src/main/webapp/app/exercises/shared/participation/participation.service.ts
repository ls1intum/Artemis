...
export class ParticipationService {
    ...
    getLogsAvailabilityForResultsOfParticipation(participationId: number): Observable<{ [key: string]: string }> {
        return this.http.get<{ [key: string]: string }>(`${this.resourceUrl}/${participationId}/results/logs-available`);
    }
