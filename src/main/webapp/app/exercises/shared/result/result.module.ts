...
import { FeedbackListComponent } from 'app/exercises/shared/result/feedback-list-component';
...
@NgModule({
    ...
    declarations: [ResultDetailComponent, ResultHistoryComponent, FeedbackCollapseComponent, FeedbackListComponent],
