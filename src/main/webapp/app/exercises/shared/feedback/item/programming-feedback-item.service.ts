...
export class ProgrammingFeedbackItemService implements FeedbackItemService {
    ...
    private createFeedbackItem(feedback: Feedback, showTestDetails: boolean): FeedbackItem {
        ...
        } else if (Feedback.isContinuousPlagiarismControlFeedback(feedback)) {
            return this.createContinuousPlagiarismControlFeedbackItem(feedback);
    ...
    /**
     * Creates a feedback item from a feedback generated by the cpc.
     * This type of feedback always shows test details, as that text explains that results is generated by cpc.
     * @param feedback A feedback received from the cpc.
     * @private
     */
    private createContinuousPlagiarismControlFeedbackItem(feedback: Feedback) {
        return this.createAutomaticFeedbackItem(feedback, true);
    }
