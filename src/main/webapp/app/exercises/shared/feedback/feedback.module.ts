...
import { FeedbackItemNode } from 'app/exercises/shared/feedback/item/feedback-item-node.component';

@NgModule({
    imports: [ArtemisSharedModule, ArtemisProgrammingExerciseActionsModule, ArtemisSharedComponentModule, BarChartModule],
    declarations: [FeedbackCollapseComponent, FeedbackItemNode],
    exports: [FeedbackCollapseComponent, FeedbackItemNode],
})
