...
@NgModule({
    imports: [RouterModule.forChild(ENTITY_STATES), ArtemisResultModule, SubmissionResultStatusModule, ExampleSubmissionsComponent, ExampleSubmissionImportComponent],
})
