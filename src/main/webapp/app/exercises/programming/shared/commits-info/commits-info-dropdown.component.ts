...
@Component({
    selector: 'jhi-commits-info-dropdown',
    templateUrl: './commits-info-dropdown.component.html',
})
export class CommitsInfoDropdownComponent implements OnInit, OnDestroy {
