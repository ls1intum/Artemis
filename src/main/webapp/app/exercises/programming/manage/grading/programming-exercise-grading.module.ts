...
import { ConfigureGradingTasksComponent } from 'app/exercises/programming/manage/grading/tasks/configure-grading-tasks.component';
...
@NgModule({
    ...
    declarations: [
        ...
        ConfigureGradingTasksComponent,
