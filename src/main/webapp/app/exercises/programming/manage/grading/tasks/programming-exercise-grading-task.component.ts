...
import { faAngleDown, faAngleRight, faAsterisk, faMedal, faPlus, faQuestionCircle, faScaleUnbalanced, faWeightHanging, faXmark } from '@fortawesome/free-solid-svg-icons';
