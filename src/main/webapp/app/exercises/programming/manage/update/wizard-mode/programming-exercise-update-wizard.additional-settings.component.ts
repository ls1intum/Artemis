...
@Component({
    ...
    template: `
        <h1><span jhiTranslate="artemisApp.programmingExercise.wizardMode.detailedSteps.additionalStepTitle">Additional settings</span></h1>
        <p><span jhiTranslate="artemisApp.programmingExercise.wizardMode.detailedSteps.additionalStepMessage">Set additional settings related to infrastructure etc</span></p>
