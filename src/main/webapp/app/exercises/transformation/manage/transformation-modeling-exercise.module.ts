...
import { ArtemisTransformationModelingExerciseRoutingModule } from 'app/exercises/transformation/manage/transformation-modeling-exercise.route';
import { TransformationModelingExerciseComponent } from 'app/exercises/transformation/manage/transformation-modeling-exercise.component';
import { TransformationModelingExerciseDetailComponent } from 'app/exercises/transformation/manage/transformation-modeling-exercise-detail.component';
...
@NgModule({
    imports: [
        ...
        ArtemisTransformationModelingExerciseRoutingModule,
    ...
    declarations: [TransformationModelingExerciseComponent, TransformationModelingExerciseDetailComponent, TransformationModelingExerciseUpdateComponent],
    exports: [TransformationModelingExerciseComponent],
})
export class ArtemisTransformationModelingExerciseModule {}
