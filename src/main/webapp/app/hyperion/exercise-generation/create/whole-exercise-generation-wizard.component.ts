...
import { faArrowLeft, faArrowRight, faKeyboard, faSpinner } from '@fortawesome/free-solid-svg-icons';
...
export class WholeExerciseGenerationWizardComponent {
    ...
    readonly canGenerate = computed(() => {
        return this.courseId() !== undefined && this.brief().trim().length >= MIN_BRIEF_LENGTH && [ProjectType.PLAIN_MAVEN, ProjectType.PLAIN_GRADLE].includes(this.projectType());
    });
    ...
    private buildExercise(courseId: number): ProgrammingExercise {
        ...
        exercise.title = 'Generating exercise';
