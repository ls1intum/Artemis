...
describe('HyperionBriefDialogComponent', () => {
    ...
    it('derives metadata, creates a plain-source Maven draft and starts the same brief', () => {
        setupSucceeds();
        ...
        component.brief.set(`  ${BRIEF}  `);
        component.generate();
        expect(suggestMetadataSpy).toHaveBeenCalledExactlyOnceWith(COURSE_ID, BRIEF, ProjectType.PLAIN_MAVEN);
