...
import { TumUiButtonComponent, TumUiDialogComponent, TumUiInputDirective, TumUiMessageComponent, TumUiPanelComponent } from '@tumaet/ui-angular';
...
export class HyperionBriefDialogComponent {
    ...
    private deriveAndCreate(mayRetryNameConflict: boolean): void {
        this.generationService
            .suggestMetadata(this.runCourseId, this.runBrief, ProjectType.PLAIN_MAVEN)
    ...
    private buildExercise(metadata: HyperionMetadataSuggestion): ProgrammingExercise {
        ...
        // Plain student sources with a Maven test project: students need no build-tool configuration.
