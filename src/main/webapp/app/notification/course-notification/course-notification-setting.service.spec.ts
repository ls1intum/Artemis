...
describe('CourseNotificationSettingService', () => {
    ...
    describe('getSettingInfo', () => {
        it('should make GET request to fetch notification settings', () => {
            ...
            const req = httpMock.expectOne(`/api/notification/notification/${courseId}/settings`);
        ...
        it('should return cached value if available and forceFetch is false', () => {
            ...
            const firstReq = httpMock.expectOne(`/api/notification/notification/${courseId}/settings`);
            ...
            httpMock.expectNone(`/api/notification/notification/${courseId}/settings`);
            expect(result).toEqual(mockSettingInfo);
        });
        ...
        it('should make a new request if forceFetch is true, even with cached value', () => {
            ...
            const secondReq = httpMock.expectOne(`/api/notification/notification/${courseId}/settings`);
    ...
    describe('setSettingPreset', () => {
        it('should make PUT request to set notification preset', () => {
            ...
            const req = httpMock.expectOne(`/api/notification/notification/${courseId}/setting-preset`);
        ...
        it('should update the subject with new preset when current value exists', () => {
            ...
            service.setSettingPreset(courseId, presetTypeId, undefined);
            const updateReq = httpMock.expectOne(`/api/notification/notification/${courseId}/setting-preset`);
            updateReq.flush({});
            vi.advanceTimersByTime(0);
    ...
    describe('setSettingSpecification', () => {
        it('should make PUT request with transformed specifications', () => {
            ...
            const req = httpMock.expectOne(`/api/notification/notification/${courseId}/setting-specification`);
            expect(req.request.method).toBe('PUT');
        ...
        it('should update the subject with new specification when current value exists', () => {
            ...
            service.setSettingSpecification(courseId, specification, undefined);
            const updateReq = httpMock.expectOne(`/api/notification/notification/${courseId}/setting-specification`);
            updateReq.flush({});
            vi.advanceTimersByTime(0);
    ...
    describe('authentication state changes', () => {
        ...
        it('should clear cached setting subjects on logout', async () => {
            ...
            scopedHttpMock.expectOne(`/api/notification/notification/${courseId}/settings`).flush(settingInfo);
        ...
        it('should ignore in-flight HTTP responses after logout', async () => {
            const courseId = 7;
            scoped.getSettingInfo(courseId).subscribe();
            const inFlight = scopedHttpMock.expectOne(`/api/notification/notification/${courseId}/settings`);
        ...
        it('should not clear settings when the same user re-emits', () => {
            const courseId = 7;
            scoped.getSettingInfo(courseId).subscribe();
            scopedHttpMock.expectOne(`/api/notification/notification/${courseId}/settings`).flush({ selectedPreset: 1, notificationTypeChannels: {} });
