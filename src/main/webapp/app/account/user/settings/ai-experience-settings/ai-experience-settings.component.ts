...
import { TumUiButtonComponent, TumUiCardComponent } from '@tumaet/ui-angular';

@Component({
    selector: 'jhi-ai-experience-settings',
    imports: [TranslateDirective, ArtemisDatePipe, DeleteButtonDirective, RouterLink, TumUiButtonComponent, TumUiCardComponent],
