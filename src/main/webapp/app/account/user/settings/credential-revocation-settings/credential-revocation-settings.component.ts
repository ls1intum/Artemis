...
import { TumAetUiButtonDirective, TumAetUiCheckboxComponent } from '@tumaet/ui-angular';
...
@Component({
    ...
    imports: [TranslateDirective, FormsModule, TumAetUiCheckboxComponent, DeleteButtonDirective, TumAetUiButtonDirective],
})
