...
export class QuestionStatisticService {
    ...
    create(questionStatistic: QuestionStatistic): Observable<EntityResponseType> {
        ...
        return this.http
            .post<QuestionStatistic>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(questionStatistic: QuestionStatistic): Observable<EntityResponseType> {
        const copy = this.convert(questionStatistic);
        return this.http
            .put<QuestionStatistic>(this.resourceUrl, copy, { observe: 'response' })
            .map((res: EntityResponseType) => this.convertResponse(res));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<QuestionStatistic>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .map((res: EntityResponseType) => this.convertResponse(res));
    }
    ...
    query(req?: any): Observable<HttpResponse<QuestionStatistic[]>> {
        ...
        return this.http
            .get<QuestionStatistic[]>(this.resourceUrl, { params: options, observe: 'response' })
