...
@Component({
    ...
    template: `
        <ng-container *ngIf="programmingExercise && programmingExercise.shortName && !programmingExercise.id">
            <div class="mt-1">
            ...
            <div id="preview" class="row ml-2 mt-1 mb-1 pt-1 pb-1">
                        ...
                        <ul>
                            <li>
                                <code class="text-white badge badge-primary label-preview"
                                    >{{ programmingExercise.course?.shortName.toLowerCase() }}{{ programmingExercise.shortName.toLowerCase() }}-exercise</code
                                >
                                <jhi-help-icon placement="right" text="artemisApp.programmingExercise.preview.templateRepoTooltip"></jhi-help-icon>
                            </li>
                            <li>
                                <code class="text-white badge badge-primary label-preview"
                                    >{{ programmingExercise.course?.shortName.toLowerCase() }}{{ programmingExercise.shortName.toLowerCase() }}-solution</code
                                >
                                <jhi-help-icon placement="right" text="artemisApp.programmingExercise.preview.solutionRepoTooltip"></jhi-help-icon>
                            </li>
                            <li>
                                <code class="text-white badge badge-primary label-preview"
                                    >{{ programmingExercise.course?.shortName.toLowerCase() }}{{ programmingExercise.shortName.toLowerCase() }}-tests</code
                                >
                ...
                <div class="col-auto rounded bg-light pt-1 pb-1">
                    ...
                    <ul>
                        <li>
                            <code class="text-white badge badge-primary label-preview"
                                >{{ programmingExercise.course?.shortName }}{{ programmingExercise.shortName.toUpperCase() }}-BASE</code
                            >
                            <jhi-help-icon placement="right" text="artemisApp.programmingExercise.preview.templateBuildPlanTooltip"></jhi-help-icon>
                        </li>
                        <li>
                            <code class="text-white badge badge-primary label-preview"
                                >{{ programmingExercise.course?.shortName }}{{ programmingExercise.shortName.toUpperCase() }}-SOLUTION</code
                            >
