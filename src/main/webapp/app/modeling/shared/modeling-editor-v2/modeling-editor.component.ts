...
import { ModelingV2Component } from 'app/modeling/shared/modeling-v2/modeling.component';
import { TranslateDirective } from 'app/shared/language/translate.directive';

@Component({
    selector: 'jhi-modeling-editor-v2',
...
export class ModelingEditorV2Component extends ModelingV2Component implements AfterViewInit, OnDestroy, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        if (changes.umlModel && changes.umlModel.currentValue && this.apollonEditor) {
            ...
            // Apollon doesn't need assessments in Modeling mode
            // ModelingEditorV2Component.removeAssessments(this.umlModel);
