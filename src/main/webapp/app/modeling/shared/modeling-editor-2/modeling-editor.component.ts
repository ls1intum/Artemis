...
import { ApollonMode, SVG } from '@ls1intum/apollon';
...
import { ModelingComponent } from 'app/modeling/shared/modeling-2/modeling.component';
...
export class ModelingEditorComponent extends ModelingComponent implements AfterViewInit, OnDestroy, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.diagramType && changes.diagramType.currentValue && this.apollonEditor) {
            // Update diagram type
            this.apollonEditor.diagramType = changes.diagramType.currentValue;
        }
    }
