import { AfterViewInit, Component, DestroyRef, ElementRef, OnDestroy, effect, inject, input, output, signal, viewChild } from '@angular/core';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, TranscriptViewerComponent, FaIconComponent, ArtemisTranslatePipe, ResizableDirective, TumLiveAttributionComponent, MessageModule],
