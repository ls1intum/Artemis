...
export class LectureService {
    ...
    updateNames(dtos: LectureNameUpdateDTO[], courseId: number): Observable<void> {
        return this.http.put<void>(`api/lecture/courses/${courseId}/lectures/lecture-names`, dtos);
    }
