...
import { faChartBar, faClipboard, faComments, faEye, faFilePdf, faFlag, faGraduationCap, faListAlt, faTable, faTimes, faUserCheck, faWrench } from '@fortawesome/free-solid-svg-icons';
