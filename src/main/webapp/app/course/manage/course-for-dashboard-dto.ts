...
export class CourseForDashboardDTO {
    ...
    /**
     * Cannot use the proper Map type ({@link ScoresPerExerciseType}) here, because this CourseForDashboardDTO object represents the data returned from the server which is in JSON format and cannot contain an actual Map.
