...
import { OpenCodeEditorButtonComponent } from 'app/course/overview/exercise-details/open-code-editor-button/open-code-editor-button.component';
...
export class ExerciseDetailsStudentActionsComponent {
    ...
    private initializeExerciseSpecificState(exercise: Exercise): void {
        if (exercise.type === ExerciseType.QUIZ) {
            ...
            this._editorLabel.set('openProofEditor');
        }
    }
