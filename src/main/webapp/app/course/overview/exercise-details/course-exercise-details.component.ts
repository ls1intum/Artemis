...
import { Exercise, ExerciseType, getIcon } from 'app/exercise/entities/exercise.model';
...
import { getFirstResultWithComplaintFromResults } from 'app/exercise/entities/submission.model';
