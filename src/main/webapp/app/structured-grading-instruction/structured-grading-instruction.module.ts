...
import { GradingInstructionDetailComponent } from 'app/structured-grading-instruction/grading-instruction-detail/grading-instruction-detail.component';
...
export class StructuredGradingInstructionModule {}
