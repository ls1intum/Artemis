...
export class NavbarComponent implements OnInit, OnDestroy {
    ...
    breadcrumbTranslation = {
        ...
        live_statistics: 'artemisApp.examLiveStatistics.title',
        overview: 'artemisApp.examLiveStatistics.menu.overview.title',
        activity_log: 'artemisApp.examLiveStatistics.menu.activity-log.title',
