...
import { NEW_MESSAGE_TITLE, NEW_REPLY_MESSAGE_TITLE, Notification } from 'app/entities/notification.model';
...
const IRRELEVANT_NOTIFICATION_TITLES = [NEW_MESSAGE_TITLE, NEW_REPLY_MESSAGE_TITLE];
