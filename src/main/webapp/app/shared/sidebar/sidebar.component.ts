...
import { faChalkboardUser, faCubesStacked, faListCheck, faPersonChalkboard } from '@fortawesome/free-solid-svg-icons';
...
import { CachingStrategy } from '../image/secured-image.component';
