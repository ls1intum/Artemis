...
@NgModule({
    ...
    declarations: [HasAnyAuthorityDirective, SecuredImageComponent, DeleteDialogComponent, PresentationScoreComponent],
    ...
    exports: [ArtemisSharedCommonModule, ArtemisSharedPipesModule, HasAnyAuthorityDirective, SecuredImageComponent, TranslateModule, PresentationScoreComponent],
})
