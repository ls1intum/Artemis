...
export class NotificationSettingsService {
    ...
    private static NOTIFICATION_SETTING_ID_TO_NOTIFICATION_TITLE_MAP: Map<SettingId, string[]> = new Map([
        [SettingId.NOTIFICATION__EXERCISE_NOTIFICATIONS__EXERCISE_RELEASED, [EXERCISE_RELEASED_TITLE]],
        [SettingId.NOTIFICATION__EXERCISE_NOTIFICATIONS__EXERCISE_OPEN_FOR_PRACTICE, [EXERCISE_PRACTICE_TITLE]],
        [SettingId.NOTIFICATION__EXERCISE_NOTIFICATIONS__NEW_EXERCISE_POST, [NEW_EXERCISE_POST_TITLE]],
        [SettingId.NOTIFICATION__EXERCISE_NOTIFICATIONS__NEW_REPLY_FOR_EXERCISE_POST, [NEW_REPLY_FOR_EXERCISE_POST_TITLE]],
        [SettingId.NOTIFICATION__LECTURE_NOTIFICATIONS__ATTACHMENT_CHANGES, [ATTACHMENT_CHANGE_TITLE]],
        [SettingId.NOTIFICATION__LECTURE_NOTIFICATIONS__NEW_LECTURE_POST, [NEW_LECTURE_POST_TITLE]],
        [SettingId.NOTIFICATION__LECTURE_NOTIFICATIONS__NEW_REPLY_FOR_LECTURE_POST, [NEW_REPLY_FOR_LECTURE_POST_TITLE]],
        ...
        [SettingId.NOTIFICATION__INSTRUCTOR_NOTIFICATIONS__COURSE_AND_EXAM_ARCHIVING_STARTED, [EXAM_ARCHIVE_STARTED_TITLE, COURSE_ARCHIVE_STARTED_TITLE]],
    ]);
