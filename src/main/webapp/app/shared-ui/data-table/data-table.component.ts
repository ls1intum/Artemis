...
export class DataTableComponent implements OnInit {
     ...
     */
    templateRef = contentChild<TemplateRef<any>>(TemplateRef);
    ...
    searchFailed = input(false);
    searchNoResults = input(false);
    isTransitioning = input(false);
    showPageSizeDropdown = input(true);
    showSearchField = input(true);
    ...
    searchNoResultsTranslation = input('artemisApp.dataTable.search.noResults');
    searchPlaceholderTranslation = input<string>('');
    minQueryLengthHintTranslation = input('artemisApp.dataTable.search.minQueryLengthHint');
    searchFields = input<string[]>([]);
    searchEnabled = input(true);
    searchEntityFilterEnabled = input(true);
