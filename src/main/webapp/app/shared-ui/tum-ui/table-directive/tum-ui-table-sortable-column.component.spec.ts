...
// Signals so the controlled sort state propagates to the directive under the zoneless test harness.
@Component({
    template: `
...
describe('TumUiTableSortableColumnComponent', () => {
    ...
    it('reflects the controlled sort state via aria-sort and the icon paths', () => {
        // login is the active ascending column -> ascending, single-arrow icon (1 path).
        ...
        // email is not the active column -> none, neutral double-arrow icon (4 paths).
        ...
        // Flip the controlled order -> descending.
