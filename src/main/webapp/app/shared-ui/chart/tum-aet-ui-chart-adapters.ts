import { TumAetUiChartSeries } from '@tumaet/ui-angular';
import { ChartMultiSeriesEntry, ChartSeriesEntry } from 'app/shared-ui/chart/chart-data.model';

/** Categories and series in the shape the tumaet-ui chart components consume. */
export interface TumAetUiChartData {
    labels: string[];
    series: TumAetUiChartSeries[];
}
 ...
 */
export function singleSeriesChart(entries: ChartSeriesEntry[], colors: string[], seriesLabel?: string): TumAetUiChartData {
    return {
 ...
 */
export function stackedBarChart(entries: ChartMultiSeriesEntry[], segmentColors: string[]): TumAetUiChartData {
 ...
 */
export function normalizedStackedBarChart(entries: ChartMultiSeriesEntry[], segmentColors: string[]): TumAetUiChartData {
 ...
 */
export function multiSeriesLineChart(entries: ChartMultiSeriesEntry[], colors: string[]): TumAetUiChartData {
...
export function referenceLineSeries(label: string, value: number, length: number, color: string): TumAetUiChartSeries {
    return {
        label,
