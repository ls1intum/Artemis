...
import { buildDbQueryFromTableEvent } from './tumaet-ui-table-request-builder';

function event(overrides: Partial<TumAetUiTableQueryEvent> = {}): TumAetUiTableQueryEvent {
