...
@Component({
    ...
    imports: [FaIconComponent, TranslateDirective, DeleteButtonDirective, ArtemisDatePipe, ArtemisTranslatePipe, CancellationModalComponent, EditTutorialGroupSessionComponent],
})
export class TutorialGroupSessionRowButtonsComponent implements OnDestroy {
    ...
    readonly cancellationDialog = viewChild<CancellationModalComponent>('cancellationDialog');
    readonly editSessionDialog = viewChild<EditTutorialGroupSessionComponent>('editSessionDialog');
