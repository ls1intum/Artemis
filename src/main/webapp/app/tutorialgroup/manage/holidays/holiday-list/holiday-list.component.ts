...
@Component({
    ...
    imports: [FaIconComponent, FormsModule, TranslateDirective, ArtemisTranslatePipe, TumUiButtonDirective, TumUiSelectButtonComponent, TumUiTagComponent, TumUiTooltipDirective],
})
