...
import { coversWholeDays, endOfHolidayDay, groupHolidaysByDay, toHolidays } from 'app/tutorialgroup/manage/holidays/holiday.model';
...
describe('holiday model', () => {
    ...
    describe('groupHolidaysByDay', () => {
        it('should index a multi-day holiday under every day it covers', () => {
            ...
            const byDay = groupHolidaysByDay(holidays);
        ...
        it('should keep both times on a holiday confined to one day', () => {
            ...
            const [segment] = groupHolidaysByDay(holidays).get('2025-12-04')!;
        ...
        it('should collect every holiday that falls on the same day', () => {
            ...
            expect(groupHolidaysByDay(holidays).get('2025-12-17')).toHaveLength(2);
        });
    });
});
