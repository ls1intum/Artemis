...
import { DAY_KEY_FORMAT, HolidayOccurrence } from 'app/tutorialgroup/manage/holidays/holiday.model';
...
export class HolidayMonthGridComponent {
    ...
    readonly holidaysByDay = input.required<Map<string, HolidayOccurrence[]>>();
    ...
    readonly holidaySelected = output<HolidayOccurrence>();
