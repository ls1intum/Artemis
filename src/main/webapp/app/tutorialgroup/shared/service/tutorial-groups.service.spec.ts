...
describe('TutorialGroupService', () => {
    ...
    it('should get tutorial group detail group dto', async () => {
        ...
        expect(result).toMatchObject({
            ...
            teachingAssistantName: returnedFromService.tutorName,
            teachingAssistantLogin: returnedFromService.tutorLogin,
            teachingAssistantImageUrl: returnedFromService.tutorImageUrl,
