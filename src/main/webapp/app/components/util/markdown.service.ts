...
export class ArtemisMarkdown {
     ...
     */
    parseTextHintExplanation(markdownText: string, targetObject: MarkDownElement) {   // TODO: what is the proper type?
     ...
     */
    addHintAtCursor(editor: any) {   // TODO: what is the proper type?
     ...
     */
    addExplanationAtCursor(editor: any) {   // TODO: what is the proper type?
