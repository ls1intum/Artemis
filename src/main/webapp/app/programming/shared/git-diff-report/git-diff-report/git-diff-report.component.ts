                ...
                this.diffInformationForPaths.set(
                    this.filePaths()
                        .filter((path) => {
                            ...
                            return templateContent !== solutionContent || (templateContent === undefined) !== (solutionContent === undefined);
                        })
                        .map((path) => {
                            const templateFileContent = this.templateFileContentByPath().get(path) || undefined;
                            const solutionFileContent = this.solutionFileContentByPath().get(path) || undefined;
