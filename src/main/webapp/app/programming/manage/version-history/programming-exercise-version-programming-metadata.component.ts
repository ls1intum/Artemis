...
export class ProgrammingExerciseVersionProgrammingMetadataComponent {
    ...
    readonly languageFields = computed<MetadataField[]>(() => {
        ...
        return this.filterFieldsForMode([
            ...
            this.toTextField('allowOfflineIde', 'artemisApp.programmingExercise.allowOfflineIde.title', data.allowOfflineIde, previousData.allowOfflineIde),
            this.toTextField('allowOnlineEditor', 'artemisApp.programmingExercise.allowOnlineEditor.title', data.allowOnlineEditor, previousData.allowOnlineEditor),
            this.toTextField('allowOnlineIde', 'artemisApp.programmingExercise.allowOnlineIde.title', data.allowOnlineIde, previousData.allowOnlineIde),
            this.toTextField(
                'staticCodeAnalysisEnabled',
                'artemisApp.programmingExercise.enableStaticCodeAnalysis.title',
                data.staticCodeAnalysisEnabled,
                previousData.staticCodeAnalysisEnabled,
            ),
            this.toTextField(
            ...
            this.toTextField(
                ...
                data.showTestNamesToStudents,
                previousData.showTestNamesToStudents,
            ),
            this.toTextField(
                'releaseTestsWithExampleSolution',
                'artemisApp.programmingExercise.versionHistory.snapshot.releaseTestsWithExampleSolution',
                data.releaseTestsWithExampleSolution,
                previousData.releaseTestsWithExampleSolution,
            ),
        ]);
    });
    ...
    readonly gradingFields = computed<MetadataField[]>(() => {
        ...
        return this.filterFieldsForMode([
            ...
            this.toTextField(
                ...
                data.submissionPolicy?.active,
                previousData.submissionPolicy?.active,
            ),
            this.toTextField(
                'submissionLimit',
    ...
    readonly buildConfigurationFields = computed<MetadataField[]>(() => {
        ...
        return this.filterFieldsForMode([
            this.toTextField(
                ...
                buildConfig.sequentialTestRuns,
                previousBuildConfig.sequentialTestRuns,
            ),
            ...
            this.toTextField(
                ...
                previousBuildConfig.checkoutSolutionRepository,
            ),
            this.toTextField('allowBranching', 'artemisApp.programmingExercise.allowBranching.title', buildConfig.allowBranching, previousBuildConfig.allowBranching),
