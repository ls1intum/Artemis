...
export type ExerciseGenerationEventTerminationReasonEnum = 'CONVERGED' | 'REPAIR_BUDGET_EXHAUSTED' | 'ATTEMPT_CAP_REACHED' | 'MECHANICAL_REPAIR_EXHAUSTED' | 'POST_REPAIR_CORRECTION_EXHAUSTED' | 'NO_SCHEDULABLE_SURFACE' | 'REVIEW_UNAVAILABLE' | 'UNCHANGED_CANDIDATE_RESUBMITTED' | 'REPAIR_DID_NOT_IMPROVE' | 'NO_ADMISSIBLE_CONCEPT' | 'CANCELLED' | 'DEADLINE_EXCEEDED' | 'TOKEN_BUDGET_EXHAUSTED' | 'AGENT_ERROR' | 'ENVIRONMENT_UNAVAILABLE' | 'RUN_FAILED' | 'NOT_STARTED';
