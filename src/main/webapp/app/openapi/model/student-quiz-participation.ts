...
export type StudentQuizParticipationInitializationStateEnum =
    'UNINITIALIZED' | 'REPO_COPIED' | 'REPO_CONFIGURED' | 'INACTIVE' | 'BUILD_PLAN_COPIED' | 'BUILD_PLAN_CONFIGURED' | 'INITIALIZED' | 'FINISHED';
...
export const StudentQuizParticipationInitializationStateEnumValues = [
    'UNINITIALIZED',
    'REPO_COPIED',
    'REPO_CONFIGURED',
    'INACTIVE',
