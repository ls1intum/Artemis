...
export class GlobalSearchApi {
     ...
     * @param excludeTypes Comma-separated entity types to hide from the results; applied after \&#39;types\&#39;
     ...
     * @param courseId Deprecated, use courseIds. A single course ID, still honored for clients that predate courseIds
     */
    globalSearch(
        q: string,
        types?: string,
        ...
        excludeCourseIds?: Array<number>,
        limit?: number,
        courseId?: number,
    ): Observable<Array<GlobalSearchResult>> {
