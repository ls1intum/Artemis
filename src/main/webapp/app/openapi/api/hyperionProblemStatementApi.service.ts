...
// @ts-ignore
import { ProblemStatementRefinementRequest } from '../model/problemStatementRefinementRequest';
// @ts-ignore
...
export class HyperionProblemStatementApiService extends BaseService {
    ...
    public generateProblemStatement(courseId: number, problemStatementGenerationRequest: ProblemStatementGenerationRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/hyperion/courses/${this.configuration.encodeParam({name: "courseId", value: courseId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/problem-statements/generate`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProblemStatementGenerationResponse>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @endpoint post /api/hyperion/courses/{courseId}/problem-statements/refine
     * @param courseId 
    ...
    public refineProblemStatement(courseId: number, problemStatementRefinementRequest: ProblemStatementRefinementRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProblemStatementRefinementResponse>>;
    public refineProblemStatement(courseId: number, problemStatementRefinementRequest: ProblemStatementRefinementRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (courseId === null || courseId === undefined) {
            throw new Error('Required parameter courseId was null or undefined when calling refineProblemStatement.');
        }
        if (problemStatementRefinementRequest === null || problemStatementRefinementRequest === undefined) {
            throw new Error('Required parameter problemStatementRefinementRequest was null or undefined when calling refineProblemStatement.');
        }
        ...
        let localVarPath = `/api/hyperion/courses/${this.configuration.encodeParam({name: "courseId", value: courseId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/problem-statements/refine`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProblemStatementRefinementResponse>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: problemStatementRefinementRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
