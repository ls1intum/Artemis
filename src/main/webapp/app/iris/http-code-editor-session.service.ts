...
export class IrisHttpCodeEditorSessionService {
    ...
    getCurrentSession(exerciseId: number): Observable<EntityResponseType> {
        return this.http.get<IrisSession>(`${this.resourceUrl}/programming-exercises/${exerciseId}/code-editor-sessions/current`, { observe: 'response' });
    }
    ...
    createSessionForProgrammingExercise(exerciseId: number): Observable<IrisSession> {
        return this.http.post<never>(`${this.resourceUrl}/programming-exercises/${exerciseId}/code-editor-sessions`, {});
    }
    ...
    getHeartbeat(sessionId: number): Observable<HttpResponse<boolean>> {
        return this.http.get<boolean>(`${this.resourceUrl}/code-editor-sessions/${sessionId}/active`, { observe: 'response' });
    }
}
