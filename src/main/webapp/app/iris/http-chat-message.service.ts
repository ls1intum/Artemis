...
export class IrisHttpChatMessageService extends IrisHttpMessageService {
     ...
     */
    createMessage(sessionId: number, message: IrisClientMessage): Response<IrisMessage> {
     ...
     * @return {Response<IrisMessage>}
     */
    resendMessage(sessionId: number, message: IrisClientMessage): Response<IrisMessage> {
