...
@NgModule({
    ...
    exports: [IrisCodeEditorChatbotButtonComponent, IrisTutorChatbotButtonComponent, IrisExerciseCreationChatbotButtonComponent, IrisEnabledComponent, IrisLogoButtonComponent],
})
