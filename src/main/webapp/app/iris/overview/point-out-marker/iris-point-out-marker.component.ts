...
import { PointOutData, getPointOutData } from 'app/iris/shared/entities/iris-content-type.model';
...
export class IrisPointOutMarkerComponent {
    ...
    readonly markers = computed<PointOutMarker[]>(() => {
        ...
        return this.message()
            .content.map(getPointOutData)
            .filter((data): data is PointOutData => data !== undefined)
     ...
     */
    protected onMarkerClick(data: PointOutData): void {
     ...
     */
    private buildLabel(data: PointOutData): string {
