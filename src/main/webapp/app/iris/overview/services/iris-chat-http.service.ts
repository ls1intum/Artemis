...
export class IrisChatHttpService {
    ...
    loadChatSessions(courseId: number): Response<IrisSession[]> {
        return this.httpClient.post<IrisSession[]>(`api/iris/chat-history/${courseId}/sessions`, null, { observe: 'response' });
    }
}
