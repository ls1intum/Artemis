...
export const userManagementRoute: Route[] = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'new',
                loadComponent: () => import('app/admin/user-management/update/user-management-update.component').then((m) => m.UserManagementUpdateComponent),
                resolve: {
            ...
            {
                path: ':login',
                loadComponent: () => import('app/admin/user-management/detail/user-management-detail.component').then((m) => m.UserManagementDetailComponent),
                resolve: {
                    user: UserManagementResolve,
                },
                data: {
