...
import { TumAetUiButtonComponent, TumAetUiDialogComponent, TumAetUiTableDirective, TumAetUiTagComponent } from '@tumaet/ui-angular';
/**
...
@Component({
    ...
    imports: [TranslateDirective, KeyValuePipe, ArtemisTranslatePipe, TumAetUiDialogComponent, TumAetUiTagComponent, TumAetUiTableDirective, TumAetUiButtonComponent],
})
