...
import { ScienceEnabledCourse, ScienceResearchExportAudit, ScienceResearchExportRequest, SelectableCourse } from 'app/admin/science/admin-science.model';
...
export class AdminScienceService {
    ...
    getSelectableCourses(): Observable<SelectableCourse[]> {
        return this.http.get<SelectableCourse[]>(`${this.resourceUrl}/selectable-courses`);
    }
