...
@Component({
    ...
    imports: [ArtemisDatePipe, ArtemisTranslatePipe, TranslateDirective, TableViewComponent, FormsModule, TumAetUiToggleSwitchComponent, AdminTitleBarTitleDirective],
})
