...
describe('PresentationAssessmentFormDialogComponent', () => {
    ...
    it('should not prefill max points for a new presentation', () => {
        fixture.componentRef.setInput('presentationAssessment', undefined);
        fixture.detectChanges();

        expect(component.editForm.controls.maxPoints.value).toBeNull();
    });
    ...
    it('should reject max points above the upper bound', () => {
        const savedSpy = vi.fn();
        component.saved.subscribe(savedSpy);
    ...
    it('should reject decimal result points', () => {
        const savedSpy = vi.fn();
        component.saved.subscribe(savedSpy);
