(function () {
    ...
    EditDragAndDropQuestionController.$inject = ['$translate', '$translatePartialLoader', '$scope', 'FileUpload', '$document', 'MAX_FILE_SIZE', 'ArtemisMarkdown', 'DragAndDropQuestionUtil', '$http'];

    function EditDragAndDropQuestionController($translate, $translatePartialLoader, $scope, FileUpload, $document, MAX_FILE_SIZE, ArtemisMarkdown, DragAndDropQuestionUtil, $http) {
    ...
    angular.module('artemisApp').component('editDragAndDropQuestion', {
        templateUrl: 'ng1/quiz/edit/drag-and-drop-question/edit-drag-and-drop-question.html',
