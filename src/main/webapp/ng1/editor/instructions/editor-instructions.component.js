...
(function () {
    ...
    var Remarkable = require("../../bower_components/remarkable/dist/remarkable.js");
    ...
    angular
        ...
        .component('editorInstructions', {
            ...
            templateUrl: 'ng1/editor/instructions/editor-instructions.html',
        ...
        .directive('httpSrc', [
            '$http', function ($http) {
                ...
                function link(scope, element, attrs) {
                    attrs.$observe('httpSrc', function(value) {
                        var requestConfig = {
                            method: 'Get',
                            url: value,
