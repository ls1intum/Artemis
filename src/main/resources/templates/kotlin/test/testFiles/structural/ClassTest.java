...
public class ClassTest extends StructuralTest {
    ...
    public void testClass() {
        ...
        if(expectedClassPropertiesJSON.has(JSON_PROPERTY_MODIFIERS)) {
            JSONArray expectedModifiers = expectedClassPropertiesJSON.getJSONArray(JSON_PROPERTY_MODIFIERS);
            String[] observerdMotifiers = Modifier.toString(observedClass.getModifiers()).split(" ");

            boolean annotationsAreRight = checkModifiers(observerdMotifiers, expectedModifiers);
            if (!annotationsAreRight) {
                fail("The modifier(s) of the class '" + expectedClassName + "' are not implemented as expected.");
            }
        }
    }
}
