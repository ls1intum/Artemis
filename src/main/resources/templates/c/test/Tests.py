...
def main():
    ...
    tester.addTest(TestOutput(makefileLocation, 0, "aAbByYzZ123!%&/()Oau", [testCompile.name], name="TestOutput_0"))
    tester.addTest(TestOutput(makefileLocation, 1, "aAbByYzZ123!%&/()Oau", [testCompile.name], name="TestOutput_1"))
    ...
    tester.addTest(TestOutput(makefileLocation, 27, "aAbByYzZ123!%&/()Oau", requirements=[testASan.name], name="TestOutputASan", executable="asan.out"))
    ...
    tester.addTest(TestOutput(makefileLocation, 27, "aAbByYzZ123!%&/()Oau", requirements=[testUBSan.name], name="TestOutputUBSan", executable="ubsan.out"))
    ...
    tester.addTest(TestOutput(makefileLocation, 27, "aAbByYzZ123!%&/()Oau", requirements=[testLSan.name], name="TestOutputLSan", executable="lsan.out"))
