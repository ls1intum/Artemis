 ...
 * Required as path alias to prevent "Failed to resolve entry for package monaco-editor" errors.
 * Individual spec files may also need vi.mock() for hoisting before static initializers.
 */
export const editor = { create: () => ({}), createModel: () => ({}), defineTheme: () => {}, setTheme: () => {} };
