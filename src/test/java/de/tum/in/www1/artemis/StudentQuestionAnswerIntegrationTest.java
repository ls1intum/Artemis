...
public class StudentQuestionAnswerIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    public void editStudentQuestionAnswer_asTA() throws Exception {
        ...
        StudentQuestionAnswer updatedStudentQuestionAnswerServer1 = request.putWithResponseBody("/api/courses/" + studentQuestionAnswer_tutor1.getQuestion().getCourse().getId() + "/student-question-answers", studentQuestionAnswer_tutor1,
        ...
        StudentQuestionAnswer updatedStudentQuestionAnswerServer2 = request.putWithResponseBody("/api/courses/" + studentQuestionAnswer_tutor2.getQuestion().getCourse().getId() + "/student-question-answers", studentQuestionAnswer_tutor2,
                StudentQuestionAnswer.class, HttpStatus.OK);
        ...
        StudentQuestionAnswer updatedStudentQuestionAnswerServer3 = request.putWithResponseBody("/api/courses/" + studentQuestionAnswer_student1.getQuestion().getCourse().getId() + "/student-question-answers", studentQuestionAnswer_student1,
                StudentQuestionAnswer.class, HttpStatus.OK);
    ...
    public void editStudentQuestionAnswer_asStudent() throws Exception {
        ...
        studentQuestionAnswer_student1.setAnswerText("New Answer Text");
        studentQuestionAnswer_student1.setAnswerDate(ZonedDateTime.now().minusHours(1));
        StudentQuestionAnswer updatedStudentQuestionAnswerServer1 = request.putWithResponseBody("/api/courses/" + studentQuestionAnswer_student1.getQuestion().getCourse().getId() + "/student-question-answers", studentQuestionAnswer_student1,
                StudentQuestionAnswer.class, HttpStatus.OK);
        ...
        studentQuestionAnswer_tutor1.setAnswerText("New Answer Text");
        studentQuestionAnswer_tutor1.setAnswerDate(ZonedDateTime.now().minusHours(1));
        StudentQuestionAnswer updatedStudentQuestionAnswerServer = request.putWithResponseBody("/api/courses/" + studentQuestionAnswer_tutor1.getQuestion().getCourse().getId() + "/student-question-answers", studentQuestionAnswer_tutor1,
    ...
    public void getStudentQuestionAnswer() throws Exception {
        ...
        StudentQuestionAnswer returnedStudentQuestionAnswer = request.get("/api/courses/" + studentQuestionAnswer.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer.getId(), HttpStatus.OK,
    ...
    public void deleteStudentQuestionAnswer_asInstructor() throws Exception {
        ...
        request.delete("/api/courses/" + studentQuestionAnswer_tutor1.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer_tutor1.getId(), HttpStatus.OK);
        ...
        request.delete("/api/courses/" + studentQuestionAnswer_tutor2.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer_tutor2.getId(), HttpStatus.OK);
    ...
    public void deleteStudentQuestionAnswer_AsTA() throws Exception {
        ...
        request.delete("/api/courses/" + studentQuestionAnswer_student2.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer_student2.getId(), HttpStatus.OK);
    ...
    public void deleteStudentQuestionAnswer_AsStudent() throws Exception {
        ...
        // delete own answer --> OK
        request.delete("/api/courses/" + studentQuestionAnswer_student1.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer_student1.getId(), HttpStatus.OK);
        ...
        request.delete("/api/courses/" + studentQuestionAnswer_student2.getQuestion().getCourse().getId() + "/student-question-answers/" + studentQuestionAnswer_student2.getId(), HttpStatus.FORBIDDEN);
