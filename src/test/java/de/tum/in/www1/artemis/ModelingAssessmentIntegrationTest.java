...
public class ModelingAssessmentIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    public void testManualAssessmentSubmit_NONZeroPointsNONZeroBonusPointsExercise() throws Exception {
        // setting up exercise
    ...
    @Test
    @WithMockUser(value = "tutor1", roles = "TA")
    public void testManualAssessmentSubmit_ZeroPointsNONZeroBonusPointsExercise() throws Exception {
        // setting up exercise
        useCaseExercise.setMaxScore(0.0);
        useCaseExercise.setBonusPoints(10.0);
        exerciseRepo.save(useCaseExercise);
    ...
    @Test
    @WithMockUser(value = "tutor1", roles = "TA")
    public void testManualAssessmentSubmit_NonZeroPointsZeroBonusPointsExercise() throws Exception {
        // setting up exercise
        useCaseExercise.setMaxScore(10.0);
    ...
    @Test
    @WithMockUser(value = "tutor1", roles = "TA")
    public void testManualAssessmentSubmit_ZeroPointsZeroBonusPointsExercise() throws Exception {
        // setting up exercise
        useCaseExercise.setMaxScore(0.0);
        useCaseExercise.setBonusPoints(0.0);
        exerciseRepo.save(useCaseExercise);
        ...
        addAssessmentFeedbackAndCheckScore(submission, feedbacks, -1.0, 0L);
        addAssessmentFeedbackAndCheckScore(submission, feedbacks, 1.0, 0L);
        addAssessmentFeedbackAndCheckScore(submission, feedbacks, 50.0, 50L);
        addAssessmentFeedbackAndCheckScore(submission, feedbacks, 50.0, 100L);
        addAssessmentFeedbackAndCheckScore(submission, feedbacks, 50.0, 100L);
    }
