...
public class PointCounterResourceIntTest {
    ...
    public void setup() {
        ...
        final PointCounterResource pointCounterResource = new PointCounterResource(pointCounterRepository);
    ...
    public void updatePointCounter() throws Exception {
        ...
        PointCounter updatedPointCounter = pointCounterRepository.findById(pointCounter.getId()).get();
        // Disconnect from session so that the updates on updatedPointCounter are not directly saved in db
        em.detach(updatedPointCounter);
        updatedPointCounter
