...
public class FileUploadSubmissionIntegrationTest {
    ...
    public void getAllSubmissionsOfExercise() throws Exception {
        ...
        List<FileUploadSubmission> submissions = request.getList("/api/exercises/" + fileUploadExercise.getId() + "/file-upload-submissions", HttpStatus.OK, FileUploadSubmission.class);
