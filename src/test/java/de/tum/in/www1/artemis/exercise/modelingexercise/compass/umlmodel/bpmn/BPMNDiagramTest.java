...
class BPMNDiagramTest extends AbstractUMLDiagramTest {
    ...
    void similarityComponentDiagram_EqualModels() {
        compareSubmissions(modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_1), modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_1), 0.8, 100.0);
        compareSubmissions(modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_2), modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_2), 0.8, 100.0);
        compareSubmissions(modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_3), modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_3), 0.8, 100.0);
    }

    @Test
    void similarityComponentDiagram_DifferentModels() {
        compareSubmissions(modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_1), modelingSubmission(BPMNDiagrams.COMPONENT_MODEL_3), 0.0, 13.48);
    }

    @Test
    void parseComponentDiagramModelCorrectly() throws IOException {
        UMLDiagram diagram = UMLModelParser.buildModelFromJSON(parseString(BPMNDiagrams.COMPONENT_MODEL_3).getAsJsonObject(), 1L);
