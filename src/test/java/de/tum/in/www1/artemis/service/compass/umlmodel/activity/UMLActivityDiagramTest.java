...
class UMLActivityDiagramTest extends AbstractUMLDiagramTest {
    ...
    void similarityActivityDiagram_EqualModels() {
        ...
        compareSubmissions(modelingSubmission(UMLActivityDiagrams.ACTIBITY_MODEL_2), modelingSubmission(UMLActivityDiagrams.ACTIBITY_MODEL_2), 0.8, 1.0);
    }

    @Test
    void similarityActivityDiagram_DifferentModels() {
        compareSubmissions(modelingSubmission(UMLActivityDiagrams.ACTIVITY_MODEL_1), modelingSubmission(UMLActivityDiagrams.ACTIBITY_MODEL_2), 0.0, 0.5708);
    }
}
