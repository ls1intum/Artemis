...
public class DragAndDropMappingResourceIntTest {
    ...
    public void updateDragAndDropMapping() throws Exception {
        ...
        DragAndDropMapping updatedDragAndDropMapping = dragAndDropMappingRepository.findById(dragAndDropMapping.getId()).get();
        // Disconnect from session so that the updates on updatedDragAndDropMapping are not directly saved in db
        em.detach(updatedDragAndDropMapping);
