...
public class ExerciseGroupIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    public void testGetExerciseGroupsForExam_asEditor() throws Exception {
        ...
        verify(examAccessService, times(1)).checkCourseAndExamAccessForRoleElseThrow(Role.EDITOR, course1.getId(), exam1.getId());
    ...
    public void testDeleteExerciseGroup_asInstructor() throws Exception {
        ...
        verify(examAccessService, times(1)).checkCourseAndExamAndExerciseGroupAccessForRoleElseThrow(Role.INSTRUCTOR, course1.getId(), exam1.getId(), exerciseGroup1);
