...
public class ApollonDiagramResourceIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    public void testCreateApollonDiagram_CREATED() throws Exception {
        Course course1 = ModelFactory.generateCourse(1L, ZonedDateTime.now(), ZonedDateTime.now(), new HashSet<>());
        course1.setTeachingAssistantGroupName("tutor");
    ...
    public void testUpdateApollonDiagram_AccessForbidden() throws Exception {
        ...
        apollonDiagram.setDiagramType(DiagramType.ClassDiagram);
        apollonDiagram.setCourseId(course1.getId());
        ApollonDiagram response = request.putWithResponseBody("/api/apollon-diagrams", apollonDiagram, ApollonDiagram.class, HttpStatus.FORBIDDEN);
    }
    ...
    public void testGetDiagramsByCourse() throws Exception {
        ...
        course1.setTeachingAssistantGroupName("tutor");
        courseRepo.save(course1);
        Course course2 = ModelFactory.generateCourse(2L, ZonedDateTime.now(), ZonedDateTime.now(), new HashSet<>());
        course2.setTeachingAssistantGroupName("tutor");
        courseRepo.save(course2);
        apollonDiagram.setCourseId(course1.getId());
        apollonDiagramRepository.save(apollonDiagram);
        List<ApollonDiagram> responseCourse1 = request.get("/api/apollon-diagrams/list/" + course1.getId(), HttpStatus.OK, List.class);
        ...
        List<ApollonDiagram> updatedResponseCourse1 = request.get("/api/apollon-diagrams/list/" + course1.getId(), HttpStatus.OK, List.class);
        ...
        List<ApollonDiagram> responseCourse2 = request.get("/api/apollon-diagrams/list/" + course2.getId(), HttpStatus.OK, List.class);
    ...
    public void testDeleteApollonDiagram() throws Exception {
        Course course1 = ModelFactory.generateCourse(1L, ZonedDateTime.now(), ZonedDateTime.now(), new HashSet<>());
        course1.setInstructorGroupName("instructor");
        courseRepo.save(course1);
