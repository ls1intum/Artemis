...
import de.tum.in.www1.artemis.repository.MultipleChoiceQuestionStatisticRepository;
...
public class MultipleChoiceQuestionStatisticResourceIntTest {
    ...
    public void setup() {
        ...
        final MultipleChoiceQuestionStatisticResource multipleChoiceQuestionStatisticResource = new MultipleChoiceQuestionStatisticResource(multipleChoiceQuestionStatisticRepository);
    ...
    public void updateMultipleChoiceQuestionStatistic() throws Exception {
        ...
        MultipleChoiceQuestionStatistic updatedMultipleChoiceQuestionStatistic = multipleChoiceQuestionStatisticRepository.findById(multipleChoiceQuestionStatistic.getId()).get();
        // Disconnect from session so that the updates on updatedMultipleChoiceQuestionStatistic are not directly saved in db
        em.detach(updatedMultipleChoiceQuestionStatistic);
