...
public class QuizPointStatisticResourceIntTest {
    ...
    public void setup() {
        ...
        final QuizPointStatisticResource quizPointStatisticResource = new QuizPointStatisticResource(quizPointStatisticRepository);
    ...
    public void updateQuizPointStatistic() throws Exception {
        ...
        QuizPointStatistic updatedQuizPointStatistic = quizPointStatisticRepository.findById(quizPointStatistic.getId()).get();
        // Disconnect from session so that the updates on updatedQuizPointStatistic are not directly saved in db
        em.detach(updatedQuizPointStatistic);
