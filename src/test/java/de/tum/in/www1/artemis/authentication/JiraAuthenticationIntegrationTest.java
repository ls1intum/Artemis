...
class JiraAuthenticationIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    void testJWTAuthentication() throws Exception {
        ...
        UserJwtResource.JWTToken jwtToken = request.postWithResponseBody("/api/public/authenticate", loginVM, UserJwtResource.JWTToken.class, HttpStatus.OK, httpHeaders);
    ...
    void testJWTAuthenticationCaptcha() throws Exception {
        ...
        UserJwtResource.JWTToken jwtToken = request.postWithResponseBody("/api/public/authenticate", loginVM, UserJwtResource.JWTToken.class, HttpStatus.FORBIDDEN, httpHeaders,
    ...
    void testEmptyPasswordAttempt() throws Exception {
        ...
        UserJwtResource.JWTToken jwtToken = request.postWithResponseBody("/api/public/authenticate", loginVM, UserJwtResource.JWTToken.class, HttpStatus.BAD_REQUEST, httpHeaders);
