...
class ModelingComparisonTest {
    ...
    void compareSubmittedAnswers() {
        ...
        var submission1 = ModelingExerciseFactory.generateModelingExerciseSubmission(modelingExercise, model1, "explanation");
        var submission2 = ModelingExerciseFactory.generateModelingExerciseSubmission(modelingExercise, model1, "explanation");  // same as submission1
        var submission3 = ModelingExerciseFactory.generateModelingExerciseSubmission(modelingExercise, emptyModel, "explanation");
        var submission4 = ModelingExerciseFactory.generateModelingExerciseSubmission(modelingExercise, null, null);
        ...
        // TODO: Compare different explanations
        assertThat(StudentExamService.isContentEqualTo(submission3, submission4)).isFalse();
        assertThat(StudentExamService.isContentEqualTo(submission4, submission5)).isTrue();  // both submission with null model

        assertThat(StudentExamService.isContentEqualTo(submission2, null)).isFalse(); // one submission null
        assertThat(StudentExamService.isContentEqualTo(null, submission4)).isFalse();  // one submission null, other null model
