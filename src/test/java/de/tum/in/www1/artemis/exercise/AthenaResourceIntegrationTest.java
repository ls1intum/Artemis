...
class AthenaResourceIntegrationTest extends AbstractAthenaTest {
    ...
    void testGetFeedbackSuggestionsSuccess() throws Exception {
        List<Feedback> response = request.getList("/api/public/athena/text-exercises/" + textExercise.getId() + "/submissions/" + textSubmission.getId() + "/feedback-suggestions",
    ...
    void testGetFeedbackSuggestionsNotFound() throws Exception {
        request.get("/api/public/athena/text-exercises/9999/submissions/9999/feedback-suggestions", HttpStatus.NOT_FOUND, List.class);
    }

    @Test
    @WithMockUser(username = TEST_PREFIX + "student1", roles = "STUDENT")
    void testGetFeedbackSuggestionsAccessForbidden() throws Exception {
        request.get("/api/public/athena/text-exercises/" + textExercise.getId() + "/submissions/" + textSubmission.getId() + "/feedback-suggestions", HttpStatus.FORBIDDEN,
                List.class);
    }
}
