...
public class StatisticCounterResourceIntTest {
    ...
    public void setup() {
        ...
        final StatisticCounterResource statisticCounterResource = new StatisticCounterResource(statisticCounterRepository);
    ...
    public void updateStatisticCounter() throws Exception {
        ...
        StatisticCounter updatedStatisticCounter = statisticCounterRepository.findById(statisticCounter.getId()).get();
        // Disconnect from session so that the updates on updatedStatisticCounter are not directly saved in db
        em.detach(updatedStatisticCounter);
    ...
    public void equalsVerifier() throws Exception {
        ...
        StatisticCounter statisticCounter1 = new StatisticCounter();
