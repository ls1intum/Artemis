package de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.component;
...
class UMLComponentDiagramTest extends AbstractUMLDiagramTest {
    ...
    @Test
    void similarityComponentDiagram_v3_EqualModels() {
        compareSubmissions(modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_1_V3), modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_1), 0.8, 100.0);
        compareSubmissions(modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_2), modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_2_V3), 0.8, 100.0);
        compareSubmissions(modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_3_V3), modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_3_V3), 0.8, 100.0);
    }
    ...
    @Test
    void similarityComponentDiagram_v3_DifferentModels() {
        compareSubmissions(modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_1_V3), modelingSubmission(UMLComponentDiagrams.COMPONENT_MODEL_3_V3), 0.0, 13.48);
    }
    ...
    @Test
    void parseComponentDiagramModelCorrectly_v3() throws IOException {
        UMLDiagram diagram = UMLModelParser.buildModelFromJSON(parseString(UMLComponentDiagrams.COMPONENT_MODEL_3_V3).getAsJsonObject(), 1L);
        assertThat(diagram).isInstanceOf(UMLComponentDiagram.class);
        UMLComponentDiagram componentDiagram = (UMLComponentDiagram) diagram;
        // 4 Components A, B, C and D
        assertThat(componentDiagram.getComponentList()).hasSize(4);
