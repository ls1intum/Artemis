...
class ExamIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    void testCreateExam_asInstructor() throws Exception {
        ...
        await().until(() -> {
            ...
            return conversationParticipants.size() == 2; // only the instructors and tutors should be added to exam channel, not students (see @BeforeEach)
        });
    }
    ...
    @Test
    @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
    void testDeleteExamWithMultipleTestRuns() throws Exception { // TODO here
