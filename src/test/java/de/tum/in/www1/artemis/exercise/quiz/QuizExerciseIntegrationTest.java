...
class QuizExerciseIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void testReevaluateStatistics() throws Exception {
        ...
        assertThat(resultRepository.findAllBySubmission_ParticipationExerciseId(quizExercise.getId())).hasSize(numberOfParticipants);
    ...
    void testReevaluateStatistics_Practice() throws Exception {
        ...
        assertThat(resultRepository.findAllBySubmission_ParticipationExerciseId(quizExercise.getId())).hasSize(10);
