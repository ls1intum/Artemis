        ...
        for (Course course : courses) {
            ...
            for (Exercise exercise : course.getExercises()) {
                ...
                if (exercise instanceof FileUploadExercise) {
                    assertThat(stats.getNumberOfSubmissions().getInTime()).as("Number of submissions for file upload exercise is correct").isEqualTo(0);
                }
                if (exercise instanceof ModelingExercise) {
                    assertThat(stats.getNumberOfSubmissions().getInTime()).as("Number of submissions for modeling exercise is correct").isEqualTo(2);
                }
                if (exercise instanceof ProgrammingExercise) {
                    assertThat(stats.getNumberOfSubmissions().getInTime()).as("Number of submissions for programming exercise is correct").isEqualTo(0);
                }
                if (exercise instanceof QuizExercise) {
                    assertThat(stats.getNumberOfSubmissions().getInTime()).as("Number of submissions for quiz exercise is correct").isEqualTo(0);
                }
                if (exercise instanceof TextExercise) {
                    assertThat(stats.getNumberOfSubmissions().getInTime()).as("Number of submissions for text exercise is correct").isEqualTo(1);
                }
            }
        }
    }
