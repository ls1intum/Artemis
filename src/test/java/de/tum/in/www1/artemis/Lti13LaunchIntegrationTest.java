...
class Lti13LaunchIntegrationTest extends AbstractSpringIntegrationJenkinsGitlabTest {
    ...
    void redirectProxyNoState() throws Exception {
        ...
        request.postFormWithoutLocation(CustomLti13Configurer.LTI_BASE_PATH + CustomLti13Configurer.LOGIN_REDIRECT_PROXY_PATH, body, HttpStatus.INTERNAL_SERVER_ERROR);
    }
