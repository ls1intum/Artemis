...
class LocalVCLocalCIIntegrationTest extends AbstractLocalCILocalVCIntegrationTest {
    ...
    void testFetchPush_testsRepository() throws Exception {
        ...
        localVCLocalCITestService.mockInputStreamReturnedFromContainer(dockerClient, "/repositories/test-repository/", solutionBuildTestResults, templateBuildTestResults);
    ...
    void testFetchPush_solutionRepository() throws Exception {
        ...
        localVCLocalCITestService.mockTestResults(dockerClient, ALL_SUCCEED_TEST_RESULTS_PATH, "/repositories/test-repository/");
    ...
    void testFetchPush_templateRepository() throws Exception {
        ...
        localVCLocalCITestService.mockInputStreamReturnedFromContainer(dockerClient, "/repositories/assignment-repository/.git/refs/heads/[^/]+", Map.of("commitHash", commitHash),
                Map.of("commitHash", commitHash));
        localVCLocalCITestService.mockTestResults(dockerClient, ALL_FAIL_TEST_RESULTS_PATH, "/repositories/test-repository/");
