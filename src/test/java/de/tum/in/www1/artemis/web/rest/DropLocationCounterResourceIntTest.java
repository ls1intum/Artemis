...
public class DropLocationCounterResourceIntTest {
    ...
    public void setup() {
        ...
        final DropLocationCounterResource dropLocationCounterResource = new DropLocationCounterResource(dropLocationCounterRepository);
    ...
    public void updateDropLocationCounter() throws Exception {
        ...
        DropLocationCounter updatedDropLocationCounter = dropLocationCounterRepository.findById(dropLocationCounter.getId()).get();
        // Disconnect from session so that the updates on updatedDropLocationCounter are not directly saved in db
        em.detach(updatedDropLocationCounter);
