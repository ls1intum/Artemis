...
abstract class AbstractTutorialGroupIntegrationTest extends AbstractSpringIntegrationLocalCILocalVCTest {
    ...
    final LocalDate FIRST_AUGUST_MONDAY = LocalDate.of(2022, 8, 1);

    final LocalDate SECOND_AUGUST_MONDAY = LocalDate.of(2022, 8, 8);

    final LocalDate THIRD_AUGUST_MONDAY = LocalDate.of(2022, 8, 15);
    ...
    final LocalDateTime FIRST_AUGUST_MONDAY_11_00 = LocalDateTime.of(2022, 8, 1, 11, 0, 0);

    final LocalDateTime FIRST_AUGUST_MONDAY_12_00 = LocalDateTime.of(2022, 8, 1, 12, 0);

    final LocalDateTime FIRST_AUGUST_MONDAY_13_00 = LocalDateTime.of(2022, 8, 1, 13, 0);
