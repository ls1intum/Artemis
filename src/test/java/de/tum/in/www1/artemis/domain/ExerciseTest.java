...
public class ExerciseTest {
    ...
    public void setUp() {
        ...
        when(submission1.getResults()).thenReturn(ratedResult);
        when(submission2.getResults()).thenReturn(ratedResult);
        when(submission3.getResults()).thenReturn(ratedResult);
    ...
    public void filterForCourseDashboard_filterSensitiveInformation() {
        ...
        when(submission1.getResults()).thenReturn(ratedResultTmp);
        when(submission2.getResults()).thenReturn(ratedResultTmp);
        when(submission3.getResults()).thenReturn(ratedResultTmp);

        exerciseService.filterForCourseDashboard(exercise, studentParticipations, "student", true);
        Result result = exercise.getStudentParticipations().iterator().next().getSubmissions().iterator().next().getResults();
    ...
    public void filterForCourseDashboard_submissionsWithUnratedResultsOrder() {
        when(submission1.getResults()).thenReturn(unratedResult);
        when(submission2.getResults()).thenReturn(unratedResult);
        when(submission3.getResults()).thenReturn(unratedResult);
    ...
    public void filterForCourseDashboard_submissionWithoutResultsOrder() {
        when(submission1.getResults()).thenReturn(null);
        when(submission2.getResults()).thenReturn(null);
        when(submission3.getResults()).thenReturn(null);
