...
public class AthenaRequestMockProvider {
    ...
    public void mockGetAvailableModulesSuccess() {
        ...
        array.add(createModule(ATHENA_RESTRICTED_MODULE_TEXT_TEST, "http://module-modeling-test-service:5005", "modeling", false));
        ...
        array.add(createModule(ATHENA_RESTRICTED_MODULE_PROGRAMMING_TEST, "http://module-restricted-modeling-test-service:5006", "modeling", false));
