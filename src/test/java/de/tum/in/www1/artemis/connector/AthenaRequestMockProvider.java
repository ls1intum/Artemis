...
public class AthenaRequestMockProvider {
    ...
    public static final String ATHENA_MODULE_MODELING_TEST = "module_modelling_test";

    public static final String ATHENA_RESTRICTED_MODULE_MODELING_TEST = "module_modelling_test_restricted";
    ...
    public void mockGetFeedbackSuggestionsAndExpect(String moduleType, RequestMatcher... expectedContents) {
        ...
        else if (moduleType.equals("modelling")) {
    ...
    public void mockGetAvailableModulesSuccess() {
        ...
        array.add(createModule(ATHENA_MODULE_MODELING_TEST, "http://module-modeling-test-service:5005", "modelling", false));
        ...
        array.add(createModule(ATHENA_RESTRICTED_MODULE_MODELING_TEST, "http://module-restricted-modeling-test-service:5006", "modelling", false));
