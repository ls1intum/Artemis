package de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart;

import static com.google.gson.JsonParser.parseString;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_1A;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_1A_V3;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_1B;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_1B_V3;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_2;
import static de.tum.in.www1.artemis.exercise.modeling.compass.umlmodel.flowchart.FlowchartUtil.FLOWCHART_MODEL_2_V3;
...
class FlowchartTest extends AbstractUMLDiagramTest {
    ...
    @Test
    void similarityFlowchartEqualModels_v3() {
        compareSubmissions(modelingSubmission(FLOWCHART_MODEL_1A_V3), modelingSubmission(FLOWCHART_MODEL_1A), 0.8, 100.0);
        compareSubmissions(modelingSubmission(FLOWCHART_MODEL_2_V3), modelingSubmission(FLOWCHART_MODEL_2_V3), 0.8, 100.0);

        compareSubmissions(modelingSubmission(FLOWCHART_MODEL_1A), modelingSubmission(FLOWCHART_MODEL_1B_V3), 0.8, 100.0);
    }
    ...
    @Test
    void similarityFlowchartDifferentModels_v3() {
        compareSubmissions(modelingSubmission(FLOWCHART_MODEL_1A_V3), modelingSubmission(FLOWCHART_MODEL_2_V3), 0.0, 47.0);
    }
    ...
    @Test
    void parseFlowchartModelCorrectly_v3() throws IOException {
        UMLDiagram diagram = UMLModelParser.buildModelFromJSON(parseString(FLOWCHART_MODEL_1B_V3).getAsJsonObject(), 1L);
        assertThat(diagram).isInstanceOf(Flowchart.class);
        Flowchart flowchart = (Flowchart) diagram;
