...
public class TeamIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    @Test
    @WithMockUser(username = "tutor1", roles = "TA")
    public void testCreateTeam_StudentsAlreadyAssigned_BadRequest() throws Exception {
    ...
    @Test
    @WithMockUser(username = "tutor1", roles = "TA")
    public void testUpdateTeam_StudentsAlreadyAssigned_BadRequest() throws Exception {
