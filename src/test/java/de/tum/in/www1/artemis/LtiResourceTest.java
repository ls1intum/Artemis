...
class LtiResourceTest {
    ...
    void launchAsAnonymousUser() throws Exception {
        ...
        URI header = request.postWithContentType("/api/lti/launch/" + exerciseId, requestBody, HttpStatus.FOUND, MediaType.APPLICATION_FORM_URLENCODED);
