...
public class BambooRequestMockProvider {
    ...
    public void mockGiveProjectPermissions(ProgrammingExercise exercise) throws URISyntaxException, IOException {
        ...
        final var instructorURI = buildGivePermissionsURIFor(projectKey, exercise.getCourseOverExerciseGroupOrCourseMember().getInstructorGroupName());
        ...
        if (exercise.getCourseOverExerciseGroupOrCourseMember().getTeachingAssistantGroupName() != null) {
            final var tutorURI = buildGivePermissionsURIFor(projectKey, exercise.getCourseOverExerciseGroupOrCourseMember().getTeachingAssistantGroupName());
    ...
    public List<Verifiable> mockCopyBuildPlanForParticipation(ProgrammingExercise exercise, String username) throws CliClient.RemoteRestException, CliClient.ClientException {
        ...
        final var buildProjectName = exercise.getCourseOverExerciseGroupOrCourseMember().getShortName().toUpperCase() + " " + exercise.getTitle();
