...
class UMLClassDiagramTest {
    ...
    void similarityClassDiagram_EqualModels() {
        var modelingSubmission1 = new ModelingSubmission().model(classModel1);
        var modelingSubmission2 = new ModelingSubmission().model(classModel1);
        modelingSubmission1.setId(1L);
        modelingSubmission2.setId(2L);

        var comparisonResult = modelingPlagiarismDetectionService.compareSubmissions(List.of(modelingSubmission1, modelingSubmission2), 0.8);
        assertThat(comparisonResult).isNotNull();
        assertThat(comparisonResult).hasSize(1);
        assertThat(comparisonResult.get(0).getSimilarity()).isEqualTo(1.0);
    }
    ...
    void similarityClassDiagram_DifferentModels() {
        ...
        var modelingSubmission1 = new ModelingSubmission().model(classModel1);
        var modelingSubmission2 = new ModelingSubmission().model(classModel2);
        modelingSubmission1.setId(1L);
        modelingSubmission2.setId(2L);

        var comparisonResult = modelingPlagiarismDetectionService.compareSubmissions(List.of(modelingSubmission1, modelingSubmission2), 0.0);
        assertThat(comparisonResult).isNotNull();
        assertThat(comparisonResult).hasSize(1);
        assertThat(comparisonResult.get(0).getSimilarity()).isEqualTo(0.3095, Offset.offset(0.001));
    }
}
