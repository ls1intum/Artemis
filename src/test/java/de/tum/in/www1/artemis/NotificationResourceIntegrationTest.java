...
public class NotificationResourceIntegrationTest extends AbstractSpringIntegrationBambooBitbucketJiraTest {
    ...
    private final NotificationTargetProvider notificationTargetProvider = new NotificationTargetProvider();
    ...
    public void testCreateNotification_asUser() throws Exception {
        ...
        groupNotification.setTarget(notificationTargetProvider.getExerciseUpdatedTarget(exercise));
