...
class PetriNetTest extends AbstractUMLDiagramTest {
    ...
    @Test
    void similarityPetriNet_v3_equalModels() {
        compareSubmissions(modelingSubmission(PETRI_NET_MODEL_1A_V3), modelingSubmission(PETRI_NET_MODEL_1A_V3), 0.8, 100.0);
        compareSubmissions(modelingSubmission(PETRI_NET_MODEL_2_V3), modelingSubmission(PETRI_NET_MODEL_2), 0.8, 100.0);

        compareSubmissions(modelingSubmission(PETRI_NET_MODEL_1A), modelingSubmission(PETRI_NET_MODEL_1B_V3), 0.8, 93.75);
    }
    ...
    @Test
    void similarityPetriNet_v3_differentModels() {
        compareSubmissions(modelingSubmission(PETRI_NET_MODEL_1A_V3), modelingSubmission(PETRI_NET_MODEL_2_V3), 0.0, 43.5625);
    }
    ...
    @Test
    void parsePetriNetModelCorrectly_v3() throws IOException {
        UMLDiagram diagram = UMLModelParser.buildModelFromJSON(parseString(PETRI_NET_MODEL_1B_V3).getAsJsonObject(), 1L);
        assertThat(diagram).isInstanceOf(PetriNet.class);
        PetriNet petriNet = (PetriNet) diagram;
