...
class TutorialGroupScheduleIntegrationTest extends AbstractTutorialGroupIntegrationTest {
    ...
    void createNewTutorialGroupWithSchedule_everyTwoWeeks_shouldCreateWithOneWeekPauseInBetween() throws Exception {
        // given
        var newTutorialGroup = this.buildTutorialGroupWithExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), THIRD_AUGUST_MONDAY_00_00.toLocalDate(), "tutor1");
        ...
        this.assertScheduledSessionIsActiveOnDate(firstAugustMondaySession, FIRST_AUGUST_MONDAY_00_00.toLocalDate(), persistedTutorialGroupId, persistedSchedule);
        this.assertScheduledSessionIsActiveOnDate(thirdAugustMondaySession, THIRD_AUGUST_MONDAY_00_00.toLocalDate(), persistedTutorialGroupId, persistedSchedule);
    }
    ...
    void createNewTutorialGroupWithSchedule_sessionFallsOnTutorialGroupFreeDay_shouldCreateCancelledSession() throws Exception {
        ...
        var newTutorialGroupCoveringHoliday = this.buildTutorialGroupWithExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), SECOND_AUGUST_MONDAY_00_00.toLocalDate(),
                "tutor1");
        ...
        this.assertScheduledSessionIsActiveOnDate(normalSession, FIRST_AUGUST_MONDAY_00_00.toLocalDate(), persistedTutorialGroupId, persistedSchedule);
        this.assertScheduledSessionIsCancelledOnDate(holidaySession, SECOND_AUGUST_MONDAY_00_00.toLocalDate(), persistedTutorialGroupId, persistedSchedule);
    ...
    void createNewTutorialGroupWithSchedule_wrongDateFormatInSchedule_shouldReturnBadRequest() throws Exception {
        // given
        var newTutorialGroup = this.buildTutorialGroupWithExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), SECOND_AUGUST_MONDAY_00_00.toLocalDate(), "tutor1");
        ...
        newTutorialGroup = this.buildTutorialGroupWithExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), SECOND_AUGUST_MONDAY_00_00.toLocalDate(), "tutor1");
    ...
    void addScheduleToTutorialGroupWithoutSchedule_asInstructor_shouldAddScheduleAndCreateSessions() throws Exception {
        ...
        var newSchedule = this.buildExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), SECOND_AUGUST_MONDAY_00_00.toLocalDate());
        ...
        this.assertScheduledSessionIsActiveOnDate(firstAugustMondaySession, FIRST_AUGUST_MONDAY_00_00.toLocalDate(), tutorialGroup.getId(), persistedSchedule);
        this.assertScheduledSessionIsActiveOnDate(secondAugustMondaySession, SECOND_AUGUST_MONDAY_00_00.toLocalDate(), tutorialGroup.getId(), persistedSchedule);
    }
    ...
    void updateTutorialGroupWithSchedule_NoChangesToSchedule_ShouldNotRecreateSessionsOrSchedule() throws Exception {
        // given
        var tutorialGroup = this.buildTutorialGroupWithExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), SECOND_AUGUST_MONDAY_00_00.toLocalDate(), "tutor1");
    ...
    void modifyExistingScheduleOfTutorialGroup_shouldRecreateScheduledSessionsButKeepIndividualSessions() throws Exception {
        ...
        var newSchedule = this.buildExampleSchedule(FIRST_AUGUST_MONDAY_00_00.toLocalDate(), THIRD_AUGUST_MONDAY_00_00.toLocalDate());
        ...
        this.assertScheduledSessionIsActiveOnDate(firstAugustMondaySession, FIRST_AUGUST_MONDAY_00_00.toLocalDate(), tutorialGroup.getId(), persistedSchedule);
        this.assertScheduledSessionIsActiveOnDate(thirdAugustMondaySession, THIRD_AUGUST_MONDAY_00_00.toLocalDate(), tutorialGroup.getId(), persistedSchedule);
        // individual session
