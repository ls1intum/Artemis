...
import de.tum.in.www1.artemis.repository.QuestionStatisticRepository;
...
public class QuestionStatisticResourceIntTest {
    ...
    public void setup() {
        ...
        final QuestionStatisticResource questionStatisticResource = new QuestionStatisticResource(questionStatisticRepository);
    ...
    public void updateQuestionStatistic() throws Exception {
        ...
        QuestionStatistic updatedQuestionStatistic = questionStatisticRepository.findById(questionStatistic.getId()).get();
        // Disconnect from session so that the updates on updatedQuestionStatistic are not directly saved in db
        em.detach(updatedQuestionStatistic);
    ...
    public void equalsVerifier() throws Exception {
        ...
        QuestionStatistic questionStatistic1 = new QuestionStatistic();
        questionStatistic1.setId(1L);
        QuestionStatistic questionStatistic2 = new QuestionStatistic();
