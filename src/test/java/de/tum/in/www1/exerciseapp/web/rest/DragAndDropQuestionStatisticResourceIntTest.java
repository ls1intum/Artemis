...
public class DragAndDropQuestionStatisticResourceIntTest {
    ...
    public void setup() {
        ...
        DragAndDropQuestionStatisticResource dragAndDropQuestionStatisticResource = new DragAndDropQuestionStatisticResource(dragAndDropQuestionStatisticRepository);
    ...
    public void updateDragAndDropQuestionStatistic() throws Exception {
        ...
        DragAndDropQuestionStatistic updatedDragAndDropQuestionStatistic = dragAndDropQuestionStatisticRepository.findOne(dragAndDropQuestionStatistic.getId());
    ...
    public void updateNonExistingDragAndDropQuestionStatistic() throws Exception {
        ...
        // Validate the DragAndDropQuestionStatistic in the database
        List<DragAndDropQuestionStatistic> dragAndDropQuestionStatisticList = dragAndDropQuestionStatisticRepository.findAll();
        assertThat(dragAndDropQuestionStatisticList).hasSize(databaseSizeBeforeUpdate + 1);
    }
