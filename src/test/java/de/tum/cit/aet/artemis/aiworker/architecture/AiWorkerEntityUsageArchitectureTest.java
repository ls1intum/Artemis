...
/**
 * Architecture test verifying that REST controllers in the AiWorker module do not use @Entity types
 ...
 */
class AiWorkerEntityUsageArchitectureTest extends AbstractModuleEntityUsageArchitectureTest {

    @Override
    public String getModulePackage() {
        return ARTEMIS_PACKAGE + ".aiworker";
    }
