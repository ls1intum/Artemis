...
class StruggleInterventionJobTest {
    ...
    void carriesContextAndAuthorizesOwningCourse() {
        var job = new StruggleInterventionJob("token-1", 7L, 42L, 3L, null, null, null, null, null);
    ...
    void carriesIntentEpisodeIdConfirmReasonAndRequestToken() {
        var job = new StruggleInterventionJob("tok", 1L, 2L, 3L, "decide", "ep-42", "progress", "rt-uuid", "push");
        ...
        assertThat(job.proactivityMode()).isEqualTo("push");
    }

    @Test
    void nullFieldsAreAllowedOnDefaultDecidePath() {
        var job = new StruggleInterventionJob("tok2", 1L, 2L, 3L, null, null, null, null, null);
        ...
        assertThat(job.proactivityMode()).isNull();
    }
}
