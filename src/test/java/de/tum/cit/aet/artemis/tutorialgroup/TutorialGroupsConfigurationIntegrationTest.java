...
class TutorialGroupsConfigurationIntegrationTest extends AbstractTutorialGroupIntegrationTest {
    ...
    private Long configurationCourseId;
     ...
     * configurationCourseId = course.getId();
     * }
     * private void deleteExampleConfiguration() {
     * Course course = courseRepository.findByIdWithEagerTutorialGroupConfigurationElseThrow(configurationCourseId);
     ...
     * var configuration = tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * request.putWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId, configuration.getId()), TutorialGroupConfigurationDTO.of(configuration),
     * TutorialGroupConfigurationDTO.class, HttpStatus.FORBIDDEN);
     * this.deleteExampleConfiguration();
     * request.postWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId), TutorialGroupConfigurationDTO.of(buildExampleConfiguration(configurationCourseId)),
     * TutorialGroupConfigurationDTO.class, HttpStatus.FORBIDDEN);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "student1", roles = "USER")
     ...
     * var configuration = tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * // when
     * var configurationFromRequest = request.get(this.getTutorialGroupsConfigurationPath(configurationCourseId), HttpStatus.OK, TutorialGroupConfigurationDTO.class);
     * // then
     ...
     * TutorialGroupConfigurationDTO configurationFromRequest = request.postWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId),
     * TutorialGroupConfigurationDTO.of(buildExampleConfiguration(configurationCourseId)), TutorialGroupConfigurationDTO.class, HttpStatus.CREATED);
     * assertThat(configurationFromRequest).isNotNull();
     * assertThat(configurationFromRequest.id()).isNotNull();
     * var persisted = tutorialGroupsConfigurationRepository.findByCourseIdWithEagerTutorialGroupFreePeriods(configurationCourseId).orElseThrow();
     * this.assertConfigurationStructure(persisted, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY, configurationCourseId, true, true);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     * void create_asInstructor_shouldReturnBadRequestWhenCourseHasNoTimeZone() throws Exception {
     * var course = courseRepository.findByIdElseThrow(configurationCourseId);
     * course.setTimeZone(null);
     * courseRepository.save(course);
     * var exampleConfigDto = TutorialGroupConfigurationDTO.of(buildExampleConfiguration(configurationCourseId));
     * request.postWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId), exampleConfigDto, TutorialGroupConfigurationDTO.class, HttpStatus.BAD_REQUEST);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     * void create_invalidDateFormat_shouldReturnBadRequest() throws Exception {
     * var exampleConfig = buildExampleConfiguration(configurationCourseId);
     * // not in correct uuuu-MM-dd format
     * exampleConfig.setTutorialPeriodStartInclusive("2022-11-25T23:00:00.000Z");
     * request.postWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId), TutorialGroupConfigurationDTO.of(exampleConfig), TutorialGroupConfigurationDTO.class,
     * HttpStatus.BAD_REQUEST);
     * exampleConfig = buildExampleConfiguration(configurationCourseId);
     * // not in correct uuuu-MM-dd format
     ...
     * // given
     * tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * // when
     * request.postWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId), TutorialGroupConfigurationDTO.of(buildExampleConfiguration(configurationCourseId)),
     * TutorialGroupConfigurationDTO.class, HttpStatus.BAD_REQUEST);
     * // then
     * assertThat(tutorialGroupsConfigurationRepository.findByCourseIdWithEagerTutorialGroupFreePeriods(configurationCourseId)).isNotEmpty();
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     ...
     * this.assertConfigurationStructure(configuration, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY, configurationCourseId, true, true);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     ...
     * request.putWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId + 5, configuration.getId()), dto, TutorialGroupConfigurationDTO.class,
     * HttpStatus.BAD_REQUEST);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     ...
     * var configuration = tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * var dto = TutorialGroupConfigurationDTO.of(configuration);
     * request.putWithResponseBody(getTutorialGroupsConfigurationPath(configurationCourseId, configuration.getId() + 5), dto, TutorialGroupConfigurationDTO.class,
     * HttpStatus.BAD_REQUEST);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     ...
     * // given
     * tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * var course = courseRepository.findByIdWithEagerTutorialGroupConfigurationElseThrow(configurationCourseId);
     ...
     * // given
     * var configuration = tutorialGroupUtilService.createTutorialGroupConfiguration(configurationCourseId, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY);
     * var tutorialGroupWithSchedule = setUpTutorialGroupWithSchedule(configurationCourseId, "tutor1");
     * this.assertConfigurationStructure(configuration, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY, configurationCourseId, true, true);
     ...
     * // then
     * configuration = tutorialGroupsConfigurationRepository.findByIdWithEagerTutorialGroupFreePeriodsElseThrow(configuration.getId());
     * this.assertConfigurationStructure(configuration, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY, configurationCourseId, false, true);
     ...
     * // then
     * configuration = tutorialGroupsConfigurationRepository.findByIdWithEagerTutorialGroupFreePeriodsElseThrow(configuration.getId());
     * this.assertConfigurationStructure(configuration, FIRST_AUGUST_MONDAY, FIRST_SEPTEMBER_MONDAY, configurationCourseId, true, false);
     * asserTutorialGroupChannelIsCorrectlyConfigured(tutorialGroupWithSchedule);
     * }
     * @Test
     * @WithMockUser(username = TEST_PREFIX + "instructor1", roles = "INSTRUCTOR")
     ...
     * assertThat(tutorialGroupFreePeriodRepository.findAllByTutorialGroupsConfigurationCourseId(configurationCourseId)).hasSize(1);
     * // when
     * // change time zone to berlin and change the end period
     * var course = courseRepository.findByIdForUpdateElseThrow(configurationCourseId);
     ...
     * course = courseRepository.findByIdWithEagerTutorialGroupConfigurationElseThrow(configurationCourseId);
     ...
     * persistedSchedule.getLocation(), TutorialGroupSessionStatus.ACTIVE, null);
     * assertThat(tutorialGroupFreePeriodRepository.findAllByTutorialGroupsConfigurationCourseId(configurationCourseId)).hasSize(0);
     * }
     * @Nested
