...
class ProblemStatementRenderingIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void shouldRenderTasksWithTestResults() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][Sort Method](<testid>1</testid>,<testid>2</testid>)", testResults, null, "en");
    ...
    void shouldShowSuccessWhenAllTestsPass() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][Task A](<testid>1</testid>)", testResults, null, "en");
    ...
    void shouldShowNotExecutedWhenTestMissing() throws Exception {
        var testResults = List.of(new TestFeedbackInput(1, "testA", true, null, 1.0));
        var body = new ProblemStatementRenderRequest("[task][Task](<testid>1</testid>,<testid>999</testid>)", testResults, null, "en");
    ...
    void shouldRenderWithoutFeedbackWhenNoTestResults() throws Exception {
        var body = new ProblemStatementRenderRequest("[task][Sort](<testid>1</testid>)", null, null, "en");
    ...
    void shouldEscapeHtmlInFeedbackMessage() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, null, "en");
    ...
    void shouldEmbedResultSummary() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, resultSummary, "en");
    ...
    void shouldNotEmbedResultWhenNull() throws Exception {
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", null, null, "en");
    ...
    void shouldLocalizeTaskStats() throws Exception {
        var testResults = List.of(new TestFeedbackInput(1, "test", true, null, 1.0));
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, null, "de");
