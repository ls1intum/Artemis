...
class ProblemStatementRenderingIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void shouldRenderTasksWithTestResults() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][Sort Method](<testid>1</testid>,<testid>2</testid>)", testResults, null, "en", false);
    ...
    void shouldShowSuccessWhenAllTestsPass() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][Task A](<testid>1</testid>)", testResults, null, "en", false);
    ...
    void shouldShowNotExecutedWhenTestMissing() throws Exception {
        var testResults = List.of(new TestFeedbackInput(1, "testA", true, null, 1.0));
        var body = new ProblemStatementRenderRequest("[task][Task](<testid>1</testid>,<testid>999</testid>)", testResults, null, "en", false);
    ...
    void shouldRenderWithoutFeedbackWhenNoTestResults() throws Exception {
        var body = new ProblemStatementRenderRequest("[task][Sort](<testid>1</testid>)", null, null, "en", false);
    ...
    void shouldEscapeHtmlInFeedbackMessage() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, null, "en", false);
    ...
    void shouldEmbedResultSummary() throws Exception {
        ...
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, resultSummary, "en", false);
    ...
    void shouldNotEmbedResultWhenNull() throws Exception {
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", null, null, "en", false);
    ...
    void shouldLocalizeTaskStats() throws Exception {
        var testResults = List.of(new TestFeedbackInput(1, "test", true, null, 1.0));
        var body = new ProblemStatementRenderRequest("[task][T](<testid>1</testid>)", testResults, null, "de", false);
