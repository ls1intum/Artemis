package de.tum.cit.aet.artemis.exercise.modeling.compass.umlmodel.usecase;
...
class UMLUseCaseDiagramTest extends AbstractUMLDiagramTest {
    ...
    @Test
    void similarityUseCaseDiagram_v3_EqualModels() {
        compareSubmissions(modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_1_V3), modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_1), 0.8, 100.0);
        compareSubmissions(modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_2_V3), modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_2_V3), 0.8, 100.0);
    }
    ...
    @Test
    void similarityUseCaseDiagram_v3_DifferentModels() {
        compareSubmissions(modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_1_V3), modelingSubmission(UMLUseCaseDiagrams.USE_CASE_MODEL_2_V3), 0.0, 18.44);
    }
    ...
    @Test
    void parseUseCaseDiagramModelCorrectly_v3() throws IOException {
        UMLDiagram diagram = UMLModelParser.buildModelFromJSON(parseString(UMLUseCaseDiagrams.USE_CASE_MODEL_2_V3).getAsJsonObject(), 1L);
        assertThat(diagram).isInstanceOf(UMLUseCaseDiagram.class);
        UMLUseCaseDiagram useCaseDiagram = (UMLUseCaseDiagram) diagram;
        assertThat(useCaseDiagram.getSystemBoundaryList()).hasSize(1);
        assertThat(useCaseDiagram.getActorList()).hasSize(2);
