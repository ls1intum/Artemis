...
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.ATTACHMENT_CHANGE_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.ATTACHMENT_CHANGE_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_FAILED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_FAILED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_FINISHED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_FINISHED_WITH_ERRORS_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_STARTED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.COURSE_ARCHIVE_STARTED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.DUPLICATE_TEST_CASE_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_FAILED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_FAILED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_FINISHED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_FINISHED_WITH_ERRORS_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_STARTED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXAM_ARCHIVE_STARTED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXERCISE_PRACTICE_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXERCISE_PRACTICE_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXERCISE_RELEASED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.EXERCISE_UPDATED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.LIVE_EXAM_EXERCISE_UPDATE_NOTIFICATION_TEXT;
...
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.NEW_ANNOUNCEMENT_POST_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.NEW_ANNOUNCEMENT_POST_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.PROGRAMMING_TEST_CASES_CHANGED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.PROGRAMMING_TEST_CASES_CHANGED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.QUIZ_EXERCISE_STARTED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationConstants.QUIZ_EXERCISE_STARTED_TITLE;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.ATTACHMENT_UPDATED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.COURSES_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.COURSE_ARCHIVE_UPDATED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.EXAMS_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.EXAM_ARCHIVE_UPDATED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.EXERCISE_RELEASED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.EXERCISE_UPDATED_TEXT;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.createCoursePostTarget;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.createCourseTarget;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.createDuplicateTestCaseTarget;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.createExerciseTarget;
import static de.tum.cit.aet.artemis.domain.notification.NotificationTargetFactory.createLectureTarget;
