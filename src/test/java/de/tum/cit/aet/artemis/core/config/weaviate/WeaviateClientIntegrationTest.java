...
/**
 * Integration tests for Weaviate client connectivity.
 * <p>
 ...
 * <p>
 * Uses the shared Weaviate Testcontainer from {@link WeaviateTestContainerFactory}.
 * Skipped when Docker is not available or the container failed to start.
 * <p>
...
class WeaviateClientIntegrationTest {
    ...
    void testClientConnectsAndIsReady() throws Exception {
        ...
        var properties = new WeaviateConfigurationProperties(true, host, httpPort, grpcPort, "http", TEST_COLLECTION_PREFIX, WeaviateConfigurationProperties.VECTORIZER_NONE, null,
                null, null, null, null);
