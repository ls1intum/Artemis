...
class TransactionAfterCommitServiceTest {

    private final TransactionAfterCommitService service = new TransactionAfterCommitService();

    @Test
    void executesImmediatelyWithoutTransactionSynchronization() {
        var executed = new AtomicBoolean();

        service.execute(() -> executed.set(true));
