...
import de.tum.cit.aet.artemis.lecture.service.LectureVideoService;
import de.tum.cit.aet.artemis.nebula.AbstractNebulaIntegrationTest;

/**
 * Integration tests for the lecture video storage functionality.
 */
class LectureVideoIntegrationTest extends AbstractNebulaIntegrationTest {

    private static final String TEST_PREFIX = "lecturevideo";
    ...
    void testUploadVideo_Success() {
        ...
        // Act
        LectureVideoDTO result = lectureVideoService.uploadLectureVideo(testLecture, videoFile);
    ...
    void testUploadVideo_AlreadyHasVideo() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> lectureVideoService.uploadLectureVideo(testLecture, newVideoFile)).isInstanceOf(ResponseStatusException.class)
    ...
    void testDeleteVideo_Success() {
        ...
        // Act
        lectureVideoService.deleteLectureVideo(testLecture.getId());
    ...
    void testDeleteVideo_NotFound() {
        // Act & Assert
        assertThatThrownBy(() -> lectureVideoService.deleteLectureVideo(testLecture.getId())).isInstanceOf(ResponseStatusException.class)
    ...
    void testGetVideoStreamingUrl_Success() {
        ...
        // Act
        String streamUrl = lectureVideoService.getVideoStreamingUrl(testLecture.getId());
    ...
    void testGetVideoStreamingUrl_NotFound() {
        // Act & Assert
        assertThatThrownBy(() -> lectureVideoService.getVideoStreamingUrl(testLecture.getId())).isInstanceOf(ResponseStatusException.class)
                .extracting(ex -> ((ResponseStatusException) ex).getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
}
