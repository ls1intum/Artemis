...
class UMLModelParserTest {
    ...
    @Test
    void buildModelFromJSON_classDiagram_v3() throws Exception {
        JsonObject classDiagramJson = loadFileFromResources("test-data/model-submission/v3/example-class-diagram.json");
        List<UMLElement> expectedElements = createExampleClassDiagramElements();
    ...
    @Test
    void buildModelFromJSON_classDiagram_v3_empty() throws Exception {
        JsonObject classDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-class-diagram.json");
    ...
    @Test
    void buildModelFromJSON_classDiagram_v3_packageRelationship() throws Exception {
        JsonObject classDiagramJson = loadFileFromResources("test-data/model-submission/v3/example-class-diagram-package-relationship.json");
        UMLPackage umlPackage = new UMLPackage("Package", emptyList(), "94d565ec-c92c-422c-b3bd-347974936348");
        UMLClass umlClass = new UMLClass("Class", emptyList(), emptyList(), "ac9c281b-5b2c-4b3d-87c0-db798bd1f513", UMLClassType.CLASS);
    ...
    @Test
    void buildModelFromJSON_activityDiagram_v3() throws Exception {
        JsonObject activityDiagramJson = loadFileFromResources("test-data/model-submission/v3/example-activity-diagram.json");
        List<UMLElement> expectedElements = createExampleActivityDiagramElements();
    ...
    @Test
    void buildModelFromJSON_activityDiagram_v3_empty() throws Exception {
        JsonObject activityDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-activity-diagram.json");
    ...
    @Test
    void buildModelFromJSON_objectDiagram_v3_empty() throws Exception {
        JsonObject objectDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-object-diagram.json");
    ...
    @Test
    void buildModelFromJSON_useCaseDiagram_v3_empty() throws Exception {
        JsonObject useCaseDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-use-case-diagram.json");
    ...
    @Test
    void buildModelFromJSON_communicationDiagram_v3_empty() throws Exception {
        JsonObject communicationDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-communication-diagram.json");
        UMLDiagram umlDiagram = UMLModelParser.buildModelFromJSON(communicationDiagramJson, 123456789);
        assertThat(umlDiagram.getModelSubmissionId()).isEqualTo(123456789);
        assertThat(umlDiagram.getAllModelElements()).isEmpty();
    }
    ...
    @Test
    void buildModelFromJSON_deploymentDiagram_v3_empty() throws Exception {
        JsonObject deploymentDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-deployment-diagram.json");
    ...
    @Test
    void buildModelFromJSON_componentDiagram_v3_empty() throws Exception {
        JsonObject componentDiagramJson = loadFileFromResources("test-data/model-submission/v3/empty-component-diagram.json");
