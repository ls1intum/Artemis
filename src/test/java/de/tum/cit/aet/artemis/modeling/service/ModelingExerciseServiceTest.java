...
class ModelingExerciseServiceTest {
    ...
    void setUp() {
        ...
        modelingExerciseService = new ModelingExerciseService(modelingExerciseRepository, exerciseSpecificationService, channelService, participationRepository,
    ...
    void testGetDeletionSummary() {
        ...
        ExerciseDeletionSummaryDTO summary = modelingExerciseService.getDeletionSummary(exerciseId);
