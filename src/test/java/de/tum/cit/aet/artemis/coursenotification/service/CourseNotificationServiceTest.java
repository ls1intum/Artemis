...
import de.tum.cit.aet.artemis.coursenotification.dto.CourseNotificationPageableDTO;
import de.tum.cit.aet.artemis.coursenotification.test_repository.CourseNotificationParameterTestRepository;
...
class CourseNotificationServiceTest {
    ...
    void shouldCreateCourseNotificationWhenSending() {
        ...
        ArgumentCaptor<de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification> entityCaptor = ArgumentCaptor
                .forClass(de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification.class);
        verify(courseNotificationRepository).save(entityCaptor.capture());

        de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification savedEntity = entityCaptor.getValue();
    ...
    void shouldReturnCourseNotificationsWhenRequested() {
        ...
        de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification entity = createTestCourseNotificationEntity(1L);
        ...
        PageImpl<de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification> page = new PageImpl<>(List.of(entity));
    ...
    private de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification createTestCourseNotificationEntity(Long id) {
        Course course = new Course();
        course.setId(123L);

        de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification entity = new de.tum.cit.aet.artemis.coursenotification.domain.CourseNotification();
        entity.setId(id);
