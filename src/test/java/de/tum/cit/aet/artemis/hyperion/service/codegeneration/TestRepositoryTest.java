...
class TestRepositoryTest {
    ...
    void setup() {
        ...
        this.testRepository = new TestRepository(programmingExerciseRepository, chatClient, templates, gitService);
    ...
    void generateSolutionPlan_withNullRepositoryUri_usesWarningMessage() throws Exception {
        ...
        Map<String, Object> expectedVariables = Map.of("problemStatement", "Create a sorting algorithm with comprehensive test coverage", "solutionCode",
        ...
        verify(templates).render(eq("/prompts/hyperion/test/1_plan.st"), eq(expectedVariables));
    }
