...
class MemirisIntegrationTest extends AbstractIrisIntegrationTest {
    ...
    void courseChat_IntermediateAccessedMemoriesThenCreatedMemories() throws Exception {
        ...
        var executingInProgress = new PyrisStageDTO("Executing pipeline", 30, de.tum.cit.aet.artemis.iris.service.pyris.dto.status.PyrisStageState.IN_PROGRESS, null, false, null);
        var executingDone = new PyrisStageDTO("Executing pipeline", 30, de.tum.cit.aet.artemis.iris.service.pyris.dto.status.PyrisStageState.DONE, null, false, null);
