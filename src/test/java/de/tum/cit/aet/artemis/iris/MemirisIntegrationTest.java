...
class MemirisIntegrationTest extends AbstractIrisIntegrationTest {
    ...
    void courseChat_IntermediateAccessedMemoriesThenCreatedMemories() throws Exception {
        ...
        var executingInProgress = new PyrisStageDTO("Analyzing context", 30, IN_PROGRESS, null, false);
        var executingDone = new PyrisStageDTO("Analyzing context", 30, DONE, null, false);
