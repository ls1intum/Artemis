...
class IrisTextExerciseChatMessageIntegrationTest extends AbstractIrisIntegrationTest {
    ...
    @Autowired
    private IrisChatSessionRepository irisTextExerciseChatSessionRepository;
    ...
    private IrisChatSession createSessionForUser(String userLogin) {
        ...
        return irisTextExerciseChatSessionRepository.save(new IrisChatSession(exercise, user, IrisChatMode.TEXT_EXERCISE_CHAT));
    }
