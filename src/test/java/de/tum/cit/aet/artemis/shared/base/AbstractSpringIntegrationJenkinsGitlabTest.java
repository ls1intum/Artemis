...
@ActiveProfiles({ SPRING_PROFILE_TEST, PROFILE_ARTEMIS, PROFILE_CORE, PROFILE_SCHEDULING, "gitlab", "jenkins", PROFILE_LTI, PROFILE_AEOLUS, PROFILE_APOLLON })
@TestPropertySource(properties = { "artemis.athena.enabled=true", "info.guided-tour.course-group-tutors=artemis-artemistutorial-tutors",
