...
class IrisCourseChatSessionResourceTest extends AbstractIrisIntegrationTest {
    ...
    void testGetCurrentSessionOrCreateIfNotExists_createsNewSession() throws Exception {
        ...
        var response = request.postWithResponseBody("/api/iris/course-chat/" + course.getId() + "/sessions/current", null, IrisChatSessionResponseDTO.class, HttpStatus.OK);
    ...
    void testGetCurrentSessionOrCreateIfNotExists_forbiddenWhenNotInCourse() throws Exception {
        ...
        request.postWithResponseBody("/api/iris/course-chat/" + otherCourse.getId() + "/sessions/current", null, IrisChatSessionResponseDTO.class, HttpStatus.FORBIDDEN);
    }
    ...
    void testGetCurrentSessionOrCreateIfNotExists_forbiddenForInvalidCourseId() throws Exception {
        ...
        request.postWithResponseBody("/api/iris/course-chat/999999/sessions/current", null, IrisChatSessionResponseDTO.class, HttpStatus.FORBIDDEN);
    }
    ...
    void testGetCurrentSessionOrCreateIfNotExists_differentUsersGetDifferentSessions() throws Exception {
        ...
        var student2Response = request.postWithResponseBody("/api/iris/course-chat/" + course.getId() + "/sessions/current", null, IrisChatSessionResponseDTO.class, HttpStatus.OK);
    ...
    void testGetCurrentSessionOrCreateIfNotExists_tutorCanAccessSession() throws Exception {
        ...
        var sessionFromDb = irisCourseChatSessionRepository.findById(response.id()).orElseThrow();
    ...
    void testGetAllSessions_returnsAllUserSessions() throws Exception {
        ...
        var response = request.getList("/api/iris/course-chat/" + course.getId() + "/sessions", HttpStatus.OK, IrisChatSessionResponseDTO.class);
    ...
    void testGetAllSessions_notFoundWhenNoSessions() throws Exception {
        ...
        request.getList("/api/iris/course-chat/" + course.getId() + "/sessions", HttpStatus.NOT_FOUND, IrisChatSessionResponseDTO.class);
    }
    ...
    void testCreateSessionForCourse_createsNewSession() throws Exception {
        ...
        var response = request.postWithResponseBody("/api/iris/course-chat/" + course.getId() + "/sessions", null, IrisChatSessionResponseDTO.class, HttpStatus.CREATED);
    ...
    void testCreateSessionForCourse_forbiddenForInvalidCourseId() throws Exception {
        // When/Then: Request with invalid course ID should fail with FORBIDDEN
        // (The @EnforceAtLeastStudentInCourse annotation returns FORBIDDEN when the user cannot be verified as a course member)
        request.postWithResponseBody("/api/iris/course-chat/999999/sessions", null, IrisChatSessionResponseDTO.class, HttpStatus.FORBIDDEN);
    }
    ...
    void testGetCurrentSessionOrCreateIfNotExists_invokesIrisCitationService() throws Exception {
        request.postWithResponseBody("/api/iris/course-chat/" + course.getId() + "/sessions/current", null, IrisChatSessionResponseDTO.class, HttpStatus.OK);
