...
class FilePathConverterTest {
    ...
    static void setup() {
        ...
        FilePathConverter.setFileUploadPathStatic(rootPath.toString());
    }
    ...
    void testFileSystemPathForPublicUriForAllFilePathTypes() {
        ...
        assertThat(actualPath).isEqualTo(FilePathConverter.buildFilePath(7L, 9L).resolve("solution.txt"));
    }
    ...
    void testExternalUriForFileSystemPathForAllFilePathTypes() {
        ...
        // FILE_UPLOAD_SUBMISSION
        path = FilePathConverter.buildFilePath(7L, 9L).resolve("solution.txt");
