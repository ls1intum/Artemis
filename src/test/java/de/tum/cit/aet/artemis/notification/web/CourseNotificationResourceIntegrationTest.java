...
class CourseNotificationResourceIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void shouldReturnNotificationsWhenGetCourseNotificationsIsCalled() throws Exception {
        ...
        request.performMvcRequest(MockMvcRequestBuilders.get("/api/notification/notification/" + course.getId() + "?page=0&size=20")).andExpect(status().isOk())
    ...
    void shouldReturnPageSizeNotificationsWhenMoreThanPageSizeAreInDatabase() throws Exception {
        ...
        request.performMvcRequest(MockMvcRequestBuilders.get("/api/notification/notification/" + course.getId() + "?page=0&size=" + pageSize)).andExpect(status().isOk())
    ...
    void shouldReturnNotificationInfoWhenGetCourseNotificationInfoIsCalled() throws Exception {
        request.performMvcRequest(MockMvcRequestBuilders.get("/api/notification/notification/info")).andExpect(status().isOk()).andExpect(jsonPath("$.presets").isArray())
