 ...
 * <p>
 * A configuration is invalid if it results in a {@link HttpStatus#BAD_REQUEST} when any exercise of the right type that the configuration has been applied to is sent to the
 * server, for example via a create or update request.
 *
