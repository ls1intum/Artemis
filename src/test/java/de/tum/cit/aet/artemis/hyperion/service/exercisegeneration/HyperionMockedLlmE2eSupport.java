...
final class HyperionMockedLlmE2eSupport {
    ...
    /** Local development may omit Docker; a missing or incompatible image must fail the build tests rather than skip them. */
    static Optional<String> sandboxSkipReason() {
        return dockerGateEnabled() ? Optional.empty() : Optional.of("No Docker daemon is available for the Hyperion generation sandbox.");
    }
