...
class ExerciseDetailsWireContractIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void details_teamExercises_matchTheEntityWire() throws Exception {
        ...
        ProgrammingExerciseStudentParticipation programmingParticipation = studentParticipationRepository
                .save(ParticipationFactory.generateTeamProgrammingExerciseStudentParticipation(programmingExercise, programmingTeam));
