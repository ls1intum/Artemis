...
class ProblemStatementBindingCheckerTest {
    ...
    @ValueSource(strings = { "Raise NotImplementedError to make the tests fail.", "Your method name must match the exact test name reported by the test runner.",
            ...
            // The tests as an active subject reaching into the student's code, which tells students what the grader does with it.
    ...
    void proseHygieneLeaks_keepsAStudentFacingRequirementThatMerelyExplainsWhyAConstructorIsNeeded() {
        // The grader-internals rule must not swallow a real requirement on the student's own code.
    ...
    void duplicateInstructionLines_reportsATaskBodyPastedTwice() {
        // A repeated instruction sentence reads as several distinct requirements.
        String statement = """
