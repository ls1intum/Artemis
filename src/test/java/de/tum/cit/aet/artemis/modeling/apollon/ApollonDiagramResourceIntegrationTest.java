...
class ApollonDiagramResourceIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void testCreateApollonDiagram_CREATED() throws Exception {
        ...
        ApollonDiagram response = request.postWithResponseBody("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", apollonDiagram, ApollonDiagram.class,
                HttpStatus.CREATED);
    ...
    void testUpdateApollonDiagram_OK() throws Exception {
        ...
        apollonDiagram.setCourseId(course1.getId());
        ApollonDiagram response = request.putWithResponseBody("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", apollonDiagram, ApollonDiagram.class,
                HttpStatus.OK);
    ...
    void testUpdateApollonDiagram_AccessForbidden() throws Exception {
        ...
        apollonDiagram.setDiagramType(DiagramType.ClassDiagram);
        apollonDiagram.setCourseId(course1.getId());
        request.putWithResponseBody("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", apollonDiagram, ApollonDiagram.class, HttpStatus.FORBIDDEN);
    }
    ...
    void testGetDiagramsByCourse() throws Exception {
        ...
        List<ApollonDiagram> responseCourse1 = request.getList("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", HttpStatus.OK, ApollonDiagram.class);
        ...
        List<ApollonDiagram> updatedResponseCourse1 = request.getList("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", HttpStatus.OK, ApollonDiagram.class);
        ...
        updatedResponseCourse1 = request.getList("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams", HttpStatus.OK, ApollonDiagram.class);
        assertThat(updatedResponseCourse1).as("updated response is not empty").isNotEmpty();
        assertThat(updatedResponseCourse1).as("updated response has length 2").hasSize(2);

        List<ApollonDiagram> responseCourse2 = request.getList("/api/modeling/courses/" + course2.getId() + "/apollon-diagrams", HttpStatus.OK, ApollonDiagram.class);
    ...
    void testGetApollonDiagram() throws Exception {
        ...
        ApollonDiagram response = request.get("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams/" + savedDiagram.getId(), HttpStatus.OK, ApollonDiagram.class);
        assertThat(response).as("response is not null").isNotNull();
        request.get("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams/" + apollonDiagram.getId() + 1, HttpStatus.NOT_FOUND, ApollonDiagram.class);
    }
    ...
    void testGetApollonDiagram_AccessForbidden() throws Exception {
        ...
        request.get("/api/modeling/courses/" + course1.getId() + "/apollon-diagrams/" + savedDiagram.getId(), HttpStatus.FORBIDDEN, ApollonDiagram.class);
    }
