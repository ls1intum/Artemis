...
class CodeGenerationStrategyTest {
    ...
    void callChatClient_withValidInput_returnsResponse() throws Exception {
        ...
        when(templates.render("test-template", templateVariables)).thenReturn("rendered prompt");
        ...
        verify(templates).render("test-template", templateVariables);
    ...
    private static class TestCodeGenerationStrategy extends CodeGenerationStrategy {

        public TestCodeGenerationStrategy(ProgrammingExerciseRepository programmingExerciseRepository, ChatClient chatClient, PromptTemplateService templates) {
