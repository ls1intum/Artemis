...
class StruggleInterventionEventDTOTest {
    ...
    void nullSessionAndMessageIdsAreOmitted() throws Exception {
        ...
        var event = new StruggleInterventionEventDTO(42, "decide", "ambient", "Re-check the logic.", null, null, null, null, null, 0.7, null, null, null, null);
    ...
    void eventCarriesSessionIdMessageIdAndConfidence() throws Exception {
        ...
        var event = new StruggleInterventionEventDTO(42, "decide", "active", null, 99L, 555L, null, null, null, 0.81, "ep-abc", null, null, null);
        JsonNode node = mapper.valueToTree(event);
        assertThat(node.get("kind").asText()).isEqualTo("decide");
    ...
    void silentEventOmitsSessionMessageAndEpisodeWhenNull() throws Exception {
        ...
        var event = new StruggleInterventionEventDTO(42, "decide", "silent", null, null, null, null, null, null, null, null, null, null, null);
        JsonNode node = mapper.valueToTree(event);
        assertThat(node.get("kind").asText()).isEqualTo("decide");
    ...
    void confirmCloseFieldsRoundTripCorrectly() throws Exception {
        ...
        var falseEvent = new StruggleInterventionEventDTO(42, "confirm_close", null, null, null, null, null, null, null, null, "ep-rt", false, null, null);
