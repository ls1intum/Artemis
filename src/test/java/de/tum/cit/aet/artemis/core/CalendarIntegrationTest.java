 ...
 */
public class CalendarIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void shouldReturnNotFoundWhenCourseDoesNotExist() throws Exception {
        int courseId = -3;
        String URL = "/api/calendar/courses/" + courseId + "/calendar-events?monthKeys=" + FIXED_DATE_MONTH_STRING + "&timeZone=" + TEST_TIMEZONE_STRING;
    ...
    void shouldReturnBadRequestWhenMonthsHaveWrongFormat() throws Exception {
        ...
        String URL = "/api/calendar/courses/" + courseId + "/calendar-events?monthKeys=" + monthKeys + "&timeZone=" + TEST_TIMEZONE_STRING;
    ...
    void shouldReturnBadRequestWhenTimeZoneFormattedIncorrectly() throws Exception {
        ...
        String URL = "/api/calendar/courses/" + courseId + "/calendar-events?monthKeys=" + FIXED_DATE_MONTH_STRING + "&timeZone=" + malformedTimeZone;
        request.get(URL, HttpStatus.BAD_REQUEST, String.class);
    }
    ...
    class TutorialSessionEventTests {
        ...
        void shouldReturnCorrectEventsForTutorialGroupSessionAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("tutorial-" + tutorialGroupSession.getId(), "Tutorial Session", course.getTitle(),
                    tutorialGroupSession.getStart(), tutorialGroupSession.getEnd(), tutorialGroupSession.getLocation(), tutor.getFirstName() + " " + tutor.getLastName());
    ...
    class LectureEventTests {
        ...
        void shouldReturnCorrectEventForVisibleLectureWithStartButNoEndAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("lecture-" + lecture.getId() + "-startDate", lecture.getTitle(), lecture.getCourse().getTitle(),
                    lecture.getStartDate(), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForVisibleLectureWithEndButNoStartAsStudent() throws Exception {
            ...
            Long courseId = course.getId();
            String URL = "/api/calendar/courses/" + courseId + "/calendar-events?monthKeys=" + PAST_DATE_MONTH_STRING + "&timeZone=" + TEST_TIMEZONE_STRING;
            Map<String, List<CalendarEventDTO>> actualResponse = request.get(URL, HttpStatus.OK, EVENT_MAP_RETURN_TYPE);

            CalendarEventDTO expectedEvent = new CalendarEventDTO("lecture-" + lecture.getId() + "-endDate", lecture.getTitle(), lecture.getCourse().getTitle(),
                    lecture.getEndDate(), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForVisibleLectureWithStartAndEndAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("lecture-" + lecture.getId() + "-startAndEndDate", lecture.getTitle(), lecture.getCourse().getTitle(),
    ...
    class ExamEventTests {
        ...
        void shouldReturnCorrectEventsForVisibleExamWithStartAndEndAndPublishResultsAndReviewStartAndEndAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent1 = new CalendarEventDTO("exam-" + exam.getId() + "-startAndEndDate", exam.getTitle(), exam.getCourse().getTitle(), exam.getStartDate(),
                    exam.getEndDate(), null, exam.getExaminer());
            CalendarEventDTO expectedEvent2 = new CalendarEventDTO("exam-" + exam.getId() + "-publishResultsDate", exam.getTitle(), exam.getCourse().getTitle(),
                    exam.getPublishResultsDate(), null, null, null);
            CalendarEventDTO expectedEvent3 = new CalendarEventDTO("exam-" + exam.getId() + "-studentReviewStartDate", exam.getTitle(), exam.getCourse().getTitle(),
                    exam.getExamStudentReviewStart(), null, null, null);
            CalendarEventDTO expectedEvent4 = new CalendarEventDTO("exam-" + exam.getId() + "-studentReviewEndDate", exam.getTitle(), exam.getCourse().getTitle(),
        ...
        void shouldReturnCorrectEventsForVisibleExamWithStartAndEndButNoPublishResultsAndReviewStartAndEndAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("exam-" + exam.getId() + "-startAndEndDate", exam.getTitle(), exam.getCourse().getTitle(), exam.getStartDate(),
                    exam.getEndDate(), null, exam.getExaminer());
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
    ...
    class QuizExerciseEventTests {
        ...
        void shouldReturnCorrectEventForReleasedSynchronizedQuizWithStartTimeAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-startAndEndDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE.plusDays(1), PAST_DATE.plusDays(1).plusSeconds(600), null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForUnreleasedSynchronizedQuizWithStartTimeAsCourseStaffMember() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-startAndEndDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE.plusHours(1), FUTURE_DATE.plusHours(1).plusSeconds(600), null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForReleasedIndividualQuizWithNoDueDateAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-releaseDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE, null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForIndividualQuizWithDueDateButNoReleaseDateAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-dueDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE, null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventsForReleasedIndividualQuizWithDueDateAsStudent() throws Exception {
            ...
            CalendarEventDTO expectedEvent1 = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-releaseDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE, null, null, null);
            CalendarEventDTO expectedEvent2 = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-dueDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE.plusDays(1), null, null, null);
        ...
        void shouldReturnCorrectEventsForUnreleasedIndividualQuizWithDueDateAsCourseStaffMember() throws Exception {
            ...
            CalendarEventDTO expectedEvent1 = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-releaseDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE, null, null, null);
            CalendarEventDTO expectedEvent2 = new CalendarEventDTO("quizExercise-" + quizExercise.getId() + "-dueDate", quizExercise.getTitle(),
                    quizExercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE.plusDays(1), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = Stream.of(expectedEvent1, expectedEvent2)
                    .collect(Collectors.groupingBy(dto -> dto.startDate().toLocalDate().toString()));
    ...
    class NonQuizExerciseEventTests {
        ...
        @WithMockUser(username = STUDENT_LOGIN, roles = "USER")
        void shouldReturnCorrectEventForReleasedExerciseWithStartDateAsStudent(NonQuizExercise nonQuizExercise) throws Exception {
            ...
            String idPrefix = switch (nonQuizExercise) {
                case TEXT -> "textExercise-";
                case MODELING -> "modelingExercise-";
                case FILEUPLOAD -> "fileUploadExercise-";
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO(idPrefix + exercise.getId() + "-startDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE.plusDays(1), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForReleasedExerciseWithDueDateAsStudent(NonQuizExercise nonQuizExercise) throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO(idPrefix + exercise.getId() + "-dueDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE.plusDays(1), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        void shouldReturnCorrectEventForReleasedExerciseWithAssessmentDueDateAsStudent(NonQuizExercise nonQuizExercise) throws Exception {
            ...
            CalendarEventDTO expectedEvent = new CalendarEventDTO(idPrefix + exercise.getId() + "-assessmentDueDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), PAST_DATE.plusDays(1), null, null, null);
            Map<String, List<CalendarEventDTO>> expectedResponse = new HashMap<>();
            expectedResponse.put(expectedEvent.startDate().withZoneSameInstant(TEST_TIMEZONE).toLocalDate().toString(), List.of(expectedEvent));
        ...
        @EnumSource(NonQuizExercise.class)
        @WithMockUser(username = STUDENT_LOGIN, roles = "USER")
        void shouldReturnNoEventsForUnreleasedExerciseAsStudent(NonQuizExercise nonQuizExercise) throws Exception {
            Exercise exercise = switch (nonQuizExercise) {
        ...
        @EnumSource(NonQuizExercise.class)
        @WithMockUser(username = TUTOR_LOGIN, roles = "TA")
        void shouldReturnCorrectEventForReleasedExerciseWithStartDateAsCourseStaffMember(NonQuizExercise nonQuizExercise) throws Exception {
            Exercise exercise = switch (nonQuizExercise) {
                case TEXT -> textExerciseUtilService.createIndividualTextExercise(course, PAST_DATE, PAST_DATE.plusDays(1), null, null);
                case MODELING -> modelingExerciseUtilService.addModelingExercise(course, PAST_DATE, PAST_DATE.plusDays(1), null, null);
                case FILEUPLOAD -> fileUploadExerciseUtilService.addFileUploadExercise(course, PAST_DATE, PAST_DATE.plusDays(1), null, null);
        ...
        void shouldReturnCorrectEventsForUnreleasedExerciseAsCourseStaffMember(NonQuizExercise nonQuizExercise) throws Exception {
            ...
            CalendarEventDTO expectedEvent1 = new CalendarEventDTO(idPrefix + exercise.getId() + "-startDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE.plusDays(1), null, null, null);
            CalendarEventDTO expectedEvent2 = new CalendarEventDTO(idPrefix + exercise.getId() + "-dueDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE.plusDays(2), null, null, null);
            CalendarEventDTO expectedEvent3 = new CalendarEventDTO(idPrefix + exercise.getId() + "-assessmentDueDate", exercise.getTitle(),
                    exercise.getCourseViaExerciseGroupOrCourseMember().getTitle(), FUTURE_DATE.plusDays(3), null, null, null);
    ...
    void shouldReturnCorrectEventsForStudentWhenQueriedForMultipleMonths() throws Exception {
        ...
        CalendarEventDTO expectedEvent1 = new CalendarEventDTO("tutorial-" + tutorialGroupSession1.getId(), "Tutorial Session", course.getTitle(), tutorialGroupSession1.getStart(),
                tutorialGroupSession1.getEnd(), tutorialGroupSession1.getLocation(), tutor.getFirstName() + " " + tutor.getLastName());
        CalendarEventDTO expectedEvent2 = new CalendarEventDTO("tutorial-" + tutorialGroupSession2.getId(), "Tutorial Session", course.getTitle(), tutorialGroupSession2.getStart(),
                tutorialGroupSession2.getEnd(), tutorialGroupSession2.getLocation(), tutor.getFirstName() + " " + tutor.getLastName());
        CalendarEventDTO expectedEvent3 = new CalendarEventDTO("tutorial-" + tutorialGroupSession3.getId(), "Tutorial Session", course.getTitle(), tutorialGroupSession3.getStart(),
    ...
    void shouldSplitEventAcrossDaysWhenEventSpansMultipleDays() throws Exception {
        ...
        CalendarEventDTO expectedEvent1 = new CalendarEventDTO("tutorial-" + tutorialGroupSession.getId() + "-0", "Tutorial Session", course.getTitle(),
                tutorialGroupSession.getStart(), tutorialGroupSession.getStart().toLocalDate().atTime(DateUtil.END_OF_DAY).atZone(timezone), tutorialGroupSession.getLocation(),
                tutor.getFirstName() + " " + tutor.getLastName());
        CalendarEventDTO expectedEvent2 = new CalendarEventDTO("tutorial-" + tutorialGroupSession.getId() + "-1", "Tutorial Session", course.getTitle(),
                tutorialGroupSession.getStart().plusDays(1).toLocalDate().atStartOfDay(timezone),
                tutorialGroupSession.getStart().plusDays(1).toLocalDate().atTime(DateUtil.END_OF_DAY).atZone(timezone), tutorialGroupSession.getLocation(),
                tutor.getFirstName() + " " + tutor.getLastName());
        CalendarEventDTO expectedEvent3 = new CalendarEventDTO("tutorial-" + tutorialGroupSession.getId() + "-2", "Tutorial Session", course.getTitle(),
                tutorialGroupSession.getStart().plusDays(2).toLocalDate().atStartOfDay(timezone), tutorialGroupSession.getEnd(), tutorialGroupSession.getLocation(),
                tutor.getFirstName() + " " + tutor.getLastName());
        Map<String, List<CalendarEventDTO>> expectedResponse = Stream.of(expectedEvent1, expectedEvent2, expectedEvent3)
                .collect(Collectors.groupingBy(dto -> dto.startDate().toLocalDate().toString()));
    ...
    void shouldGroupEventsAccordingToClientTimeZone() throws Exception {
        ...
        String URL = "/api/calendar/courses/" + courseId + "/calendar-events?monthKeys=2025-05&timeZone=" + otherTimeZone;
        Map<String, List<CalendarEventDTO>> actualResponse = request.get(URL, HttpStatus.OK, EVENT_MAP_RETURN_TYPE);

        CalendarEventDTO expectedEvent = new CalendarEventDTO("tutorial-" + tutorialGroupSession.getId(), "Tutorial Session", course.getTitle(), tutorialGroupSession.getStart(),
