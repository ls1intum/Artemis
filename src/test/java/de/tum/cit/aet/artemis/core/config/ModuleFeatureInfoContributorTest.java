...
class ModuleFeatureInfoContributorTest {
    ...
    private static final List<String> modulePropertyNames = List.of(Constants.ATLAS_ENABLED_PROPERTY_NAME, Constants.FILEUPLOAD_ENABLED_PROPERTY_NAME);

    @Test
    void testEnabledContribution() {
        testContribution(true, List.of(Constants.MODULE_FEATURE_ATLAS, Constants.MODULE_FEATURE_FILEUPLOAD));
    }
