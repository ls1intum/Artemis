...
class CourseRequestIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void acceptCourseRequest_asAdmin_shouldSucceed() throws Exception {
        ...
        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Accept Test", "ACPTST", "WS2025", null, null);
    ...
    void acceptCourseRequest_asInstructor_shouldReturnForbidden() throws Exception {
        ...
        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Accept Forbidden Test", "ACPFBD", "WS2025", null, null);
    ...
    void acceptCourseRequest_nonExistent_shouldReturnNotFound() throws Exception {
        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Non Existent", "NONEXST", "WS2025", null, null);
    ...
    void acceptCourseRequest_alreadyAccepted_shouldReturnBadRequest() throws Exception {
        ...
        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Already Accepted", "ALRACPT", "WS2025", null, null);
    ...
    void acceptCourseRequest_alreadyRejected_shouldReturnBadRequest() throws Exception {
        ...
        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Already Rejected", "ALRREJT", "WS2025", null, null);
    ...
    void acceptCourseRequest_withShortNameConflict_shouldReturnBadRequest() throws Exception {
        ...
        // Create a course with the same short name that the accept DTO will use
        Course existingCourse = new Course();
        existingCourse.setShortName("CNFLCT");
        existingCourse.setTitle("Conflicting Course");
        courseRepository.save(existingCourse);

        CourseRequestAcceptDTO acceptDTO = new CourseRequestAcceptDTO("Conflicting Accept", "CNFLCT", "WS2025", null, null);
    ...
    void getAdminOverview_withPagination_shouldReturnCorrectDecidedRequests() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            CourseRequest request = createTestCourseRequest("Decided " + i);
