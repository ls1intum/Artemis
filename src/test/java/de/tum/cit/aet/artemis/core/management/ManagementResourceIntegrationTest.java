...
class ManagementResourceIntegrationTest extends AbstractSpringIntegrationLocalCILocalVCTest {
    ...
    void toggleFeatures() throws Exception {
        ...
        request.put("/api/core/exercises/" + programmingExercise1.getId() + "/resume-programming-participation/" + participation.getId(), null, HttpStatus.OK);
        request.put("/api/core/participations/" + participation.getId() + "/cleanup-build-plan", null, HttpStatus.OK);
        request.postWithoutLocation("/api/core/programming-submissions/" + participation.getId() + "/trigger-failed-build", null, HttpStatus.OK, null);
        ...
        request.delete("/api/core/programming-exercises/" + programmingExercise2.getId(), HttpStatus.OK, deleteProgrammingExerciseParamsFalse());
        ...
        request.put("/api/core/exercises/" + programmingExercise1.getId() + "/resume-programming-participation/" + participation.getId(), null, HttpStatus.FORBIDDEN);
        request.put("/api/core/participations/" + participation.getId() + "/cleanup-build-plan", null, HttpStatus.FORBIDDEN);
        request.postWithoutLocation("/api/core/programming-submissions/" + participation.getId() + "/trigger-failed-build", null, HttpStatus.FORBIDDEN, null);
        programmingExercise2.setBuildConfig(programmingExerciseBuildConfigRepository.save(programmingExercise2.getBuildConfig()));
        programmingExercise2 = programmingExerciseRepository.save(programmingExercise2);
        request.delete("/api/core/programming-exercises/" + programmingExercise2.getId(), HttpStatus.FORBIDDEN);
