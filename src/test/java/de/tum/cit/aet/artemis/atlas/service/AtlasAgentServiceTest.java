...
class AtlasAgentServiceTest {
    ...
    void setUp() {
        ...
        atlasAgentService = new AtlasAgentService(chatClient, chatMemory, delegationService, null, null, null, null, executionPlanStateManagerService, atlasAgentSessionCacheService,
                previewService);
    }
