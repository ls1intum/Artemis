...
class FeatureToggleServiceTest extends AbstractSpringIntegrationIndependentTest {
    ...
    // science, TutorSuggestions, AtlasAgent, AtlasML, Memiris, RateLimit, GlobalSearch, AutonomousTutor, AutomaticCompetencyManagement disabled by default
    ...
    void checkReset() {
        ...
        assertThat(featureToggleService.isFeatureEnabled(Feature.AutomaticCompetencyManagement)).isFalse();
    }
    ...
    private void resetToDefaultState() {
        ...
        featureToggleService.disableFeature(Feature.AutomaticCompetencyManagement);
    }
