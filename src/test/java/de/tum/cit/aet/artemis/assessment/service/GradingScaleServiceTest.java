...
class GradingScaleServiceTest extends AbstractSpringIntegrationIndependentBatchTest {
    ...
    void testMatchPercentageToGradeStepNoValidMapping() {
        ...
        assertThatExceptionOfType(EntityNotFoundException.class).isThrownBy(() -> gradingScaleRepository.matchPercentageToGradeStep(percentage, gradingScale))
    ...
    void testMatchPercentageToGradeStepValidMappingExists() {
        ...
        GradeStep gradeStep = gradingScaleRepository.matchPercentageToGradeStep(percentage, gradingScale);

        assertThat(gradeStep).usingRecursiveComparison().ignoringFields("gradingScale", "gradingScale", "id").isEqualTo(expectedGradeStep);
    }
    ...
    void testMatchPercentageToGradeStepWithBonusPoints(double bonusPercentage) {
        ...
        GradeStep gradeStep = gradingScaleRepository.matchPercentageToGradeStep(bonusPercentage, gradingScale);
    ...
    void testSaveGradingScaleValidGradeStepSet() {
        ...
        assertThat(savedGradingScale).usingRecursiveComparison().ignoringFields("exam", "course", "gradeSteps", "gradingScale").isEqualTo(gradingScale);
        assertThat(savedGradingScale.getGradeSteps()).usingRecursiveComparison().ignoringFields("gradingScale", "gradingScale", "id").isEqualTo(gradingScale.getGradeSteps());
    }
    ...
    void testGradeStepMatchingForRoundingErrors1() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(39.99, gradingScale);

        assertThat(gradeStep.getGradeName()).isEqualTo("Step0");

        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(39.999, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors2() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(64.005, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors3() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(50.009, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors4() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(60.1322, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors5() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(33, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors6() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(55.679, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors7() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(70.15, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors8() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(45.825, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors9() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(50.1, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors10() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(35.089, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors11() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(25, gradingScale);
    ...
    void testGradeStepMatchingForRoundingErrors12() {
        ...
        gradeStep = gradingScaleRepository.matchPercentageToGradeStep(42.06, gradingScale);
