...
@ActiveProfiles({ SPRING_PROFILE_TEST, PROFILE_ARTEMIS, PROFILE_CORE, PROFILE_SCHEDULING, PROFILE_APOLLON, PROFILE_IRIS, PROFILE_AEOLUS, PROFILE_THEIA, PROFILE_LTI })
@TestPropertySource(properties = { "artemis.athena.enabled=true", "artemis.user-management.use-external=false",
