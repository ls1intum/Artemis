...
class PyrisRewritingTest extends AbstractIrisIntegrationTest {
    ...
    void callRewritingPipeline() throws Exception {
        ...
        irisRewritingService.handleStatusUpdate(job,
                new PyrisRewritingStatusUpdateDTO(stages, "result", null, List.of("Inconsistency 1", "Inconsistency 2"), List.of("Suggestion 1", "Suggestion 2"), null));
        ...
        assertThat(allValues.get(2).inconsistencies()).containsExactly("Inconsistency 1", "Inconsistency 2");
        assertThat(allValues.get(2).suggestions()).containsExactly("Suggestion 1", "Suggestion 2");
    }
