...
class AdminBuildJobQueueResourceTest {
    ...
    void returnsLiveGenerationSandboxesForKnownAgent() {
        ...
        GenerationSandboxSessionDTO session = new GenerationSandboxSessionDTO("agent-1::container", GenerationSandboxSessionDTO.Role.AUTHORING, "job-1", 12L, 3L, "instructor",
                "GENERATE", Instant.EPOCH, Instant.EPOCH, 2);
