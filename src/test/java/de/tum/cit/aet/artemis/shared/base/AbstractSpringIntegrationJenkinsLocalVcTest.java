...
@TestPropertySource(properties = { "server.port=49152", "info.guided-tour.course-group-tutors=artemis-artemistutorial-tutors",
        "info.guided-tour.course-group-students=artemis-artemistutorial-students", "artemis.version-control.url=http://localhost:49152",
        "artemis.version-control.local-vcs-repo-path=${java.io.tmpdir}", "info.guided-tour.course-group-editors=artemis-artemistutorial-editors",
        ...
        "artemis.version-control.ssh-template-clone-url=ssh://git@localhost:1235/", "spring.liquibase.enabled=true", "artemis.iris.health-ttl=500",
        "artemis.version-control.ssh-private-key-folder-path=${java.io.tmpdir}", "info.contact=test@localhost",
        "spring.jpa.properties.hibernate.cache.hazelcast.instance_name=Artemis_localvc_jenkins", })
