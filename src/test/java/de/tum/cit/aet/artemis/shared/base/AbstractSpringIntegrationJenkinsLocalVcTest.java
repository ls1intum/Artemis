...
@TestPropertySource(properties = { "server.port=49153", "artemis.version-control.url=http://localhost:49153",
        ...
        "spring.jpa.properties.hibernate.cache.hazelcast.instance_name=Artemis_localvc_jenkins", "artemis.version-control.ssh-port=7203",
        "artemis.version-control.ssh-template-clone-url=ssh://git@localhost:7203/" })
