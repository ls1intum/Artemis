...
class HyperionTemplateRepositoryServiceTest {
    ...
    void generateSolutionPlan_includesSolutionCodeInTemplateVariables() throws Exception {
        ...
        templateRepository.generateSolutionPlan(user, exercise, 1L, "logs", "structure", "consistency issues");
    ...
    void generateSolutionPlan_withRepositoryAccessException_throwsNetworkingException() throws Exception {
        ...
        assertThatThrownBy(() -> templateRepository.generateSolutionPlan(user, exercise, 1L, "logs", "structure", "consistency issues")).isInstanceOf(NetworkingException.class)
                .hasMessageContaining("Repository access failed").hasRootCauseMessage("Repository access failed");
    }
    ...
    void generateSolutionPlan_withNullBuildLogs_usesEmptyString() throws Exception {
        ...
        templateRepository.generateSolutionPlan(user, exercise, 1L, null, "repo structure", "consistency issues");
    ...
    void generateSolutionPlan_withNullRepositoryStructure_throwsIllegalArgumentException() {
        assertThatThrownBy(() -> templateRepository.generateSolutionPlan(user, exercise, 1L, "logs", null, "consistency issues")).isInstanceOf(IllegalArgumentException.class)
