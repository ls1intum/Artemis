...
class WeaviateConfigurationPropertiesTest {
    ...
    void testSchemeSecureValidation() {
        ...
        assertThat(new WeaviateConfigurationProperties(false, "localhost", 8001, 50051, "http", TEST_COLLECTION_PREFIX, WeaviateConfigurationProperties.VECTORIZER_NONE, null, null,
                null, null, null)).isNotNull();
        assertThat(new WeaviateConfigurationProperties(false, "localhost", 443, 50051, "https", TEST_COLLECTION_PREFIX, WeaviateConfigurationProperties.VECTORIZER_NONE, null, null,
                null, null, null)).isNotNull();
    ...
    void testSchemeValidation() {
        ...
        assertThat(new WeaviateConfigurationProperties(true, "localhost", 8001, 50051, "http", TEST_COLLECTION_PREFIX, WeaviateConfigurationProperties.VECTORIZER_NONE, null, null,
                null, null, null).secure()).isFalse();
        assertThat(new WeaviateConfigurationProperties(true, "localhost", 443, 50051, "https", TEST_COLLECTION_PREFIX, WeaviateConfigurationProperties.VECTORIZER_NONE, null, null,
                null, null, null).secure()).isTrue();
    }
}
