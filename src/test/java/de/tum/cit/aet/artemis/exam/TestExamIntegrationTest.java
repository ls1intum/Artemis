...
class TestExamIntegrationTest extends AbstractSpringIntegrationIndependentTest {
    ...
    void testUpdateTestExam_asInstructor_withExamModeChanged() throws Exception {
        ...
        createdExamA.setExamType(ExamType.REAL);
        ...
        examB.setExamType(ExamType.REAL);
        ...
        createdExamB.setExamType(ExamType.PRACTICE);
        ...
        // Case 3: practice test exam should be updated to simulation test exam
        Exam examC = ExamFactory.generateTestExam(course1);
        examC.setChannelName("examC");
        Exam createdExamC = request.postWithResponseBody("/api/exam/courses/" + course1.getId() + "/exams", examC, Exam.class, HttpStatus.CREATED);
        createdExamC.setExamType(ExamType.SIMULATION);
        request.putWithResponseBody("/api/exam/courses/" + course1.getId() + "/exams", createdExamC, Exam.class, HttpStatus.CONFLICT);
    }
