...
class PyrisStatusUpdateStruggleTest {
    ...
    void decisionCallback_removesJobThenDispatchesThenReleasesMarker() {
        var update = new PyrisStruggleInterventionStatusUpdateDTO("hint", "active", 0.8, "FM", List.of(), List.of());
    ...
    void nonDecisionCallback_keepAlive_holdsMarker() {
        ...
        var update = new PyrisStruggleInterventionStatusUpdateDTO(null, null, null, null, List.of(inProgress), List.of());
    ...
    void nonDecisionTerminalCallback_releasesMarker() {
        ...
        var update = new PyrisStruggleInterventionStatusUpdateDTO(null, null, null, null, List.of(errorStage), List.of());
