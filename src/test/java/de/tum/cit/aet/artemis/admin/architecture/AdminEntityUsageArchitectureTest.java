...
/**
 * Architecture test to verify that REST controllers in the Admin module
 * do not use @Entity types directly. Controllers should use DTOs instead.
 * <p>
 * TODO: Reduce violation counts to 0 by introducing DTOs for all endpoints.
 */
class AdminEntityUsageArchitectureTest extends AbstractModuleEntityUsageArchitectureTest {
