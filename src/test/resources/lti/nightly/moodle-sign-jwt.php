<?php
// Invoked via `docker exec moodle php /tmp/moodle-sign-jwt.php <audience> <endpoint> <nonce>` from
// NightlyLtiMoodleInteropTest. Calls Moodle's own `lti_sign_jwt()` so the JWT is bit-for-bit
