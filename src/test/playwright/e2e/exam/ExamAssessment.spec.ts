...
test.describe('Exam assessment', () => {
    ...
    test.describe('Programming exercise assessment', () => {
        test.beforeEach('Prepare exam', async ({ page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd }) => {
            examEnd = dayjs().add(2, 'minutes');
            await prepareExam(course, examEnd, ExerciseType.PROGRAMMING, page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd);
        });
    ...
    test.describe('Modeling exercise assessment', () => {
        test.beforeEach('Prepare exam', async ({ page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd }) => {
            ...
            await prepareExam(course, examEnd, ExerciseType.MODELING, page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd);
        });
    ...
    test.describe('Text exercise assessment', () => {
        test.beforeEach('Prepare exam', async ({ page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd }) => {
            ...
            await prepareExam(course, examEnd, ExerciseType.TEXT, page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd);
        });
    ...
    test.describe('Quiz exercise assessment', () => {
        ...
        test.beforeEach('Prepare exam', async ({ page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd }) => {
            ...
            await prepareExam(course, examEnd, ExerciseType.QUIZ, page, examAPIRequests, examExerciseGroupCreation, examParticipation, examNavigation, examStartEnd);
        });
...
async function handleComplaint(
    ...
    await expect(exerciseAssessment.getComplaintText().filter({ hasText: complaintText })).toBeVisible();
    if (reject) {
