...
module.exports = {
    ...
    rootDir: '../../../',
    testMatch: ['<rootDir>/src/test/javascript/spec/integration/**/*.ts', '<rootDir>/src/test/javascript/spec/component/**/*.ts','<rootDir>/src/test/javascript/spec/app/entities/lecture/*.ts', '<rootDir>/src/test/javascript/spec/service/**/*.ts'],
    moduleNameMapper: {
