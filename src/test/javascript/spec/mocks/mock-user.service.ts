...
export class MockUserService {
    query(req?: any): Observable<HttpResponse<User[]>> {
        return of({
            body: [new User(1, "ga59pelTest", "Alexandros", "Tsakpinis", "alexandros.tsakpinis@tum.de",
                false, "en", ["ROLE_USER", "ROLE_ADMIN"], ["jira-users", "tumuser", "eist2019students"], "anonymousUser",
                new Date("2020-03-03T09:01:43Z"), "ga59pel", new Date("2020-03-22T13:02:10Z"))],
