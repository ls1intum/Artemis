...
describe('ExamParticipantScores', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [ExamParticipantScoresComponent, ParticipantScoresTableContainerStubComponent, MockPipe(ArtemisTranslatePipe), MockComponent(AlertOverlayComponent)],
            providers: [
