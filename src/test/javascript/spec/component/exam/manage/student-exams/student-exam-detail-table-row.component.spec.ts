...
describe('StudentExamDetailTableRowComponent', () => {
    ...
    it('should return the right icon based on exercise type', () => {
        ...
        expect(studentExamDetailTableRowComponent.exerciseIcon(exercise)).to.equal('project-diagram');

        exercise = new ProgrammingExercise(course, new ExerciseGroup());
        expect(studentExamDetailTableRowComponent.exerciseIcon(exercise)).to.equal('keyboard');

        exercise = new QuizExercise(course, new ExerciseGroup());
        expect(studentExamDetailTableRowComponent.exerciseIcon(exercise)).to.equal('check-double');

        exercise = new FileUploadExercise(course, new ExerciseGroup());
        expect(studentExamDetailTableRowComponent.exerciseIcon(exercise)).to.equal('file-upload');
    });
