...
import { ExamLiveStatisticsComponent, TableContent } from 'app/exam/statistics/exam-live-statistics.component';
...
describe('Exam Live Statistics Component', () => {
    // Course
    ...
    let comp: ExamLiveStatisticsComponent;
    let fixture: ComponentFixture<ExamLiveStatisticsComponent>;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [ExamLiveStatisticsComponent, ArtemisDatePipe, MockPipe(ArtemisTranslatePipe)],
            providers: [
            ...
            .then(() => {
                ...
                fixture = TestBed.createComponent(ExamLiveStatisticsComponent);
    ...
    it('should call notifyExamSubscribers on init', () => {
        ...
        const responseFakeExam = { body: exam as Exam } as HttpResponse<Exam>;
        jest.spyOn(examManagementService, 'find').mockReturnValue(of(responseFakeExam));
        const spy = jest.spyOn(examLiveStatisticsService, 'notifyExamSubscribers');
