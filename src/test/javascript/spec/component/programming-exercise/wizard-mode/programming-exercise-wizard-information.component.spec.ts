    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            .then(() => {
                ...
                wizardComponent.updateRepositoryName = (a) => (an) => '';
                wizardComponent.updateCheckoutDirectory = (a) => (an) => '';
                wizardComponent.refreshAuxiliaryRepositoryChecks = () => {};
                wizardComponent.updateCategories = (c) => {};
