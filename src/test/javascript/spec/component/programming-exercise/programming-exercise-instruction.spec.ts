...
import { ProgrammingExerciseTaskExtensionWrapper } from 'app/exercises/programming/shared/instructions/instructions-render/extensions/programming-exercise-task.extension';
