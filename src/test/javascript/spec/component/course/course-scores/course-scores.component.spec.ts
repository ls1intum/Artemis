...
describe('CourseScoresComponent', () => {
    ...
    courseScoreStudent1.scoreAchieved = roundScorePercent(40 / 30, course);
    ...
    courseScoreStudent2.scoreAchieved = roundScorePercent(15 / 30, course);
    ...
    it('should log error on sentry when wrong points score calculation', () => {
        ...
        cs1.scoreAchieved = roundScorePercent(40 / 30, course);
        const cs2 = new ScoresDTO();
        cs2.studentId = user2.id;
        cs2.pointsAchieved = 99;
        cs2.studentLogin = user2.login;
        cs2.scoreAchieved = roundScorePercent(15 / 30, course);
    ...
    it('should generate csv correctly', () => {
        ...
        validateUserRow(
            ...
            '0%',
            '40',
            roundScorePercent(40 / 30, course).toLocaleString() + '%',
        );
