...
describe('RequestFeedbackButtonComponent', () => {
    ...
    it('should handle errors when requestFeedback fails', fakeAsync(() => {
        ...
        const exercise = { id: 1, type: ExerciseType.TEXT, course: undefined, studentParticipations: [participation], allowManualFeedbackRequests: true } as Exercise;
    ...
    it('should disable the button when participation is missing', fakeAsync(() => {
        setAthenaEnabled(true);
        const exercise = { id: 1, type: ExerciseType.TEXT, course: {}, studentParticipations: undefined, allowManualFeedbackRequests: true } as Exercise;
        fixture.componentRef.setInput('exercise', exercise);
        mockExerciseDetails(exercise);
    ...
    it('should display the correct button label and style when Athena is enabled', fakeAsync(() => {
        ...
        const exercise = { id: 1, type: ExerciseType.TEXT, course: {}, studentParticipations: [participation], allowManualFeedbackRequests: true } as Exercise;
        fixture.componentRef.setInput('exercise', exercise);
    ...
    it('should call requestFeedback() when button is clicked', fakeAsync(() => {
        ...
        const exercise = { id: 1, type: ExerciseType.PROGRAMMING, studentParticipations: [participation], course: {}, allowManualFeedbackRequests: true } as Exercise;
        fixture.componentRef.setInput('exercise', exercise);
    ...
    it('should show an alert when requestFeedback() is called and conditions are not satisfied', fakeAsync(() => {
        ...
        const exercise = { id: 1, type: ExerciseType.TEXT, course: {}, allowManualFeedbackRequests: true } as Exercise;
        fixture.componentRef.setInput('exercise', exercise);
    ...
    it('should disable the button if latest submission is not submitted or feedback is generating', fakeAsync(() => {
        ...
        const exercise = { id: 1, type: ExerciseType.TEXT, studentParticipations: [participation], course: {}, allowManualFeedbackRequests: true } as Exercise;
        fixture.componentRef.setInput('exercise', exercise);
