...
import { MODULE_FEATURE_FILEUPLOAD } from '../../../../../../main/webapp/app/app.constants';
        ...
        return TestBed.configureTestingModule({
            ...
            .then(() => {
                ...
                getProfileInfoSub.mockReturnValue(
                    of({ inProduction: false, sshCloneURLTemplate: 'ssh://git@testserver.com:1234/', activeModuleFeatures: [MODULE_FEATURE_FILEUPLOAD] } as ProfileInfo),
                );
