...
describe('ShortAnswerQuestionUtil', () => {
    ...
    it('Should transform text parts to html correctly', fakeAsync(() => {
        ...
        expect(shortAnswerQuestionUtil.transformTextPartsIntoHTML(originalTextParts1)).to.eql(formattedTextParts1);
        ...
        expect(shortAnswerQuestionUtil.transformTextPartsIntoHTML(originalTextParts2)).to.eql(formattedTextParts2);
        ...
        expect(shortAnswerQuestionUtil.transformTextPartsIntoHTML(originalTextParts3)).to.eql(formattedTextParts3);
    }));
