...
describe('ProgrammingExerciseGitDiffReport Component', () => {
    ...
    it('Should set added/removed lines to 1-0', () => {
        const entries = [{ filePath: 'src/a.java', startLine: 1, lineCount: 1 }] as ProgrammingExerciseGitDiffEntry[];
    ...
    it('Should set added/removed lines to 0-1', () => {
        const entries = [{ filePath: 'src/a.java', previousStartLine: 1, previousLineCount: 1 }] as ProgrammingExerciseGitDiffEntry[];
