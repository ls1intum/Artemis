...
import { irisCourse, mockConversation } from '../../helpers/sample/iris-sample-data';
import { IrisHttpExerciseCreationSessionService } from 'app/iris/http-exercise-creation-session.service';

describe('Iris Http Exercise Creation Session Service', () => {
    let service: IrisHttpExerciseCreationSessionService;
    let httpMock: HttpTestingController;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [HttpClientTestingModule],
            providers: [IrisHttpExerciseCreationSessionService],
        });
        service = TestBed.inject(IrisHttpExerciseCreationSessionService);
    ...
    describe('Service methods', () => {
        ...
        it('should return current session', fakeAsync(() => {
            ...
            service
                .getCurrentSession(irisCourse.id!)
                .pipe(take(1))
