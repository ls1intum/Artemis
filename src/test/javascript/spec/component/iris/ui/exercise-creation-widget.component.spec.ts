...
describe('IrisExerciseCreationChatbotWidgetComponent', () => {
    ...
    let mockExerciseCreationSessionService: IrisExerciseCreationSessionService;
    ...
    beforeEach(async () => {
        ...
        mockExerciseCreationSessionService = {
            createNewSession: jest.fn(),
            sendMessage: jest.fn().mockImplementation(async (sessionId, message) => {
                return mockHttpMessageService.createMessage(sessionId, message);
            }),
            resendMessage: jest.fn().mockImplementation(async (sessionId, message) => {
                return mockHttpMessageService.resendMessage(sessionId, message);
            }),
            rateMessage: jest.fn().mockImplementation(async (sessionId, messageId, helpful) => {
                return mockHttpMessageService.rateMessage(sessionId, messageId, helpful);
            }),
        } as any;
        ...
        await TestBed.configureTestingModule({
            ...
            .then(() => {
                ...
                component.sessionService = mockExerciseCreationSessionService;
    ...
    it('should add user message on send', waitForAsync(async () => {
        ...
        const sessionMock = jest.spyOn(mockExerciseCreationSessionService, 'sendMessage');
    ...
    it('should resend message', waitForAsync(async () => {
        ...
        const sessionMock = jest.spyOn(mockExerciseCreationSessionService, 'resendMessage');
    ...
    it('should rate message', waitForAsync(async () => {
        ...
        const sessionMock = jest.spyOn(mockExerciseCreationSessionService, 'rateMessage');
    ...
    describe('clear chat session', () => {
        it('should call service to clear old session and create a new one', () => {
            jest.spyOn(mockExerciseCreationSessionService, 'createNewSession');
            component.exerciseId = 18;

            component.createNewSession();

            expect(mockExerciseCreationSessionService.createNewSession).toHaveBeenCalledWith(18);
        });
