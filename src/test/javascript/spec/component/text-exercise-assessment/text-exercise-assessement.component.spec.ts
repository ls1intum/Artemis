...
describe('TextExerciseAssessmentComponent', () => {
    ...
    const testBedConfiguration = (routeParamSubmissionId?: string | number) => {
        const submissionId = routeParamSubmissionId ? routeParamSubmissionId : 'new';
        const route = ({ params: of({ exerciseId: exercise.id, submissionId }) } as any) as ActivatedRoute;
    ...
    describe('when submissionId router param is `new`', () => {
        beforeEach(async () => {
            await testBedConfiguration();
        });
    ...
    describe('when submissionId router param is 1', () => {
        beforeEach(async () => {
            await testBedConfiguration(1);
        });
