...
describe('TextAssessmentComponent', () => {
    ...
    it('should load unassessedSubmission if there is an unassessed submission and lock limit is not reached', () => {
    ...
    it('should not load unassessedSubmission and show an lock limit reached message if lock limit is reached', () => {
