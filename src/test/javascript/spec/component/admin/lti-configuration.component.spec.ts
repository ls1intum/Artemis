...
describe('LtiConfigurationComponent', () => {
    ...
    it('should generate URLs correctly', () => {
        ...
        expect(component.getDeepLinkingUrl()).toContain('/api/public/lti/lti13/deep-link');
        ...
        expect(component.getInitiateLoginUrl()).toContain('/api/public/lti/lti13/initiate-login');

        // Test for getRedirectUri
        expect(component.getRedirectUri()).toContain('/api/public/lti/lti13/auth-callback');
    });
