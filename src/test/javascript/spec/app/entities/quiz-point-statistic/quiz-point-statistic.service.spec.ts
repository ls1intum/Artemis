...
describe('Service Tests', () => {
    describe('QuizPointStatistic Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new QuizPointStatistic(0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a QuizPointStatistic', async () => {
                ...
                service
                    .create(new QuizPointStatistic(null))
                    .pipe(take(1))
            ...
            it('should update a QuizPointStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of QuizPointStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                service
                    .query(expected)
            ...
            it('should delete a QuizPointStatistic', async () => {
