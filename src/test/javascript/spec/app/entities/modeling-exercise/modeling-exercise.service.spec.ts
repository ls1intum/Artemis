    ...
    describe('ModelingExercise Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/modeling-exercises';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ModelingExercise', () => {
                service.create(new ModelingExercise(null)).subscribe(received => {
            ...
            it('should update a ModelingExercise', () => {
                service.update(new ModelingExercise(123)).subscribe(received => {
            ...
            it('should return a ModelingExercise', () => {
            ...
            it('should return a list of ModelingExercise', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ModelingExercise(123)]);
            });
