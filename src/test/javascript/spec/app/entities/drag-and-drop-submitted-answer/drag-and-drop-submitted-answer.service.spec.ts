...
describe('Service Tests', () => {
    describe('DragAndDropSubmittedAnswer Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a DragAndDropSubmittedAnswer', () => {
                service.create(new DragAndDropSubmittedAnswer(null)).subscribe(received => {
            ...
            it('should update a DragAndDropSubmittedAnswer', () => {
                service.update(new DragAndDropSubmittedAnswer(123)).subscribe(received => {
            ...
            it('should return a DragAndDropSubmittedAnswer', () => {
            ...
            it('should return a list of DragAndDropSubmittedAnswer', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DragAndDropSubmittedAnswer(123)]);
            });

            it('should delete a DragAndDropSubmittedAnswer', () => {
