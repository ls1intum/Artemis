    ...
    describe('ModelingSubmission Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ModelingSubmission', () => {
                service.create(new ModelingSubmission(null)).subscribe(received => {
            ...
            it('should update a ModelingSubmission', () => {
                service.update(new ModelingSubmission(123)).subscribe(received => {
            ...
            it('should return a ModelingSubmission', () => {
            ...
            it('should return a list of ModelingSubmission', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ModelingSubmission(123)]);
            });

            it('should delete a ModelingSubmission', () => {
