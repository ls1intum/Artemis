    ...
    describe('Exercise Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/exercises';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Exercise', () => {
                service.create(new Exercise(null)).subscribe(received => {
            ...
            it('should update a Exercise', () => {
                service.update(new Exercise(123)).subscribe(received => {
