    ...
    describe('Submission Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/submissions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Submission', () => {
                service.create(new Submission(null)).subscribe(received => {
            ...
            it('should update a Submission', () => {
                service.update(new Submission(123)).subscribe(received => {
