    ...
    describe('ProgrammingExercise Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ProgrammingExercise', () => {
                service.create(new ProgrammingExercise(null)).subscribe(received => {
            ...
            it('should update a ProgrammingExercise', () => {
                service.update(new ProgrammingExercise(123)).subscribe(received => {
            ...
            it('should return a ProgrammingExercise', () => {
            ...
            it('should return a list of ProgrammingExercise', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ProgrammingExercise(123)]);
            });
