...
describe('Service Tests', () => {
    describe('ShortAnswerSubmittedAnswer Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ShortAnswerSubmittedAnswer(0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ShortAnswerSubmittedAnswer', async () => {
                ...
                service
                    .create(new ShortAnswerSubmittedAnswer(null))
                    .pipe(take(1))
            ...
            it('should update a ShortAnswerSubmittedAnswer', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of ShortAnswerSubmittedAnswer', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                service
                    .query(expected)
            ...
            it('should delete a ShortAnswerSubmittedAnswer', async () => {
