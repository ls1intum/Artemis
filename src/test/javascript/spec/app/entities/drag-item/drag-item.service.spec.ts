...
describe('Service Tests', () => {
    describe('DragItem Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new DragItem(0, 'AAAAAAA', 'AAAAAAA', false);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a DragItem', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of DragItem', async () => {
                const returnedFromService = Object.assign(
                    {
                        pictureFilePath: 'BBBBBB',
                        text: 'BBBBBB',
            ...
            it('should delete a DragItem', async () => {
