...
describe('Service Tests', () => {
    describe('DragAndDropAssignment Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a DragAndDropAssignment', () => {
                service.create(new DragAndDropAssignment(null)).subscribe(received => {
            ...
            it('should update a DragAndDropAssignment', () => {
                service.update(new DragAndDropAssignment(123)).subscribe(received => {
            ...
            it('should return a DragAndDropAssignment', () => {
            ...
            it('should return a list of DragAndDropAssignment', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DragAndDropAssignment(123)]);
            });

            it('should delete a DragAndDropAssignment', () => {
