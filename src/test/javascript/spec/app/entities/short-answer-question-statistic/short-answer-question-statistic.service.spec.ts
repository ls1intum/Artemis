...
describe('Service Tests', () => {
    describe('ShortAnswerQuestionStatistic Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ShortAnswerQuestionStatistic(0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ShortAnswerQuestionStatistic', async () => {
                ...
                service
                    .create(new ShortAnswerQuestionStatistic(null))
                    .pipe(take(1))
            ...
            it('should update a ShortAnswerQuestionStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of ShortAnswerQuestionStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                service
                    .query(expected)
            ...
            it('should delete a ShortAnswerQuestionStatistic', async () => {
