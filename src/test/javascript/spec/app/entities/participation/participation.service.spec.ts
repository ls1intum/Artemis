    ...
    describe('Participation Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Participation', () => {
                service.create(new Participation(null)).subscribe(received => {
            ...
            it('should update a Participation', () => {
                service.update(new Participation(123)).subscribe(received => {
            ...
            it('should return a Participation', () => {
            ...
            it('should return a list of Participation', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Participation(123)]);
            });
