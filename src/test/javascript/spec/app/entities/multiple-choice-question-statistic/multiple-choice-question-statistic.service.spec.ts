...
describe('Service Tests', () => {
    describe('MultipleChoiceQuestionStatistic Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new MultipleChoiceQuestionStatistic(0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a MultipleChoiceQuestionStatistic', async () => {
                ...
                service
                    .create(new MultipleChoiceQuestionStatistic(null))
                    .pipe(take(1))
            ...
            it('should update a MultipleChoiceQuestionStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of MultipleChoiceQuestionStatistic', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                service
                    .query(expected)
            ...
            it('should delete a MultipleChoiceQuestionStatistic', async () => {
