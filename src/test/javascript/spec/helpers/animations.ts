 ...
 *
 * Some third-party libraries (@swimlane/ngx-charts) internally use @angular/animations.
 ...
 *
 * TODO: Remove this file once ngx-charts no longer requires @angular/animations
 */
