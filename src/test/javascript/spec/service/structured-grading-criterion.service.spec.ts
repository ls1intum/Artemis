...
describe('Structured Grading Criteria Service', () => {
    ...
    beforeEach(() => {
        ...
        let limitedSGI = new GradingInstruction();
        limitedSGI.id = 1;
        limitedSGI.credits = 1.0;
        limitedSGI.usageCount = 1;
        let unlimitedSGI = new GradingInstruction();
        limitedSGI.id = 2;
        unlimitedSGI.credits = 1.0;
        unlimitedSGI.usageCount = 0;
        let bigLimitSGI = new GradingInstruction();
        limitedSGI.id = 3;
    ...
    describe('Service methods', () => {
        it('should calculate the total score', async () => {
            ...
            let totalScore = service.computeTotalScore(returnedFromService);
