...
describe('AthenaService', () => {
    ...
    const textExercise = {
        id: 1,
        type: 'text',
        gradedFeedbackSuggestionModule: 'text_module',
        gradingCriteria,
    } as Exercise;
    const programmingExercise = {
        id: 2,
        type: 'programming',
        gradedFeedbackSuggestionModule: 'programming_module',
        gradingCriteria,
    } as Exercise;
    const modelingExercise = {
        id: 2,
        type: 'modeling',
        gradedFeedbackSuggestionModule: 'modeling_module',
        gradingCriteria,
    } as Exercise;
    beforeEach(() => {
    ...
    it('should return no feedback suggestions when feedback suggestions are disabled on the exercise', fakeAsync(() => {
        ...
        const exerciseWithoutFeedbackSuggestions = { ...textExercise, gradedFeedbackSuggestionModule: undefined } as Exercise;
