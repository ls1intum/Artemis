...
describe('TextEditorService', () => {
    ...
    it('Can detect that a French sentence isn\'t German or English', () => {
        const testString = 'C\'est une phrase français';
        expect(textEditorService.predictLanguage(testString)).toBe(null);
    ...
    it('Can detect a long German text ', () => {
        ...
        const testString = 'Bernd Brügge ist ein deutscher Informatiker und Ordinarius für Angewandte Softwaretechnik' +
    ...
    it('Can detect a long English text ', () => {
        ...
        const testString = 'Bernd Bruegge (German: Bernd Brügge) (born 1951) is a German computer scientist,' +
