...
export ARTEMIS_HYPERION_AGENT_MAXTOKENSPERJOB="${HYPERION_LIVE_MAX_TOKENS_PER_JOB:-6000000}"
# The 24h admission budget is a production cost control; a local validation session runs several full generations back to back and would otherwise 429.
export ARTEMIS_HYPERION_AGENT_ADMISSIONMAXTOKENSPERUSER="${HYPERION_LIVE_MAX_TOKENS_PER_USER:-120000000}"
export ARTEMIS_HYPERION_AGENT_ADMISSIONMAXTOKENSPERCOURSE="${HYPERION_LIVE_MAX_TOKENS_PER_COURSE:-1200000000}"
