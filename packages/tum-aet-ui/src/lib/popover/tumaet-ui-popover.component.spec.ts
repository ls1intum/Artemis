...
describe('TumAetUiPopoverComponent', () => {
    let component: TumAetUiPopoverComponent;
    let fixture: ComponentFixture<TumAetUiPopoverComponent>;
    let origin: HTMLButtonElement;

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiPopoverComponent] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiPopoverComponent);
    ...
    describe('leaving', () => {
        const panel = () => document.querySelector('.tumaet-ui-popover-panel');
