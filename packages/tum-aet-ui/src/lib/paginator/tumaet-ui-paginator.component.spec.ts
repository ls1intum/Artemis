...
describe('TumAetUiPaginatorComponent', () => {
    let component: TumAetUiPaginatorComponent;
    let fixture: ComponentFixture<TumAetUiPaginatorComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiPaginatorComponent, FontAwesomeTestingModule],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiPaginatorComponent);
