...
export class TumAetUiTooltipDirective implements OnDestroy {
    ...
    readonly content = input.required<string | readonly string[]>({ alias: 'tumAetUiTooltip' });
    readonly placement = input<TumAetUiOverlayPlacement>('top', { alias: 'tumAetUiTooltipPlacement' });
    /**
     ...
     */
    readonly describesHost = input(true, { alias: 'tumAetUiTooltipDescribesHost', transform: booleanAttribute });
    ...
    private contentRef?: ComponentRef<TumAetUiTooltipContentComponent>;
    private positionSub?: Subscription;
    private showTimer?: ReturnType<typeof setTimeout>;
    private hideTimer?: ReturnType<typeof setTimeout>;
    private readonly tooltipId = `tumaet-ui-tooltip-${nextTooltipId++}`;
    private interactionSub?: Subscription;

    private appliedPlacement: TumAetUiOverlayPlacement = 'top';
