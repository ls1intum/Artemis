...
describe('TumAetUiSkeletonComponent', () => {
    let fixture: ComponentFixture<TumAetUiSkeletonComponent>;
    let host: HTMLElement;

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiSkeletonComponent] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiSkeletonComponent);
        host = fixture.nativeElement as HTMLElement;
        fixture.detectChanges();
    });

    function lines(): HTMLElement[] {
        return [...host.querySelectorAll<HTMLElement>('.tumaet-ui-skeleton-line')];
    }
    ...
    it('has no shimmer to switch off', () => {
        ...
        const stylesheet = [...document.querySelectorAll('style')].map((style) => style.textContent ?? '').find((text) => text.includes('.tumaet-ui-skeleton-line')) ?? '';
