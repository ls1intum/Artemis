...
const variants: TumAetUiEmptyStateVariant[] = ['outlined', 'solid', 'plain'];

interface EmptyStateStoryArgs {
    title: string;
    description: string;
    variant: TumAetUiEmptyStateVariant;
    actions?: never;
    documentation?: never;
}
...
const meta = {
    ...
    component: TumAetUiEmptyStateComponent,
    args: {
    ...
    argTypes: {
        ...
        actions: {
            description: 'Optional content projected into the action area using the `[tumAetUiEmptyStateActions]` attribute.',
            control: false,
            table: {
        ...
        documentation: {
            description: 'Optional link projected below the actions using the `[tumAetUiEmptyStateDocumentation]` attribute.',
            control: false,
            table: {
                category: 'Content projection',
    ...
    render: (args) => ({
        ...
        template: `<tumaet-ui-empty-state [icon]="icon" [title]="title" [description]="description" [variant]="variant" />`,
    }),
...
const renderWithProjectedContent = (args: EmptyStateStoryArgs, content: string) => ({
    ...
    template: `
        <tumaet-ui-empty-state [icon]="icon" [title]="title" [description]="description" [variant]="variant">
            ${content}
...
const actionsContent = `
    <tumaet-ui-button tumAetUiEmptyStateActions [icon]="addIcon">Add exercise</tumaet-ui-button>
    <tumaet-ui-button tumAetUiEmptyStateActions [icon]="importIcon" variant="outlined">Import from course</tumaet-ui-button>
`;

const documentationContent = `
    <a tumAetUiEmptyStateDocumentation href="https://docs.artemis.tum.de/instructor/exercises/intro" target="_blank" rel="noopener noreferrer">
