...
export type TumAetUiSortDirection = 'asc' | 'desc';

export interface TumAetUiSortState {
    field: string;
    direction: TumAetUiSortDirection;
}

export interface TumAetUiTableQueryEvent {
    pageIndex: number;
    pageSize: number;
    sort?: TumAetUiSortState;
    searchTerm?: string;
}
