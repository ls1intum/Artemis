...
import { TumAetUiAutoCompleteComponent } from './tumaet-ui-autocomplete.component';

describe('TumAetUiAutoCompleteComponent (multiple mode)', () => {
    let component: TumAetUiAutoCompleteComponent;
    let fixture: ComponentFixture<TumAetUiAutoCompleteComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiAutoCompleteComponent, FontAwesomeTestingModule] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiAutoCompleteComponent);
    ...
    function chips(): HTMLElement[] {
        return Array.from(fixture.nativeElement.querySelectorAll('tumaet-ui-chip'));
    }
...
describe('TumAetUiAutoCompleteComponent with reactive formControl', () => {
    @Component({
        imports: [TumAetUiAutoCompleteComponent, ReactiveFormsModule],
        template: `<tumaet-ui-autocomplete [formControl]="control" [multiple]="true" [suggestions]="suggestions" />`,
    })
    ...
    it('reflects the FormControl value as chips and honors control.disable()', async () => {
        ...
        const chips = () => Array.from(fixture.nativeElement.querySelectorAll('tumaet-ui-chip')) as HTMLElement[];
...
describe('TumAetUiAutoCompleteComponent single mode with standalone ngModel', () => {
    @Component({
        imports: [TumAetUiAutoCompleteComponent, FormsModule],
        template: `<tumaet-ui-autocomplete [(ngModel)]="value" [suggestions]="suggestions" />`,
    })
...
describe('TumAetUiAutoCompleteComponent single-mode value + completeOnFocus', () => {
    let fixture: ComponentFixture<TumAetUiAutoCompleteComponent>;
    let component: TumAetUiAutoCompleteComponent;
