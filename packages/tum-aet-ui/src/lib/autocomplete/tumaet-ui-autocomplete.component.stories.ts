...
const meta = {
    ...
    component: TumAetUiAutoCompleteComponent,
    args: {
        ariaLabel: 'Assignee',
        searchRequested: fn(),
...
} satisfies Meta<TumAetUiAutoCompleteComponent>;

export default meta;

type Story = StoryObj<TumAetUiAutoCompleteComponent>;
