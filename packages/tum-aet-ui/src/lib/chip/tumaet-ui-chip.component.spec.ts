...
describe('TumAetUiChipComponent', () => {
    let component: TumAetUiChipComponent;
    let fixture: ComponentFixture<TumAetUiChipComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiChipComponent, FontAwesomeTestingModule] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiChipComponent);
    ...
    function label(): HTMLElement {
        return fixture.debugElement.query(By.css('.tumaet-ui-chip-label')).nativeElement;
    }
...
@Component({
    template: `<tumaet-ui-chip><span class="projected">Custom</span></tumaet-ui-chip>`,
    imports: [TumAetUiChipComponent],
})
class ChipHostComponent {}

describe('TumAetUiChipComponent (content projection)', () => {
