...
import { TumAetUiSearchFieldComponent } from './tumaet-ui-search-field.component';

describe('TumAetUiSearchFieldComponent', () => {
    let fixture: ComponentFixture<TumAetUiSearchFieldComponent>;
    let component: TumAetUiSearchFieldComponent;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiSearchFieldComponent, FontAwesomeTestingModule],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiSearchFieldComponent);
    ...
    it('names the field by its placeholder unless given an explicit label', () => {
        ...
        // A real key rather than free text, so the assertion fails if the name stops going through tumAetUiTranslate.
        fixture.componentRef.setInput('ariaLabel', 'tumAetUi.select.filter');
        fixture.detectChanges();
