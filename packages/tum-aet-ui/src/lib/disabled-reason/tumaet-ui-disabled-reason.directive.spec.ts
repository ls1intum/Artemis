...
@Component({
    template: `<button [tumAetUiDisabledReason]="reason()" (click)="clicks = clicks + 1">Save</button>`,
    imports: [TumAetUiDisabledReasonDirective],
})
...
describe('TumAetUiDisabledReasonDirective', () => {
    ...
    it('shows the reason as a tooltip on focus', () => {
        ...
        expect(document.querySelector('.tumaet-ui-tooltip-bubble')?.textContent).toContain('Save the exercise first');
