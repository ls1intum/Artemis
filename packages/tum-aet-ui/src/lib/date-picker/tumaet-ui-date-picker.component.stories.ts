...
import { TumAetUiDatePickerComponent } from './tumaet-ui-date-picker.component';

const meta = {
    title: 'Forms/Date Picker',
    component: TumAetUiDatePickerComponent,
    args: {
        ariaLabel: 'Deadline',
        labelName: 'Deadline',
...
} satisfies Meta<TumAetUiDatePickerComponent>;

export default meta;

type Story = StoryObj<TumAetUiDatePickerComponent>;
