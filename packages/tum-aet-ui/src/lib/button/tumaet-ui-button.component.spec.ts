...
describe('TumAetUiButtonComponent', () => {
    let component: TumAetUiButtonComponent;
    let fixture: ComponentFixture<TumAetUiButtonComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiButtonComponent, FontAwesomeTestingModule],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiButtonComponent);
