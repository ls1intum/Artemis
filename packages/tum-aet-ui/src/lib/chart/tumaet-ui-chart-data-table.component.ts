...
export interface TumAetUiChartDataTableRow {
    label: string;
 ...
 */
@Component({
    selector: 'tumaet-ui-chart-data-table',
    changeDetection: ChangeDetectionStrategy.OnPush,
    host: { class: 'tumaet-ui-chart-data-table' },
    styles: `
        :host {
            position: absolute;
            width: 1px;
...
export class TumAetUiChartDataTableComponent {
    readonly caption = input<string>();
    readonly rows = input<readonly TumAetUiChartDataTableRow[]>([]);
}
