...
import { TumAetUiChartDatumContext, TumAetUiChartSelectEvent, TumAetUiChartSeries, TumAetUiLineChartConfig } from './tumaet-ui-chart.types';
...
interface LineView {
    ...
    color: string;
    dashed: boolean;
    points: { key: string; x: number; y: number; context: TumAetUiChartDatumContext }[];
}
 ...
 */
@Component({
    selector: 'tumaet-ui-line-chart',
    templateUrl: './tumaet-ui-line-chart.component.html',
    styleUrl: './tumaet-ui-line-chart.component.scss',
    ...
    host: { class: 'tumaet-ui-line-chart' },
})
export class TumAetUiLineChartComponent implements OnDestroy {
    ...
    readonly config = input<TumAetUiLineChartConfig>({});
    ...
    protected readonly clipId = `tumaet-ui-line-chart-clip-${nextLineChartId++}`;
    ...
    protected readonly tooltip = computed(() => {
        ...
        const contexts: TumAetUiChartDatumContext[] = [];
    ...
    protected onPointSelect(context: TumAetUiChartDatumContext): void {
    ...
    protected onPlotClick(event: MouseEvent): void {
        ...
        let nearest: TumAetUiChartDatumContext | undefined;
        let shortest = Number.POSITIVE_INFINITY;
