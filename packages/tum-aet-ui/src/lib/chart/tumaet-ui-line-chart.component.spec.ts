...
import { TumAetUiLineChartComponent } from './tumaet-ui-line-chart.component';
import { TumAetUiChartSelectEvent, TumAetUiChartSeries, TumAetUiLineChartConfig } from './tumaet-ui-chart.types';

describe('TumAetUiLineChartComponent', () => {
    let fixture: ComponentFixture<TumAetUiLineChartComponent>;

    const labels = ['Week 1', 'Week 2', 'Week 3', 'Week 4'];

    async function render(series: TumAetUiChartSeries[], config: TumAetUiLineChartConfig = {}): Promise<void> {
    ...
    function paths(): SVGPathElement[] {
        return fixture.debugElement.queryAll(By.css('path.tumaet-ui-line-chart-line')).map((element) => element.nativeElement);
    }
    ...
    function hitArea(): SVGRectElement {
        return fixture.debugElement.query(By.css('rect.tumaet-ui-line-chart-hit-area')).nativeElement;
    }

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiLineChartComponent] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiLineChartComponent);
    ...
    it('should lead an interactive point with its series so that two series stay distinguishable', async () => {
        ...
        const names = fixture.debugElement
            .queryAll(By.css('circle.tumaet-ui-line-chart-point'))
    ...
    it('should render selectable axis labels as real text nodes', async () => {
        ...
        const rendered = texts('text.tumaet-ui-chart-tick');
    ...
    it('should render a point per defined value', async () => {
        await render([{ data: [40, undefined, 60, 72] }]);
        expect(fixture.debugElement.queryAll(By.css('circle.tumaet-ui-line-chart-point'))).toHaveLength(3);
    });
    ...
    it('should draw a reference line dashed and keep it out of the legend', async () => {
        ...
        const dashed = fixture.debugElement.queryAll(By.css('path.tumaet-ui-line-chart-line-dashed'));
    ...
    it('should emit the point that was clicked', async () => {
        ...
        const first = fixture.debugElement.query(By.css('circle.tumaet-ui-line-chart-point')).nativeElement as SVGCircleElement;
    ...
    it('should honour an explicit value axis range', async () => {
        ...
        const ticks = texts('text.tumaet-ui-chart-tick');
    ...
    it('should truncate category labels with the axis formatter', async () => {
        ...
        expect(texts('text.tumaet-ui-chart-tick')).toContain('Week');
    });
