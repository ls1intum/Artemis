...
import { TumAetUiSelectComponent } from './tumaet-ui-select.component';
...
describe('TumAetUiSelectComponent', () => {
    let component: TumAetUiSelectComponent;
    let fixture: ComponentFixture<TumAetUiSelectComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({ imports: [TumAetUiSelectComponent, FontAwesomeTestingModule] }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiSelectComponent);
    ...
    describe('filter', () => {
        function filterField(): HTMLInputElement | null {
            return document.querySelector('.tumaet-ui-select-filter');
        }
...
describe('TumAetUiSelectComponent with [(ngModel)]', () => {
    @Component({
        imports: [TumAetUiSelectComponent, FormsModule],
        template: `<tumaet-ui-select [(ngModel)]="value" [options]="options" optionLabel="label" optionValue="value" />`,
    })
...
describe('TumAetUiSelectComponent with reactive formControl', () => {
    @Component({
        imports: [TumAetUiSelectComponent, ReactiveFormsModule],
        template: `<tumaet-ui-select [formControl]="control" [options]="options" optionLabel="label" optionValue="value" />`,
    })
