...
import { TumAetUiCheckboxChangeEvent, TumAetUiCheckboxComponent } from './tumaet-ui-checkbox.component';

describe('TumAetUiCheckboxComponent', () => {
    let fixture: ComponentFixture<TumAetUiCheckboxComponent>;
    let component: TumAetUiCheckboxComponent;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiCheckboxComponent, FontAwesomeTestingModule],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiCheckboxComponent);
    ...
    function tick(): HTMLElement | undefined {
        const icon = fixture.debugElement.query(By.css('.tumaet-ui-checkbox-icon'));
...
@Component({
    template: `<tumaet-ui-checkbox [(ngModel)]="value" (changed)="lastEvent = $event" />`,
    imports: [TumAetUiCheckboxComponent, FormsModule],
})
class TwoWayNgModelHostComponent {
    value = false;
    lastEvent?: TumAetUiCheckboxChangeEvent;
}

describe('TumAetUiCheckboxComponent (two-way ngModel via CVA)', () => {
...
@Component({
    template: `<tumaet-ui-checkbox [ngModel]="selected()" [ngModelOptions]="{ standalone: true }" (changed)="toggle()" />`,
    imports: [TumAetUiCheckboxComponent, FormsModule],
})
...
describe('TumAetUiCheckboxComponent controlled pattern', () => {
...
describe('TumAetUiCheckboxComponent (reactive formControl via CVA)', () => {
