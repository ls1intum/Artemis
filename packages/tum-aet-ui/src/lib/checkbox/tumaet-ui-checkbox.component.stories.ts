...
interface CheckboxStoryArgs {
    ...
    checked: boolean;
    disabled: boolean;
    changed: (event: TumAetUiCheckboxChangeEvent) => void;
}

const meta = {
    title: 'Forms/Checkbox',
    component: TumAetUiCheckboxComponent,
    args: {
...
export const StaysSquareBesideAWrappingLabel: Story = {
        ...
        template: `
            <div style="width: 420px;">
                <div style="display: flex; align-items: center; gap: 8px;">
                    <tumaet-ui-checkbox inputId="wrap-centered" name="wrap-centered" data-testid="wrap-centered" />
                ...
                <div style="display: flex; gap: 8px;">
                    <tumaet-ui-checkbox inputId="wrap-stretched" name="wrap-stretched" data-testid="wrap-stretched" />
                ...
                <div style="--tumaet-ui-spacing: initial; display: flex; gap: 8px;">
                    <tumaet-ui-checkbox inputId="wrap-untokened" name="wrap-untokened" data-testid="wrap-untokened" />
    ...
    play: async ({ canvas }) => {
        for (const id of ['wrap-centered', 'wrap-stretched', 'wrap-untokened']) {
            const box = canvas.getByTestId(id).querySelector('.tumaet-ui-checkbox-box')!.getBoundingClientRect();
    ...
    render: (args) => ({
        ...
        template: `
            <div style="display: flex; align-items: center; gap: 8px; width: 120px;">
                <tumaet-ui-checkbox inputId="tight" name="tight" data-testid="tight-checkbox" />
