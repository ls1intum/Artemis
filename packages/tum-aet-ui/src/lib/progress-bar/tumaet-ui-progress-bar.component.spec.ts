...
describe('TumAetUiProgressBarComponent', () => {
    let fixture: ComponentFixture<TumAetUiProgressBarComponent>;
    let host: HTMLElement;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiProgressBarComponent],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiProgressBarComponent);
    ...
    function fill(): HTMLElement {
        return fixture.debugElement.query(By.css('.tumaet-ui-progress-bar-value')).nativeElement;
    }

    function label(): HTMLElement {
        return fixture.debugElement.query(By.css('.tumaet-ui-progress-bar-label')).nativeElement;
    }
...
@Component({
    template: `<tumaet-ui-progress-bar [value]="30" [showValue]="false"
        ><span class="projected">{{ 30 }}%</span></tumaet-ui-progress-bar
    >`,
    imports: [TumAetUiProgressBarComponent],
})
class ProgressBarHostComponent {}

describe('TumAetUiProgressBarComponent (content projection)', () => {
