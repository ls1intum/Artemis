...
describe('TumAetUiInputNumberComponent', () => {
    let fixture: ComponentFixture<TumAetUiInputNumberComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiInputNumberComponent, FontAwesomeTestingModule],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiInputNumberComponent);
    ...
    it('does not render the stepper by default and renders two buttons when showButtons is set', () => {
        expect(fixture.debugElement.queryAll(By.css('.tumaet-ui-input-number-button'))).toHaveLength(0);
        fixture.componentRef.setInput('showButtons', true);
        fixture.detectChanges();
        expect(fixture.debugElement.queryAll(By.css('.tumaet-ui-input-number-button'))).toHaveLength(2);
    });
});

@Component({
    template: `<tumaet-ui-input-number
        [(ngModel)]="value"
        [min]="min()"
        [max]="max"
        [showButtons]="true"
        ...
        [locale]="locale()"
    />`,
    imports: [TumAetUiInputNumberComponent, FormsModule, FontAwesomeTestingModule],
})
class HostComponent {
    value?: number;
...
describe('TumAetUiInputNumberComponent (ngModel + formatting)', () => {
    ...
    function buttons(): HTMLButtonElement[] {
        return fixture.debugElement.queryAll(By.css('.tumaet-ui-input-number-button')).map((d) => d.nativeElement);
    }
...
describe('TumAetUiInputNumberComponent (external CVA writes)', () => {
...
describe('TumAetUiInputNumberComponent (maxFractionDigits)', () => {
