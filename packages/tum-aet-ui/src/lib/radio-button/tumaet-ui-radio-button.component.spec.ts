...
describe('TumAetUiRadioButtonComponent', () => {
    let fixture: ComponentFixture<TumAetUiRadioButtonComponent>;
    let component: TumAetUiRadioButtonComponent;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiRadioButtonComponent],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiRadioButtonComponent);
    ...
    it('emits selected with the radio value on every click', () => {
        const events: TumAetUiRadioButtonSelectEvent[] = [];
...
@Component({
    ...
    `,
    imports: [TumAetUiRadioButtonComponent, FormsModule],
})
...
describe('TumAetUiRadioButtonComponent controlled group', () => {
...
@Component({
    template: `
        <tumaet-ui-radio-button [value]="false" name="exec" [(ngModel)]="executeNow" />
        <tumaet-ui-radio-button [value]="true" name="exec" [(ngModel)]="executeNow" />
    `,
    imports: [TumAetUiRadioButtonComponent, FormsModule],
})
...
describe('TumAetUiRadioButtonComponent (two-way [(ngModel)] group via CVA)', () => {
...
@Component({
    template: `<tumaet-ui-radio-button [value]="'x'" [formControl]="control" />`,
    imports: [TumAetUiRadioButtonComponent, ReactiveFormsModule],
})
class ReactiveHostComponent {
    readonly control = new FormControl<string | undefined>(undefined);
}

describe('TumAetUiRadioButtonComponent (reactive formControl via CVA)', () => {
