...
import { TumAetUiSelectButtonComponent, TumAetUiSelectButtonSize } from './tumaet-ui-select-button.component';
...
interface SelectButtonStoryArgs {
    ...
    size: TumAetUiSelectButtonSize | undefined;
    allowEmpty: boolean;
    disabled: boolean;
...
const meta = {
    ...
    component: TumAetUiSelectButtonComponent,
    args: {
    ...
    render: (args) => {
        return {
            props: { ...args },
            template: `
                <span id="interval-label" class="tumaet-ui-story-label">{{ label }}</span>
...
export const CustomItemTemplate: Story = {
    render: (args) => {
        return {
            props: { ...args },
            template: `
                <span id="compact-interval-label" class="tumaet-ui-story-label">{{ label }}</span>
                <tumaet-ui-select-button
