...
import { TumAetUiSelectButtonComponent } from './tumaet-ui-select-button.component';
...
describe('TumAetUiSelectButtonComponent', () => {
    let fixture: ComponentFixture<TumAetUiSelectButtonComponent>;
    let component: TumAetUiSelectButtonComponent;
    let host: HTMLElement;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TumAetUiSelectButtonComponent],
        }).compileComponents();
        fixture = TestBed.createComponent(TumAetUiSelectButtonComponent);
...
@Component({
    template: `
        <tumaet-ui-select-button [options]="opts" optionValue="value" [itemTemplate]="itemTpl" />
...
describe('TumAetUiSelectButtonComponent (custom item template)', () => {
...
@Component({
    template: `<tumaet-ui-select-button [options]="opts" optionLabel="label" optionValue="value" [formControl]="control" />`,
    imports: [TumAetUiSelectButtonComponent, ReactiveFormsModule],
})
...
describe('TumAetUiSelectButtonComponent (reactive forms)', () => {
