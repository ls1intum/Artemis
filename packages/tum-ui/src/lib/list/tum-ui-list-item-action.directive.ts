...
const BASE =
    'tum-ui-list-item-action tum:flex tum:w-full tum:items-center tum:gap-2 tum:border-0 tum:bg-transparent tum:px-4 tum:py-3 tum:text-start tum:text-base tum:no-underline ' +
    'tum:focus-visible:outline tum:focus-visible:outline-2 tum:focus-visible:outline-focus tum:focus-visible:-outline-offset-2';

const INACTIVE = 'tum:cursor-pointer tum:text-text tum:hover:bg-hover-background tum:hover:text-text-hover';
