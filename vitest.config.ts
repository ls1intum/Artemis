...
export default defineConfig({
    ...
    test: {
        ...
        include: [
            ...
            'src/main/webapp/app/shared-ui/components/resizable-panels/**/*.spec.ts', // include shared resizable panels
        ...
        coverage: {
            ...
            include: [
                ...
                'src/main/webapp/app/shared-ui/components/resizable-panels/**/*.ts', // include shared resizable panels for code coverage
