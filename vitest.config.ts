...
export default defineConfig({
    ...
    test: {
        ...
        include: ['src/main/webapp/app/fileupload/**/*.spec.ts', 'src/main/webapp/app/core/admin/**/*.spec.ts'],
        ...
        coverage: {
            ...
            include: ['src/main/webapp/app/fileupload/**/*.ts', 'src/main/webapp/app/core/admin/**/*.ts'],
