...
export default defineConfig({
    ...
    test: {
        ...
        include: ['src/main/webapp/app/fileupload/**/*.spec.ts', 'src/main/webapp/app/core/account/**/*.spec.ts', 'src/main/webapp/app/buildagent/**/*.spec.ts'],
        ...
        coverage: {
            ...
            include: ['src/main/webapp/app/fileupload/**/*.ts', 'src/main/webapp/app/core/account/**/*.ts', 'src/main/webapp/app/buildagent/**/*.ts'],
