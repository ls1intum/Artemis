...
class ExceptionTranslatorTest {
    ...
    void testAccessDenied() throws Exception {
        ResultActions perform = request.getMvc().perform(get("/api/exception-translator-test/access-denied")).andExpect(status().isForbidden()).andExpect(content().contentType(MediaType.APPLICATION_PROBLEM_JSON))
