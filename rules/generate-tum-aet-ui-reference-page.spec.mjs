...
import { renderReferencePage, renderReferenceResolver } from '../supporting_scripts/generate-tum-aet-ui-reference-page.mjs';

describe('TUM AET UI reference page generation', () => {
