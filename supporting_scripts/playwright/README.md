...
This will set up the database, start Artemis inside a docker container, and start the client via bun.
...
In case you stop the client, you can simply re-run it at the root of the Artemis project with `bun start`.
