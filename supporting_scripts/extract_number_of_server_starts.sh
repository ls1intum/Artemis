...
then
  echo "The number of Server Starts should be lower than/equals 7! Please adapt this check if the change is intended or try to fix the underlying issue causing a different number of server starts!"
  exit 1
fi
