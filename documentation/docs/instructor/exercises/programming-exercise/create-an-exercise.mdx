...
Click **Create** in the page header. The **Manage Exercises** dialog opens on its **Create** tab, showing one card per exercise type. Choose **Programming** and confirm with **Create**. Artemis then opens the creation form.
...
2. Click **Import** in the page header and choose **Programming** in the **Manage Exercises** dialog, then select the exercise to import.
