...
Edit it either with **Edit** on the exercise, or with **Edit in Editor** to have it side by side with the code. Both editors synchronize in real time when several people work at once — see [Collaborative Editing](#collaborative-editing).
