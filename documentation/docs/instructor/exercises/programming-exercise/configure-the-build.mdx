...
Unless noted otherwise, these settings require [Integrated Code Lifecycle](/instructor/integrations/integrated-code-lifecycle) and apply to every build of the exercise: template, solution and student submissions alike.
