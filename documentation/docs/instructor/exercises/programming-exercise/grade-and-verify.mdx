...
<Callout variant={CalloutVariant.warning}>
  ...
  If locking fails and the participant submits again, Artemis attempts to lock again and sets the new result to <img src={notGradedLabel} alt="Not Graded" style={{display: 'inline', verticalAlign: 'middle', height: '1.5rem'}} />.
...
<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/56245" title="Video tutorial for feedback analysis" />
