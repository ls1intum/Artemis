---
id: textual-exercise
title: Textual Exercise
sidebar_label: Textual Exercise
---
...
<Image src={createTextExerciseForm1} alt="Create Text Exercise Form 1" size={ImageSize.large} />
...
<Image src={createTextExerciseForm2} alt="Create Text Exercise Form 2" size={ImageSize.large} />
...
<Image src={createExerciseFormHint} alt="Create Exercise Form Hint" size={ImageSize.medium} />

The following screenshot illustrates the last section of the form:

- **Linked Competencies**: In case instructors created competencies, they can link them to the exercise here. See the Adaptive Learning documentation for more information.
...
<Image src={createTextExerciseForm3} alt="Create Text Exercise Form 3" size={ImageSize.large} />
...
<Image src={importTextExerciseModal} alt="Import Text Exercise Modal" size={ImageSize.medium} />
...
<Image src={courseDashboardExerciseText} alt="Course Dashboard Exercise Text" size={ImageSize.large} />
...
<Image src={textExerciseCardStudentView} alt="Text Exercise Card Student View" size={ImageSize.large} />
...
<Image src={textExerciseStudentsInterface} alt="Text Exercise Students Interface" size={ImageSize.large} />
...
<Image src={assessmentDashboard} alt="Assessment Dashboard" size={ImageSize.large} />

- Then click on **Exercise Dashboard** of the text exercise.

<Image src={exerciseDashboard} alt="Exercise Dashboard" size={ImageSize.large} />

- You will then be redirected to *Exercise Assessment Dashboard*.

<Image src={exerciseAssessmentDashboard} alt="Exercise Assessment Dashboard" size={ImageSize.large} />
...
<Image src={assessmentModal} alt="Assessment Modal" size={ImageSize.large} />
...
<Image src={feedbackModal} alt="Feedback Modal" size={ImageSize.large} />

- If automatic assessment suggestions were enabled for the exercise, you would get available suggestions from the service [Athena](https://github.com/ls1intum/edutelligence/tree/main/athena). More details about this service can be found in the research papers listed in the Athena documentation.
