...
Exercises of the same topic can be bundled into a **variant group**, which gives them a shared timeline, lets them share a points cap, and shows them to students as one entry. Artemis can also generate a variant of an existing exercise with AI. See [Exercise Variants](/instructor/exercises/exercise-variants) and [Generate Variants with AI](/instructor/exercises/variant-generation).

## Exercise Organization and Navigation

Users can reach the exercise overview by clicking on the tab labeled *Exercises*.

<Image src={generalMenuExercise} alt="Exercise Menu" size={ImageSize.small} caption={"Exercise Tab in Sidebar"}></Image>
...
<Image src={sidebarCollapseExercise} alt="Sidebar Collapse Exercise" size={ImageSize.small} caption={"Exercise Sidebar with collapsed categories"}></Image>
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap'}}>
    <Image src={exerciseOverviewCurrent} alt="Current Exercises Overview" size={ImageSize.small} caption={"Exercise Overview uncollapsed (1)"}></Image>
    <Image src={exerciseOverviewPast} alt="Past Exercises Overview" size={ImageSize.small} caption={"Exercise Overview uncollapsed (2)"}></Image>
</div>
