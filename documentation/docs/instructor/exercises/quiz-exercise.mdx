...
import createExerciseModal from './assets/general/create-exercise-modal.png';
...
- **Apollon Drag-and-Drop Questions**: Questions where students drag items onto a UML diagram created with the [Apollon editor](https://github.com/ls1intum/Apollon) inside Artemis
...
Click **Create** in the page header and choose **Quiz** in the *Manage Exercises* dialog to open the quiz creation form.

<Image src={createExerciseModal} alt="Manage Exercises dialog" size={ImageSize.large} caption="Create an exercise from the Manage Exercises dialog" />
...
<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/26851" title="Creating Quiz Exercises" height={400} />
