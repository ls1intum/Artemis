...
<Callout variant={CalloutVariant.info}>
  <p>The Visual view provides an intuitive interface for creating quiz questions. You can switch between Visual and Edit views while maintaining all your changes.</p>
</Callout>
