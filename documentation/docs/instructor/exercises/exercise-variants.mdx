...
2. **While generating a variant with AI:** the wizard can create a new group holding the source exercise and the generated variant. See [Generate Variants with AI](/instructor/exercises/variant-generation).
