...
<Callout variant={CalloutVariant.info}>
  ...
  Exercise variant groups are a course-level concept. Exams use their own **exercise groups**, where Artemis assigns each student exactly one exercise from the group. Both are described on this page, in [Variant Groups in Exams](#variant-groups-in-exams).
