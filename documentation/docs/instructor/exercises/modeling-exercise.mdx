...
<Callout variant={CalloutVariant.info}>
  ...
  Grading feedback suggestions are enabled per course by an administrator. See <a href="/instructor/course-management/course-configuration#ai-assisted-feedback">AI Assisted Feedback</a> in the Course Configuration documentation. To learn how to set up the Athena service, refer to <a href="/admin/artemis-intelligence">Artemis Intelligence</a>.
