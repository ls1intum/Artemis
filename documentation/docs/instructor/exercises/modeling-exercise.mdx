...
<Image src={createModelingExerciseFormHint} alt="Create Modeling Exercise Form Hint" size={ImageSize.medium} caption="Hint Icon Example" />
...
<Image src={useInAssessmentTraining} alt="Use in Assessment Training" size={ImageSize.medium} caption="Use in Assessment Training Option" />
...
<Image src={automaticFeedbackViewDetailed} alt="Automatic Feedback View Detailed" size={ImageSize.medium} caption="Detailed AI Feedback" />
...
<Image src={automaticFeedbackHistory} alt="Automatic Feedback History" size={ImageSize.medium} caption="Submission History Section in Modeling Editor" />