...
Where the course has **Grading feedback suggestions** switched on in the Athena settings page, Artemis generates assessment suggestions for modeling submissions using the Athena service.
