...
import importExerciseModal from './assets/general/import-exercise-modal.png';
...
Click **Create** in the page header and choose **Modeling** in the *Manage Exercises* dialog.
...
Alternatively, you can start from an existing exercise: click **Import** in the page header and choose **Modeling** in the *Manage Exercises* dialog.

<Image src={importExerciseModal} alt="Import tab of the Manage Exercises dialog" size={ImageSize.large} caption="Import an exercise from the Manage Exercises dialog" />
