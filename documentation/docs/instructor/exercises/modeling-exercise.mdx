...
Two switches turn on assessment help. **Enable automatic assessment suggestions** reuses assessments from
submissions already graded in this exercise, and **Enable feedback suggestions from Athena** generates them with the
Athena service instead.
