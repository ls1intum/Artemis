...
Where the course has **Grading feedback suggestions** enabled on the Athena settings page, Artemis generates assessment suggestions for modeling submissions using the Athena service.
