...
For more details, see the [Auxiliary Repositories configuration section](/Artemis/instructor/exercises/programming-exercise#auxiliary-repositories) in Exercise Creation.
...
<Callout variant={CalloutVariant.info}>
  <p>The GCC SCA option for C does not offer categories by default. The issues were categorized during parsing with respect to the rules. For details on the default configuration and active rules, see the <a href="#static-code-analysis-default-configuration">Static Code Analysis Default Configuration</a> section below.</p>
</Callout>
...
|-------------------------------------------------------------------------------------------------|------------------------------|-----------------------------------------------------------|
| **[Coding](https://checkstyle.org/checks/coding/index.html) / Code Style**                      | EmptyStatement               |                                                           |
|                                                                                                 | EqualsHashCode               |                                                           |
...
| **[Class Design](https://checkstyle.org/checks/design/index.html) / Design**                    | FinalClass                   |                                                           |
|                                                                                                 | HideUtilityClassConstructor  |                                                           |
|                                                                                                 | InterfaceIsType              |                                                           |
|                                                                                                 | VisibilityModifier           |                                                           |
| **[Block Checks](https://checkstyle.org/checks/blocks/index.html) / Code Style**                | AvoidNestedBlocks            |                                                           |
|                                                                                                 | EmptyBlock                   |                                                           |
|                                                                                                 | NeedBraces                   |                                                           |
| **[Modifiers](https://checkstyle.org/checks/modifier/index.html) / Code Style**                 | ModifierOrder                |                                                           |
|                                                                                                 | RedundantModifier            |                                                           |
| **[Size Violations](https://checkstyle.org/checks/sizes/index.html) / Code Metrics**            | MethodLength                 |                                                           |
|                                                                                                 | ParameterNumber              |                                                           |
|                                                                                                 | FileLength                   |                                                           |
|                                                                                                 | LineLength                   | max="120"                                                 |
| **[Imports](https://checkstyle.org/checks/imports/index.html) / Naming & Formatting**           | IllegalImport                |                                                           |
|                                                                                                 | RedundantImport              |                                                           |
|                                                                                                 | UnusedImports                | processJavadoc="false"                                    |
| **[Naming Conventions](https://checkstyle.org/checks/naming/index.html) / Naming & Formatting** | ConstantName                 |                                                           |
...
|                                                                                                 | ParameterName                |                                                           |
|                                                                                                 | TypeName                     |                                                           |
| **[Whitespace](https://checkstyle.org/checks/whitespace/index.html) / Naming & Formatting**     | EmptyForIteratorPad          |                                                           |
|                                                                                                 | GenericWhitespace            |                                                           |
|                                                                                                 | MethodParamPad               |                                                           |
|                                                                                                 | NoWhitespaceAfter            |                                                           |
|                                                                                                 | NoWhitespaceBefore           |                                                           |
...
|                                                                                                 | WhitespaceAfter              |                                                           |
|                                                                                                 | WhitespaceAround             |                                                           |
| **[Javadoc Comments](https://checkstyle.org/checks/javadoc/index.html) / Documentation**        | InvalidJavadocPosition       |                                                           |
|                                                                                                 | JavadocMethod                |                                                           |
|                                                                                                 | JavadocType                  |                                                           |
|                                                                                                 | JavadocStyle                 |                                                           |
...
| **[Miscellaneous](https://checkstyle.org/checks/misc/index.html) / Miscellaneous**              | ArrayTypeStyle               |                                                           |
|                                                                                                 | UpperEll                     |                                                           |
|                                                                                                 | NewlineAtEndOfFile           |                                                           |
|                                                                                                 | Translation                  |                                                           |
...
| Category (Tool/Artemis)                 | Rule                                                                                                                                                                                    |
|-----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Memory Management / Potential Bugs**  | free-of-non-heap<br/>malloc-leak<br/>file-leak<br/>mismatching-deallocation                                                                                                             |
| **Undefined Behavior / Potential Bugs** | double-free<br/>null-argument<br/>use-after-free<br/>use-of-uninitialized-value<br/>write-to-const<br/>write-to-string-literal<br/>possible-null-argument<br/>possible-null-dereference |
| **Bad Practice / Bad Practice**         | double-fclose<br/>too-complex<br/>stale-setjmp-buffer                                                                                                                                   |
| **Security / Security**                 | exposure-through-output-file<br/>unsafe-call-within-signal-handler<br/>use-of-pointer-in-stale-stack-frame<br/>tainted-array-index                                                      |
