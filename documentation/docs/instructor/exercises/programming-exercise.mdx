...
Default container configuration usually doesn't need changes.
...
- **Internet Access**: Disable to prevent students from downloading dependencies during builds. Dependencies must be cached in the Docker image
