...
<Callout variant={CalloutVariant.info}>
    <p>
        The online code editor supports real-time collaborative editing. Multiple instructors can edit the same
...
<Callout variant={CalloutVariant.info}>
    ...
    <ul>
        ...
        <li>Unsaved/unsubmitted content is not preserved on the server. When all users close the page, unsaved content are lost. </li>
