...
- If **Grading Feedback Suggestions** is enabled for the course, you would get available suggestions from the service [Athena](https://github.com/ls1intum/edutelligence/tree/main/athena). More details about this service can be found in the following research papers:
