...
Your Artemis administrator may activate the `sharing`-profile. If this profile is enabled, you see an <Image src={sharingButton1} alt={"Sharing Button"} size={ImageSize.small} inline />-Button in the exercise detail view.
...
In the exercise detail view click on the <Image src={sharingButton1} alt={"Sharing Button"} size={ImageSize.small} inline />-Button.
