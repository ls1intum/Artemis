...
Your Artemis administrator may activate the `sharing`-profile. If this profile is enabled, you see an **Export to Sharing** button in the exercise detail view.
...
In the exercise detail view click **Export to Sharing**.
