...
Here you can see all the students’ participations for the exercise and navigate to the repository of a student by pressing the '*Code*' button and clicking on <Image src={openRepositoryButtonImg} alt={"Open Repository Button"} size={ImageSize.small} inline />.
...
You can navigate to these repositories by pressing the '*Code*' button and clicking <Image src={openRepositoryButtonImg} alt={"Open Repository Button"} size={ImageSize.small} inline /> as described above.
