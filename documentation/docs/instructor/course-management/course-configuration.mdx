...
Once a course has been created (either through a [course request](/instructor/course-management/course-requests) or by an administrator), you can configure it by clicking the **Settings** button in the bottom-left corner of the course sidebar. The settings page is organized into four sections: general information, exercises and grading, additional course features, and student enrollment. Additionally, the Iris AI tutor and Athena AI feedback can be configured separately from the course overview page.
