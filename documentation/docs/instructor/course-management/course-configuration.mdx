...
<Callout variant={CalloutVariant.info}>
The AI Assisted Feedback settings are only visible to instructors and administrators.
</Callout>

**AI Assisted Feedback for Exercises Enabled** is the master toggle that activates Athena-powered feedback features for this course. When disabled, none of the sub-options below have any effect.

When enabled, two additional options become available:

**Formative Feedback Requests Enabled** allows students to request preliminary AI feedback from Athena before the exercise due date. Students can use this to get early guidance on their work without waiting for the official tutor assessment.

**Grading Feedback Suggestions Enabled** allows Athena to suggest feedback to tutors while they assess student submissions across all exercise types. Suggestions appear alongside the submission and can be accepted, modified, or dismissed by the tutor.
...
<Callout variant={CalloutVariant.info}>
The AI Assisted Feedback settings are only visible to administrators.
</Callout>
