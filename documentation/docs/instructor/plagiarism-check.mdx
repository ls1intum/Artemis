...
5. Notify the student about the potential plagiarism case and ask them for a statement.
...
<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/42153" title="Creating a new exercise with the CPC enabled" />

Reviewing check's results by an instructor.

<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/42154" title="Reviewing check's results by an instructor" />

Reviewing check's results by a student.

<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/42155" title="Reviewing check's results by a student" />

Fixing submissions marked as a significant similarity.

<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/42156" title="Fixing submissions marked as a significant similarity" />
...
<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/42157" title="Responding to a significant similarity plagiarism case that persisted after the exercise due date and adding a verdict to it" />
