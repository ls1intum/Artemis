...
<Callout variant={CalloutVariant.warning}>
    <p>
        Plagiarism checks and resulting cases can have serious academic and potentially legal consequences for students.
        Always review detected cases carefully, ensure that evidence is well-documented, and handle communication and
        decisions in a fair, transparent, and responsible manner in line with your institutions regulations.
    </p>
</Callout>
