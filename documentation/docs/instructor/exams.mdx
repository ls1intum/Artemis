...
![Timeline of an Artemis Exam](./assets/exams/timeline.png)
*Timeline of an Artemis Online Exam*
...
- Click on ![Course Management](./assets/exams/buttons/course_management.png).
- Click on ![Exams](./assets/exams/buttons/exams.png) for your course. It will open the *Exam Management Screen*.
- Here you have access to all the exams of your course. All aspects of the exam are managed from the management screen.
- You can create an exam by clicking on ![Create New Exam](./assets/exams/buttons/create_new_exam.png).
...
- When you click on ![Create New Exam](./assets/exams/buttons/create_new_exam.png) you are presented with the *Create Exam* view. Here you can set the basic information such as `title`, `examiner` etc.
...
![Create and Configure](./assets/exams/exam_configuration.png)
*Create and Configure the Exam*

![Exam Conduction](./assets/exams/exam_conduction.png)
*Exam Conduction*

![Exam Exercises](./assets/exams/exam_exercises.png)
*Exam Exercises*

![Exam Assessment and Student Review](./assets/exams/exam_assessment.png)
*Exam Assessment and Student Review*

#### 1.2.3 Import Exam

- Instead of creating a new exam, you can import an existing exam by clicking on ![Import Exam](./assets/exams/buttons/import_exam.png) from any of the courses you are an instructor in.
- Artemis displays a list of all available exams. To select one specific exam for the import, click on the ![Import Individual Exam](./assets/exams/buttons/import_individual_exam.png) button.

![List with all exams available for import](./assets/exams/exam_import_selection.png)
...
- By default, every exercise group is mandatory. You can set the `mandatory` flag when you add an exercise group initially, or later by clicking ![Edit](./assets/exams/buttons/edit.png) on the exercise group.

![Exercise Groups with different Exercise Variants](./assets/exams/exercise_variants.png)
...
- When you click on ![Import Exercise Group](./assets/exams/buttons/import_exercise_group.png), you can select one exam from which exercise group(s) should be imported.
- To select one exam, click on ![Select Exercise Group](./assets/exams/buttons/select_exercise_group.png).

![First step in the process to import exercise group(s). You can select one exam, from which exercise group(s) should be imported](./assets/exams/exercise_group_import_exam.png)
...
- After you have started the import by clicking on ![Import Exam](./assets/exams/buttons/import_exam.png), Artemis checks if the title and short name of the selected programming exercise(s) are unique. If they are not unique, a warning is displayed and you have to change the corresponding title and short name.
...
![Second step in the process to import exercise group(s). You can select or deselect individual exercises, which should be imported alongside the exercise group(s).](./assets/exams/exercise_group_import_exercises.png)
...
![Add different Exercises](./assets/exams/add_exercises.png)
...
- Programming exercises have multiple special options to adjust their behavior:
  ...
  - After you add a programming exercise you can configure the grading via ![Configure Grading Button](./assets/exams/buttons/configure_grading.png).
  ...
  - You can hide tests so that they are not executed during the exam conduction by setting the test case visibility to `After Release Date of Results.` Students can not receive feedback from hidden tests during the exam conduction. This option is set by default when creating new programming exercises within an exam.
    ...
    ![Configure the Grading of a Programming Exercise](./assets/exams/configure_grading.png)
...
- To register students to the exam, navigate from the exam management to the *Students* page. Artemis offers two options to register students. You can:
  ...
  2. To import multiple students, click on the ![Import Students](./assets/exams/buttons/import_students.png) button and provide a `CSV` file in the Import Users dialog. The required fields in the `CSV` file include the `registrationNumber` and the `login`, while `email`, `firstname`, `lastname`, `seat`, and `room` are optional. Note that the `room` and `seat` fields are only necessary for the exam participation check. You can find an example file at `docs/user/exams/instructor/example_import_students.csv`. To begin the import, press the ![Import Students Button](./assets/exams/buttons/import_students_button.png) button.

     ![Import Students Dialog](./assets/exams/import_students_dialog.png)
     *Import Students Dialog*

  3. Register every student in the course by pressing the ![Register Course Students](./assets/exams/buttons/register_course_students.png) button.
...
![Register Students Page](./assets/exams/add_students.png)
...
- To generate student exams you must click on ![Generate Individual Exams](./assets/exams/buttons/generate_individual_exams.png). This will trigger Artemis to create a student exam for every registered user.
...
:::note
![Generate Individual Exams](./assets/exams/buttons/generate_individual_exams.png) button will be locked once the exam becomes visible to the students. You cannot perform changes to student exams once the [exam conduction](#2-conduction) has started.
:::

- If you have added more students recently, you can choose to ![Generate Missing Exams](./assets/exams/buttons/generate_missing_exams.png).
- ![Prepare Exercise Start](./assets/exams/buttons/prepare_exercise_start.png) creates a participation for each exercise for every registered user, based on their assigned exercises. It also creates the individual repositories and build plans for programming exercises. This action can take a while if there are many registered students due to the communication between the version control (VC) and continuous integration (CI) server.

:::warning
You must trigger ![Prepare Exercise Start](./assets/exams/buttons/prepare_exercise_start.png) before the [exam conduction](#2-conduction) begins.
:::

- On the *Student Exams* page, you can also maintain the repositories of student exams. This functionality only affects programming exercises. You can choose to ![Lock Repo](./assets/exams/buttons/lock_repo.png) and ![Unlock Repo](./assets/exams/buttons/unlock_repo.png) all student repositories.
...
![Student Exam Page](./assets/exams/student_exams.png)
*Student Exam Page*

![Individual Working Time](./assets/exams/individual_working_time.png)
*Individual Working Time*

### 1.7 Conducting Test Runs

![Test Run Management](./assets/exams/test_run_management.png)
*Test Run Management*
...
- An instructor can also assess his test run submissions. To do this, you must have completed at least one test run. To navigate to the assessment screen of the test runs click ![Assess Test Runs](./assets/exams/buttons/assess_test_runs.png).

![Test run conduction marked with the banner on the top left.](./assets/exams/test_run_conduction.png)
...
- You can view the results of the assessment of the test run by clicking on ![Summary](./assets/exams/buttons/summary.png). This page simulates the *Student Exam Summary* where the students can view their submissions and the results once they are published.
...
![In Progress Exam Checklist](./assets/exams/exam_checklist.png)
...
![Exam Status Overview](./assets/exams/exam_checklist_overview.png)
...
- Additionally, once the [exam conduction](#2-conduction) ends, you can click on ![Evaluate Quizzes](./assets/exams/buttons/evaluate_quizzes.png). This action will evaluate all student exam submissions for all quiz exercises and assign an automatic result.

:::note
If you do not press this button, the students quiz exercises will not be graded.
:::

- After the [exam conduction](#2-conduction) ends, you can click on ![Assess Unsubmitted Student Exams](./assets/exams/buttons/assess_unsubmitted_student_exams.png). This action will automatically evaluate all submissions with 0 points for unsubmitted student exams. Additionally, empty submissions will be automatically graded with 0 points.
...
![Assessment Dashboard](./assets/exams/assessment_dashboard.png)
*Assessment Dashboard*

- To assess a submission for an exercise, you can click on ![Exercise Dashboard](./assets/exams/buttons/exercise_dashboard.png).
...
- If there is a submission which has not been assessed yet, you can click ![Start New Assessment](./assets/exams/buttons/start_new_assessment.png). This will fetch a random student submission of this exercise which you can then assess.
...
![Manually Assessing a Programming Submission](./assets/exams/programming_assessment.png)
...
![Configure exam](./assets/exams/set_second_correction_exam.png)
...
![second correction status](./assets/exams/second_correction_status.png)
...
![Configure exam](./assets/exams/exam_assessment_dashboard_second_correction.png)

- To assess a submission a second time go to the exercise assessment dashboard. When it is enabled, a ![Start New Assessment](./assets/exams/buttons/start_new_assessment.png) button will be visible in the second correction round.
...
- You can access each assessment of both rounds by going to the exam's ![Exercise Groups](./assets/exams/buttons/exercise_groups.png) -> ![Scores](./assets/exams/buttons/scores.png) of the respective exercise.

![Scores page](./assets/exams/scores_table.png)
*Scores page*
...
To open the suspicious behavior dashboard click on the ![Suspicious Behavior](./assets/exams/buttons/suspicious_behavior.png) button.
...
![Suspicious Behavior Exam Checklist](./assets/exams/suspicious_behavior_exam_checklist.png)
...
You can see the available analysis options in the first screenshot below. To start the analysis, click the ![Analyze Sessions](./assets/exams/buttons/analyze_sessions.png) button. When the analysis detects at least one suspicious case, the instructor can click the ![View Sessions](./assets/exams/buttons/view_sessions.png) button to see the details of the suspicious exam sessions.
The second screenshot shows an example of analysis results.

![Suspicious Behavior Analysis Options](./assets/exams/analysis_options.png)
*Suspicious Behavior Analysis Options*

![Suspicious Behavior Analysis Results Example](./assets/exams/suspicious_behavior_analysis_results.png)
...
To view the current detection results or run a detection click on the ![View Plagiarism Results](./assets/exams/buttons/view_plagiarism_results.png) button. This navigates to the plagiarism detection page of the exercise.
Once the instructor has confirmed at least one case, the ![View Cases](./assets/exams/buttons/view_cases.png) button is visible at the bottom left of the table that navigates to all confirmed plagiarism cases of the exam.

![Plagiarism Cases Overview](./assets/exams/plagiarism_case_overview.png)
...
- To apply the plagiarism check, you must navigate to the individual exercise. This can be done by navigating to:
  ...
  ![Exams](./assets/exams/buttons/exams.png) -> ![Exercise Groups](./assets/exams/buttons/exercise_groups.png) -> exercise-title

![Detecting Plagiarism attempts on Modeling Exercises](./assets/exams/plagiarism.png)
*Detecting Plagiarism attempts on Modeling Exercises*

- At the bottom of the page you will find the option ![Check Plagiarism](./assets/exams/buttons/check_plagiarism.png).
...
- The exam timeline is available on the details page of a student exam when the student exam has been submitted by clicking on the button ![Exam Timeline](./assets/exams/buttons/exam_timeline.png). If the exam has not been submitted yet, the exam timeline button is disabled and shows an explanatory tooltip.
...
![Exam timeline](./assets/exams/exam_timeline_example.png)

### 3.6 Grading Key

- Optionally, you can create a grading key for your exam by clicking ![Grade Key](./assets/exams/buttons/grade_key.png) at the top of the exam's detail page.
...
- For an easy out-of-the-box configuration, you can click ![Generate Default Grade Key](./assets/exams/buttons/generate_default_grade_key.png) and then click `Save`.
...
- If you would like to define custom grade steps, you can use the ![Add Grade Step](./assets/exams/buttons/add_grade_step.png) button and modify the grade step intervals.
...
- ![Import Export](./assets/exams/buttons/import_export.png) buttons enable you to save the grading key as a CSV file and re-use it in other courses and exams.

![Default Grading Key](./assets/exams/grade_key_editor.png)
*Default Grading Key*
...
- You can access the exam scores by clicking on ![Scores](./assets/exams/buttons/scores.png). This view aggregates the results of the students and combines them to provide an overview over the students' performance.
...
- The exam scores can also be exported via ![Export](./assets/exams/buttons/export.png). This is useful to upload the results into university systems like [TUM Online](https://campus.tum.de) as a `CSV` file.
...
![Exam Scores Page](./assets/exams/exam_statistics.png)
*Exam Scores Page*
...
![Example Solution Publication Date](./assets/exams/exam_example_solution_publication_date.png)
...
![Assessor responding to a Complaint](./assets/exams/complaint_response.png)
...
You can also verify the attendance in the web application by pressing the ![Verify Attendance](./assets/exams/buttons/verify_attendance.png) button. This button opens a new view that shows which students have started the exam in Artemis but still need to complete the check-in with a teaching assistant.

![Verify Attendance View: One student did not complete the check-in](./assets/exams/verify_attendance_verification_missing.png)
*Verify Attendance View: One student did not complete the check-in*

![Verify Attendance View: All students have been successfully checked in](./assets/exams/verify_attendance_verification_successful.png)
...
![Exam Overview](./assets/exams/exam_overview.png)
...
![Student List View](./assets/exams/student_list_view.png)
![Export Signatures](./assets/exams/student_list_view_export_signatures.png)
...
![Student Detail View](./assets/exams/student_detail_view.png)
