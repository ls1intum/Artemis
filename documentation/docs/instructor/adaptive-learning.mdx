...
<Callout variant={CalloutVariant.info}>
    <p>
        To use this feature, Iris needs to be enabled for your Artemis instance and <em>Competency Generation</em> needs to be enabled in the Iris global settings <strong>as well as the Iris settings of your course</strong> (see image below).
        If you cannot enable <em>Competency Generation</em> in your Iris course settings, contact your instance administrators.
    </p>
</Callout>
