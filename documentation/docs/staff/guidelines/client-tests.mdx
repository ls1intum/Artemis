...
| A spy should have been called with a value | Always test the number of calls as well:<br/><br/>```ts
expect(spy).toHaveBeenCalledOnce();
expect(spy).toHaveBeenCalledWith(value);
```<br/><br/>If you have multiple calls, you can verify the parameters of each call separately:<br/><br/>```ts
