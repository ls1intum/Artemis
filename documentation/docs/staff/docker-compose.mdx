...
Everything related to the Docker Image of Artemis (built by the Dockerfile) can be found [in the Server Setup section](/staff/setup#run-the-server-via-docker).
...
See the [Debugging with Docker](/staff/docker-debugging) section for detailed information.
