...
<Image src={topLevelDesign} alt="Top-Level Design" size={ImageSize.large} />
...
<Image src={deploymentOverview} alt="Deployment Overview" size={ImageSize.large} />
...
<Image src={dataModel} alt="Data Model" size={ImageSize.large} />
...
<Image src={serverArchitecture} alt="Server Architecture" size={ImageSize.large} />
...
<Image src={iclDeployment} alt="Integrated Code Lifecycle Deployment" size={ImageSize.large} />
...
<Image src={iclVCSubsystem} alt="Version Control Subsystem" size={ImageSize.large} />
...
<Image src={iclCISubsystem} alt="Continuous Integration Subsystem" size={ImageSize.large} />
...
<Image src={iclCIMSubsystem} alt="CI Management Subsystem" size={ImageSize.large} />
...
<Image src={iclBuildJobItem} alt="BuildJobQueueItem" size={ImageSize.large} />
...
<Image src={iclBuildAgent} alt="Build Agent Subsystem" size={ImageSize.large} />
...
<Image src={iclCancellationClass} alt="Build Job Cancellation Class Diagram" size={ImageSize.large} />
...
<Image src={iclCancellationComm} alt="Build Job Cancellation Communication Diagram for a Processing Build Job" size={ImageSize.large} />
