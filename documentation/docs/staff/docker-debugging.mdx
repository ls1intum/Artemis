...
If you want to debug your own PR, replace the image name with your own PR image `ghcr.io/ls1intum/artemis:pr-<pr-number>`.
...
If the server start fails with Liquibase errors, you can run the following command to reset the database:
