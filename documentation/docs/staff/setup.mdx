...
Podman offers a [desktop application](https://podman-desktop.io/) similar to [Docker Desktop](https://www.docker.com/products/docker-desktop/) and [CLI tools](https://podman.io) for Windows, macOS, and Linux.
