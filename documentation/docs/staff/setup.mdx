...
- **Integrated Code Lifecycle Setup (Recommended):** [Integrated Code Lifecycle Setup](#integrated-code-lifecycle-setup)
- **LocalVC + Jenkins Setup:** See the old documentation under `/docs/dev/setup/jenkins-localvc.rst`
...
<iframe
    src="https://live.rbg.tum.de/w/artemisintro/34536?video_only=1&t=0"
    title="Video version of the setup guide on TUM-Live"
    width="600"
    height="350"
    allowFullScreen
    loading="lazy"
...
<iframe
    src="https://live.rbg.tum.de/w/artemisintro/34537?video_only=1&t=0"
    title="Video of creating a programming exercise on TUM-Live"
    width="600"
    height="350"
    allowFullScreen
    loading="lazy"
...
<iframe
    src="https://live.rbg.tum.de/w/artemisintro/34538?video_only=1&t=0"
    title="Video showcasing how to participate in a programming exercise from the online editor and from a local Git client on TUM-Live"
    width="600"
    height="350"
    allowFullScreen
    loading="lazy"
...
<iframe
    src="https://live.rbg.tum.de/w/artemisintro/34539?video_only=1&t=0"
    title="Video showcasing unauthorized access to a local VC repository on TUM-Live"
    width="600"
    height="350"
    allowFullScreen
    loading="lazy"
