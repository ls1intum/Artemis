...
<Callout variant={CalloutVariant.warning}>
  ...
  <p>On startup, if a collection already exists, Artemis will log:<br/>
  <code>Collection 'Artemis_Exercises' already exists, skipping creation. Delete the collection and restart to apply configuration changes.</code></p>
