...
artemis:
    weaviate:
        enabled: false                    # Disabled by default; set to true to enable Weaviate integration
        ...
        collection-prefix: Artemis_       # Prefix for all Weaviate collection names to avoid naming conflicts (e.g. with Pyris, or allowing different prefixes for a shared Weaviate instance for test servers)
        vectorizer-module: none           # Vectorizer module: "none" for self-provided vectors or "text2vec-transformers" for automatic embeddings
```
