...
Weaviate is a vector database used by Artemis to provide a global keyword and semantic search across various entities:

- **Exercises** (Programming, Quiz, Modeling, Text, File Upload)
- **Lectures** and **Lecture Units** (Text, Attachment, Video, Online)
- **Exams**
- **FAQs**
- **Communication Channels**

It is also used by the EduTelligence suite (Iris/Pyris) for storing and retrieving embeddings.
