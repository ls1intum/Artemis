...
- Deploy the PR to a test server and verify its functionality. See the [Test Servers Documentation](test-servers) for instructions on deployment and test accounts.
...
- Ensure code adheres to the project's [Guidelines](https://docs.artemis.tum.de/developer/guidelines/).
...
- [Guidelines](https://docs.artemis.tum.de/developer/guidelines/)
