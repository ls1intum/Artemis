...
- Make sure that the PR is marked as "ready for review" and not in a draft state. Afterward, add yourself to the reviewers.
...
- Deploy the PR to a test server and verify its functionality. See the [Test Servers Documentation](https://docs.artemis.cit.tum.de/dev/testservers.html) for instructions, and use the provided [Test Accounts](https://confluence.aet.cit.tum.de/spaces/ArTEMiS/pages/25252245/Test+Accounts+Test+Servers#TestAccounts%26TestServers-TestAccounts) for logging in.
...
- Ensure code adheres to the project's [Guidelines](https://docs.artemis.cit.tum.de/dev/guidelines.html).
...
To support continuous improvement and engagement in the review process, Artemis uses [Hephaestus](https://hephaestus.aet.cit.tum.de/):
...
- [Guidelines](https://docs.artemis.cit.tum.de/dev/guidelines.html)
- [Development Process](development-process)
- [GitHub Pull Request Review Documentation](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-request-reviews)
