...
| Entity                           | Belongs to                                          | Parent required | Orphan possible | Notes                                                                      |
| -------------------------------- | --------------------------------------------------- | --------------- | --------------- | -------------------------------------------------------------------------- |
| `PresentationAssessment`         | Course `course_id`                                  | Required        | No              | Cascades on course deletion. The linked exercise is an optional reference. |
| `PresentationAssessmentInstance` | PresentationAssessment `presentation_assessment_id` | Required        | No              | Cascades on assessment deletion.                                           |
...
Of the 149 tables behind the 188 entities, 89 have a required parent, 24 are roots by design, 18 are
