...
| `IrisProactiveEpisode` | User `user_id` and Exercise `exercise_id` | Required (all) | No | Cascades on both. |
...
parents. That leaves **16 tables where the schema permits an orphan**, in three shapes.
