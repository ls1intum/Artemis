---
id: language
title: Inclusive, Diversity-Sensitive, and Appreciative Language
sidebar_label: Inclusive, Diversity-Sensitive, and Appreciative Language
---
...
* **Avoid using terms that have social history**:  Terms that can have historical significance or impact regarding race, ethnicity, national origin, gender, age, mental and physical ability, sexual orientation, socioeconomic status, religion, and educational background.
...
* **Beschreibe Handlungen (aktiv oder passiv)**:
  ...
  * „Automatisch generierte Ergebnisse werden am Ende des Bearbeitungszeitraums erstellt". Statt „Die Studierenden erhalten am Ende des Bearbeitungszeitraums ein automatisch generiertes Ergebnis.")
...
* [Inclusive Language in Technology, Academy Software Foundation](https://www.aswf.io/blog/inclusive-language/)
* [Google Developer Documentation Style Guide](https://developers.google.com/style/inclusive-documentation/)
* [Geschlechtergerechter Sprachgebrauch, Duden](https://www.duden.de/sprachwissen/sprachratgeber/Geschlechtergerechter-Sprachgebrauch/)
* [TUM Sprachleitfaden, Technische Universität München](https://www.zv.tum.de/fileadmin/w00cks/diversity/Stabsstelle/Sprachleitfaden/TUM_Sprachleitfaden_Stabsstelle_Diversity_Inclusion.pdf)
* [Ein Leitfaden für inklusive, vielfaltssensible und wertschätzende Sprache, School of Engineering and Design, Technische Universität München](https://www.ed.tum.de/ed/ueber-uns/diversitaet/sprachleitfaden/)
* [Stabsstelle Diversity & Inclusion, Technische Universität München](https://www.zv.tum.de/diversity/stabsstelle-diversity-inclusion/)
