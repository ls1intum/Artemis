...
The private [TUM UI package](/developer/guidelines/tum-ui-kit) isolates existing reusable components.
It does not change the PrimeNG policy, and adding a new Artemis component to that package requires an
explicit reusable-package need.
