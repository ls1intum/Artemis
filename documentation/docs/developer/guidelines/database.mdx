...
1. Save the child entity (e.g., [Feedback](https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/assessment/domain/Feedback.java)) without connection to the parent entity (e.g., [Result](https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/assessment/domain/Result.java))
