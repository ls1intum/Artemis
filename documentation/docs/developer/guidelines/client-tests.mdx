...
Most client tests use [Jest](https://jestjs.io) as the testing framework.
...
[Vitest](https://vitest.dev/) instead of Jest. The authoritative list of Vitest modules is defined by the
