...
For the end-to-end service contract, headers, module manager, and module behavior, see the [Athena request lifecycle](https://ls1intum.github.io/edutelligence/athena/docs/dev/module/request-lifecycle).
