...
3. **Set the installation metadata**
    - The server refuses to start until it knows who operates the installation. Add these three values to `application-local.yml`, replacing the examples with your own; they appear on the About page:
