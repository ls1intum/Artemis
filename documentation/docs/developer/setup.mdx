...
4. **[pnpm](https://pnpm.io) (≥ 11.9.0) — the package manager Artemis uses for the Angular client**
   ...
   ```bash
   pnpm --version          # should print 11.9.0 (matches packageManager in package.json)
