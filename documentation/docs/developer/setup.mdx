...
4. **[pnpm](https://pnpm.io) (≥ 11.13.1) — the package manager Artemis uses for the Angular client**
   ...
   ```bash
   pnpm --version          # should print 11.13.1 (matches packageManager in package.json)
