...
4. **[pnpm](https://pnpm.io) (≥ 11.1.0) — the package manager Artemis uses for the Angular client**
   ...
   The official pnpm website is [pnpm.io](https://pnpm.io/); the CLI reference lives at [pnpm.io/cli](https://pnpm.io/cli/add) and the installation guide at [pnpm.io/installation](https://pnpm.io/installation).
