...
<Callout variant={CalloutVariant.info}>
Make sure to follow the [Artemis Code and Design Guidelines](https://docs.artemis.cit.tum.de/dev/guidelines.html).
</Callout>
...
1. The first term is a main feature of Artemis and should use code highlighting, e.g. `Programming exercises`:
   ...
   Possible feature tags are: `Programming exercises`, `Integrated code lifecycle`, `Quiz exercises`, `Modeling exercises`, `Text exercises`, `File upload exercises`, `Exam mode`,
