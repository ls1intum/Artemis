...
```markdown title="Artemis/.github/ISSUE_TEMPLATE/feature-proposal--developer-.md"
<!-- Feature Proposal Template Content -->
See: .github/ISSUE_TEMPLATE/feature-proposal--developer-.md
```
