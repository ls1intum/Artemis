...
## Use Your Own PR Image (Optional)
...
## Configure IntelliJ Remote Debugging
...
## Handle Liquibase Errors (If Necessary)
...
Afterward, you can start the server again with the same command as under
[Start the Docker Compose File](#start-the-docker-compose-file).
