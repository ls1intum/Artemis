...
INFO_OPERATORNAME="<organization operating this installation>"
INFO_OPERATORADMINNAME="<name of its administrator>"
INFO_UNIVERSITYNAME="<university or institution>"
```

The last three lines are the installation metadata that every core node requires; they appear on the About page.
