...
If your setup also activates `localvc` or `buildagent` - the setups listed above do not - add a build-agent git password of your own, because the shipped one is rejected as well:
