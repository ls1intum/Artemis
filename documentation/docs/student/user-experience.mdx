...
import themeSwitchGif from "./assets/user-experience/theme_switch.gif";
import synchronizeThemeGif from "./assets/user-experience/synchronize_theme.gif";
...
<Image src={themeSwitchGif} alt={"Click the icon in the navbar to change the theme"} size={ImageSize.large} />
...
<Image src={synchronizeThemeGif} alt={"Re-enable theme synchronization in the theme popover"} size={ImageSize.large} />
