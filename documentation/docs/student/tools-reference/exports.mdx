...
| [Your user data](#export-user-data-gdpr-data-export)                  | Privacy statement, in the page footer        | ZIP with everything Artemis stores about you        |
...
You can request one export at a time. After you have downloaded it, or after Artemis has deleted it, the page shows
the date from which you may request the next one.
