...
<TumLiveVideo src="61337" title="Web Notifications" />
...
* **Maintenance** – Notifies you about scheduled system maintenance windows.
...
<TumLiveVideo src="61335" title="Notification Settings" />
...
| ExerciseUpdatedNotification | X | X | X |
| QuizExerciseStartedNotification | X | X | X |
