...
- Programming exercises have 2 modes.
  ...
  1. **Online code editor:** can only be used when you are online.
     ...
     :::note
     You have to click on ![Submit](./assets/exams/buttons/submit.png)! Otherwise your solution will *not* be pushed to the VC server and no build will be triggered.
     :::
