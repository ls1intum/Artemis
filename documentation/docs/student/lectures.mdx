...
Clicking on a lecture leads to the lecture details page, where students can see the title, description, lecture units, and attachments.

<Image src={lectureDetails} alt="Lecture Details Page" size={ImageSize.large}></Image>
...
Instructors can create competencies, which are desired learning objectives, and link lecture units to them. See the [Adaptive Learning](./adaptive-learning.mdx) documentation for more information.