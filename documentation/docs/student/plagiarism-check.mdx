...
<Callout variant={CalloutVariant.warning}>
    <p>
        Plagiarism cases are taken seriously at the university. If you receive a notification about a
        plagiarism case or a request for a statement, make sure to read all information carefully and respond honestly
