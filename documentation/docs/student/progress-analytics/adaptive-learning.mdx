...
Students can track their progress on the **Competencies** tab and view the next recommended content on the **Learning Path** tab.
...
The Insights Learner Profile is available when the Iris AI memory feature is enabled on the Artemis instance. It allows students to configure whether Iris can retain context from previous interactions to provide more personalized guidance over time. Students can enable or disable this feature in the Learner Profile settings page.
