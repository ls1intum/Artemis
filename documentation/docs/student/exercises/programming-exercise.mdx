...
3. If you have a graded participation, choose whether the practice repository starts from the template repository or from your graded participation. Otherwise the popover offers a single **Practice** button, which starts from the template repository
...
Where the exercise is assessed semi-automatically — a person marks it as well as the tests — and your instructor has
switched the feature on, **Request AI feedback** gives you preliminary comments on what you have pushed, beyond what
the tests report. It is not your mark. See [AI Feedback on a Draft](/student/exercises/ai-feedback).
