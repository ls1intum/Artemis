...
The editor opens inside the exercise view, next to the problem statement, and offers:

1. **File browser**: Navigate through your code files and see the project structure
2. **Code editor**: Write and edit your code with syntax highlighting
3. **Build output**: See compilation results and test feedback
4. **Interactive problem statement**: The instructions stay visible beside your code, with task indicators that update as you pass tests
5. **Submit**: Submit your solution for automated testing; **Code** gives you the URL to clone the repository
