...
| Programming | Yes |
| Quiz | Yes |
| Text | Yes, where your Artemis instance runs the Athena service and you have agreed to use AI |
| Modeling | Yes, where your Artemis instance runs the Athena service and you have agreed to use AI |
| File Upload | No |
...
<Callout variant={CalloutVariant.info}>
  ...
  Starting a practice participation and using **Request AI feedback** on it are two different conditions. Starting depends on the exercise type, the passed due date, the Athena service and your own [AI choice](../learning-content/iris.mdx#choosing-whether-to-use-ai): if you chose **No AI**, **Start practice** is not shown. Requesting feedback additionally needs your instructor to have enabled AI feedback for the course.
