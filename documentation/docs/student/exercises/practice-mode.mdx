...
<Image src={practiceModePopover} alt="Practice mode confirmation on a programming exercise" size={ImageSize.medium} caption="A programming exercise asks for confirmation before it creates the practice repository" />
