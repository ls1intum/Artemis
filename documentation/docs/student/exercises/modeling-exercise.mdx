...
The exercise appears on the course's exercise list once it is released.
...
**Start exercise** creates your participation, and **Open modeling editor** opens the editor.

## Draw and Submit

The task sits beside the canvas. Below it you can add an explanation of your model, which is worth writing whenever
a choice in the diagram needs justifying — an assessor reads it alongside the diagram.
