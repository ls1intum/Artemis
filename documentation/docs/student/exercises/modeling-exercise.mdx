...
When the exercise is released you can work on the exercise. Open it from the exercise list and click **Start exercise** in the header.

Artemis then opens the online modeling editor next to the problem statement. You can read the task, draw your diagram, and add an explanation of your solution if needed. **Submit** in the header hands in your diagram.
