...
2. Request to join a Organization from ???.

3. Create API keys in Project Settings of your organization.

4. See how Langfuse can receive traces on the OLTP endpoint [here](https://langfuse.com/integrations/native/opentelemetry)
