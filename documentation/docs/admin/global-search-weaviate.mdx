...
docker compose --env-file .env -f docker/weaviate.yml up -d
```
...
docker compose --env-file .env -f docker/weaviate-embeddings.yml build
docker compose --env-file .env -f docker/weaviate-embeddings.yml up -d
```
