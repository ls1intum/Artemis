...
| Anonymised by an older version | `UserService.anonymizeUser`, together with `is_deleted`; no longer written, see [Deleting User Accounts](user-deletion.mdx#accounts-left-over-from-older-versions) | Absent |
