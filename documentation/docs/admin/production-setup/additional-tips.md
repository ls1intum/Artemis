...
`-Djava.security.egd=file:/dev/./urandom` might also be useful for other (production) setups, even if this service file is not used. This is required if repositories are cloned via SSH from the VCS.
...
The [development section of the documentation](https://docs.artemis.cit.tum.de/dev/setup/docker-compose.html) provides a introduction to
