...
responsible for managing and interacting with the build job queue (adding, cancelling and viewing build jobs), and the [Local VC system](/admin/production-setup/integrated-code-lifecycle-setup).
