...
<Image src={singleInstanceSetupImg} size={ImageSize.medium} />
...
<Image src={multiInstanceSetupSimpleImg} size={ImageSize.medium} />
...
<Image src={deploymentHazelcastImg} size={ImageSize.medium} />
...
<Image src={deploymentBrokerImg} size={ImageSize.medium} />
...
<Image src={registryImg} size={ImageSize.medium} />
...
<Image src={buildAgentViewImg} size={ImageSize.medium} />
...
2. Create additional run configurations for each instance. You will have to add CLI arguments to each additional run
    ...
    <Image src={runConfigImg} size={ImageSize.medium} />
...
<Image src={multiNodeSetupImg} size={ImageSize.medium} />
