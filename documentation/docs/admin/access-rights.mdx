...
| Submit File                     | ✔                | ✔                | ✔                  | ✔ (before due date)   |
| View Own Submission             | ✔                | ✔                | ✔                  | ✔ (own only)          |
| View Editor Data                | ✔                | ✔                | ✔                  | ✔ (own only)          |
...
### File Upload Exercises - Summary

| Role       | Capabilities                                                                      |
|------------|-----------------------------------------------------------------------------------|
| Student    | Submit files, view own submission/results, view editor data for own participation |
| TA         | Same as Student + view all submissions, assess, lock submissions, limited export  |
| Editor     | Same as TA + create/edit/import exercises, search exercises, re-evaluate          |
| Instructor | Same as Editor + delete exercises, delete assessments, export all submissions     |
| Admin      | Full access to all file upload exercises                                          |

### File Upload Exercises - Prerequisites

- **Course Enrollment**: All exercise access requires enrollment in the course (except for Admins)
- **Admin Override**: Admins can access all file upload exercises regardless of course membership
- **Exam vs Course**: Exam exercises require Editor role for viewing details; course exercises only require TA role

### File Upload Exercises - Visibility Rules

Visibility conditions marked as "(if released)", "(before due date)", "(own only)", or "(own, after graded)" in the tables above are defined as follows:
...
**Submission Due Date:**
- Students can only submit files before the exercise `dueDate`
...
| Re-evaluate Exercise            | ✔                | ✔                |                    |                       |
| View Course Exercises           | ✔                | ✔                | ✔                  |                       |
| Submit Model                    | ✔                | ✔                | ✔                  | ✔ (before due date)   |
| View Own Submission             | ✔                | ✔                | ✔                  | ✔ (own only)          |
| View Latest Submission (editor) | ✔                | ✔                | ✔                  | ✔ (own only)          |
| Get Submission (for assessment) | ✔                | ✔                | ✔                  |                       |
| Get Unassessed Submission       | ✔                | ✔                | ✔                  |                       |
| List All Submissions            | ✔                | ✔                | ✔                  |                       |
| Save Assessment                 | ✔                | ✔                | ✔                  |                       |
...
| Export Submissions (limited)    | ✔                | ✔                | ✔                  |                       |
| Export All Submissions          | ✔                |                  |                    |                       |
| Create Apollon Diagram          | ✔                | ✔                | ✔                  |                       |
| Edit Apollon Diagram            | ✔                | ✔                | ✔                  |                       |
| View Apollon Diagrams           | ✔                | ✔                | ✔                  |                       |
| Delete Apollon Diagram          | ✔                | ✔                |                    |                       |
| View Diagram Title              | ✔                | ✔                | ✔                  | ✔                     |
...
### Modeling Exercises - Summary

| Role       | Capabilities                                                                                      |
|------------|---------------------------------------------------------------------------------------------------|
| Student    | Submit models, view own submission/results, view diagram titles, convert models to PDF            |
| TA         | Same as Student + view all submissions, assess, lock submissions, limited export, manage diagrams |
| Editor     | Same as TA + create/edit/import exercises, search exercises, re-evaluate, delete diagrams         |
| Instructor | Same as Editor + delete exercises, delete assessments, export all submissions                     |
| Admin      | Full access to all modeling exercises                                                             |

### Modeling Exercises - Prerequisites

- **Course Enrollment**: All exercise access requires enrollment in the course (except for Admins)
- **Admin Override**: Admins can access all modeling exercises regardless of course membership
- **Exam vs Course**: Exam exercises require Editor role for viewing details; course exercises only require TA role

### Modeling Exercises - Visibility Rules
...
**Submission Due Date:**
- Students can only submit models before the exercise `dueDate`
- Submissions after due date are rejected (except for exam exercises which have separate handling)
...
- Students can view their assessment results only after the assessment is finalized AND the assessment due date has passed
- Assessor information is hidden from students until assessment is finalized
- Double-blind assessment is supported: TAs cannot see student/team information during assessment

**Example Solution:**
- Students can view the example solution model only after it has been published (`isExampleSolutionPublished()`)
- Teaching Assistants and above can view example solutions at any time

### Modeling Exercises - Apollon Diagram Templates

Apollon diagram templates are reusable diagram structures that instructors can create for use in exercises.
...
| Re-evaluate Exercise            | ✔                | ✔                |                    |                       |
| View Course Exercises           | ✔                | ✔                | ✔                  |                       |
| Submit Text                     | ✔                | ✔                | ✔                  | ✔ (before due date)   |
| View Own Submission             | ✔                | ✔                | ✔                  | ✔ (own only)          |
| View Text Editor Data           | ✔                | ✔                | ✔                  | ✔ (own only)          |
| Get Submission (for assessment) | ✔                | ✔                | ✔                  |                       |
| Get Unassessed Submission       | ✔                | ✔                | ✔                  |                       |
| List All Submissions            | ✔                | ✔                | ✔                  |                       |
| Save Assessment                 | ✔                | ✔                | ✔                  |                       |
...
### Text Exercises - Summary

| Role       | Capabilities                                                                                        |
|------------|-----------------------------------------------------------------------------------------------------|
| Student    | Submit text, view own submission/results, view text editor data for own participation               |
| TA         | Same as Student + view all submissions, assess, lock submissions, limited export, add events        |
| Editor     | Same as TA + create/edit/import exercises, search exercises, re-evaluate, plagiarism, save examples |
| Instructor | Same as Editor + delete exercises, delete assessments, export all submissions, view analytics       |
| Admin      | Full access to all text exercises including assessment event analytics                              |

### Text Exercises - Prerequisites

- **Course Enrollment**: All exercise access requires enrollment in the course (except for Admins)
- **Admin Override**: Admins can access all text exercises regardless of course membership
- **Exam vs Course**: Exam exercises require Editor role for viewing details; course exercises only require TA role

### Text Exercises - Visibility Rules
...
**Submission Due Date:**
- Students can only submit text before the exercise `dueDate`
- Submissions after due date are rejected (except for exam exercises which have separate handling)
...
**Athena AI Feedback:**
- Text exercises support Athena AI feedback suggestions (if enabled)
- AI-generated preliminary feedback is available before assessment due date
