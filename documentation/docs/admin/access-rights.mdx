...
<Callout variant={CalloutVariant.info}>
    Super Admin privileges are only relevant when passkeys are activated and passkey enforcement for administrators is enabled.
    In other configurations, Super Admins and Admins have identical permissions, except that Admins cannot modify the accounts of Super Admins.
</Callout>
