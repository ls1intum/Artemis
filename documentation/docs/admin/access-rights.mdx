...
Tutors and editors can open course exercise participation and score lists using anonymous participation IDs. Student
names, logins, team identities, and identifying repository links are visible only to instructors. Searching or sorting
these lists by participant identity and exporting submissions selected by student login or team name also require
instructor access. Tutors can still download anonymized programming submissions selected by participation ID for
assessment. Students retain access to their own participation and repository details.
...
#### Additional Visibility Rules for Programming Exercises
...
[//]: # (Refers to QuizSubmissionResource.java: https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/quiz/web/openapi/QuizSubmissionResource.java)
...
[//]: # (Refers to QuizExerciseBatchResource.java: https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/quiz/web/openapi/QuizExerciseBatchResource.java)
...
#### Additional Visibility Rules for Quizzes
