...
[//]: # (TODO Text Exercises have a weird access management, not using the annotations and many hardcoded things in there -> should be refactored to be more consistent with the other exercise types)
