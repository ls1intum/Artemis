...
<Callout variant={CalloutVariant.info}>
    **Course membership terminology:**
    ...
    Both require the user to be associated with the specific course - platform-wide roles alone are not sufficient.
</Callout>
...
| Feature                     | Instructor          | Editor              | Teaching Assistant  | Student                    |
|-----------------------------|---------------------|---------------------|---------------------|----------------------------|
| View Quiz (course)          | ✔ (if in course)    | ✔ (if in course)    | ✔ (if in course)    | ✔ (if enrolled + released) |
| View Quiz (exam)            | ✔ (if in course)    | ✔ (if in course)    |                     |                            |
| Create Quiz (course)        | ✔                   | ✔                   |                     |                            |
| Create Quiz (exam)          | ✔                   | ✔                   |                     |                            |
| Update Quiz                 | ✔                   | ✔                   |                     |                            |
| Delete Quiz                 | ✔                   |                     |                     |                            |
...
| Submit File                     | ✔ (before due date) | ✔ (before due date) | ✔ (before due date) | ✔ (before due date)        |
...
| Re-evaluate Exercise            | ✔                   | ✔                   |                     |                            |
| View Course Exercises           | ✔ (if in course)    | ✔ (if in course)    | ✔ (if in course)    |                            |
| Submit Model                    | ✔ (before due date) | ✔ (before due date) | ✔ (before due date) | ✔ (before due date)        |
| View Own Submission             | ✔                   | ✔                   | ✔                   | ✔ (own only)               |
...
| Re-evaluate Exercise            | ✔                   | ✔                   |                     |                            |
| View Course Exercises           | ✔ (if in course)    | ✔ (if in course)    | ✔ (if in course)    |                            |
| Submit Text                     | ✔ (before due date) | ✔ (before due date) | ✔ (before due date) | ✔ (before due date)        |
| View Own Submission             | ✔                   | ✔                   | ✔                   | ✔ (own only)               |
