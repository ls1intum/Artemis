...
<Callout variant={CalloutVariant.info}>
    Quiz exercises use a different submission and assessment model from other exercise types. The [Shared Submission and Assessment Features](#shared-submission-and-assessment-features) do not apply to quizzes.
</Callout>
