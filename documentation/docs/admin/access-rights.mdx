...
[//]: # (Refers to AdminUserResource.java: https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/account/web/admin/AdminUserResource.java)
[//]: # (Refers to PasskeyResource.java: https://github.com/ls1intum/Artemis/blob/develop/src/main/java/de/tum/cit/aet/artemis/account/web/PasskeyResource.java)
...
<!-- GENERATED:Course Access -->
| Feature                                             | Instructor       | Editor           | Teaching Assistant | Student          |
|-----------------------------------------------------|------------------|------------------|--------------------|------------------|
|                                                     | ✔ (if in course) |                  |                    |                  |
| Active Students For Course Detail View              | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Active Students For Course Live Time                | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Add User to Course                                  | ✔                |                  |                    |                  |
| All                                                 | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| All Competencies From Course                        | ✔ (if in course) | ✔ (if in course) |                    |                  |
| All Exercises With Due Dates For Course             | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| All Sessions                                        | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Archive Course                                      | ✔                |                  |                    |                  |
| Assessment Dashboard                                | ✔                | ✔                | ✔                  |                  |
| Batch Add Users to Group                            | ✔                |                  |                    |                  |
| Categories In Course                                | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Cleanup Course                                      | ✔                |                  |                    |                  |
| Competencies For Import                             | ✔                | ✔                |                    |                  |
| Competency Contributions For Exercise               | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Competency Course Progress                          | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Competency Relation                                 | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Competency Relation                                 | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Competency Relation                                 | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Competency Relations                                | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Competency Student Progress                         | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Competency Title                                    | ✔                | ✔                | ✔                  | ✔                |
| Course                                              | ✔ (if in course) |                  |                    |                  |
| Course                                              | ✔ (if in course) |                  |                    |                  |
| Course Archive                                      | ✔ (if in course) |                  |                    |                  |
| Course Competencies With Progress                   | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Course Competency                                   | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Course Competency Titles                            | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Course D T O For Detail View                        | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Course For Assessment Dashboard                     | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Course For Enrollment                               | ✔                | ✔                | ✔                  | ✔                |
| Course Learner Profile                              | ✔                | ✔                | ✔                  | ✔                |
| Course Learner Profiles                             | ✔                | ✔                | ✔                  | ✔                |
| Course Material                                     | ✔ (if in course) |                  |                    |                  |
| Course Notification Info                            | ✔                | ✔                | ✔                  | ✔                |
| Course Notifications                                | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Course Request                                      | ✔                | ✔                | ✔                  | ✔                |
| Course With Exercises                               | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Course With Exercises And Lectures And Competencies | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Course With Organizations                           | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Courses                                             | ✔                | ✔                | ✔                  |                  |
| Courses For Archive                                 | ✔                | ✔                | ✔                  | ✔                |
...
| Courses For Import                                  | ✔                |                  |                    |                  |
| Courses For Management Overview                     | ✔                | ✔                | ✔                  |                  |
| Courses For Notifications                           | ✔                | ✔                | ✔                  | ✔                |
| Courses With Quiz Exercises                         | ✔                | ✔                |                    |                  |
| Courses With User Stats                             | ✔                | ✔                | ✔                  |                  |
| Current Session Or Create If Not Exists             | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Download Course Archive                             | ✔                |                  |                    |                  |
| Editor From Course                                  | ✔ (if in course) |                  |                    |                  |
| Editors In Course                                   | ✔ (if in course) |                  |                    |                  |
| Enroll In Course                                    | ✔                | ✔                | ✔                  | ✔                |
| Exercise Stats For Course Overview                  | ✔                | ✔                | ✔                  |                  |
| Exercises For Course Overview                       | ✔                | ✔                | ✔                  |                  |
| Existing Exercise Details                           | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Generate Competencies From Course Description       | ✔ (if in course) | ✔ (if in course) |                    |                  |
| Import Course Material                              | ✔                |                  |                    |                  |
| Import Summary                                      | ✔ (if in course) |                  |                    |                  |
| Instructor From Course                              | ✔ (if in course) |                  |                    |                  |
| Instructor To Course                                | ✔ (if in course) |                  |                    |                  |
| Instructors In Course                               | ✔ (if in course) |                  |                    |                  |
| Latest Judgement Of Learning For Competency         | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Latest Judgement Of Learning For Course             | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| List Course Users                                   | ✔                |                  |                    |                  |
| Locked Submissions For Course                       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Members Of Course                                   | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Notification Status                                 | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Other Users In Course                               | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Remove User from Course                             | ✔                |                  |                    |                  |
| Search Course Members                               | ✔                | ✔                | ✔                  | ✔                |
| Search Other Users in Course                        | ✔                | ✔                | ✔                  | ✔                |
| Search Students in Course                           | ✔                | ✔                | ✔                  |                  |
| Search Users in Course                              | ✔                | ✔                | ✔                  | ✔                |
| Session For Course                                  | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Set Judgement Of Learning                           | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Set Setting Preset                                  | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Set Setting Specification                           | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Setting Info                                        | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Stats For Assessment Dashboard                      | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Student From Course                                 | ✔ (if in course) |                  |                    |                  |
| Student To Course                                   | ✔ (if in course) |                  |                    |                  |
| Students In Course                                  | ✔ (if in course) |                  |                    |                  |
| Students In Course                                  | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                  |
| Tutor From Course                                   | ✔ (if in course) |                  |                    |                  |
| Tutor To Course                                     | ✔ (if in course) |                  |                    |                  |
| Tutors In Course                                    | ✔ (if in course) |                  |                    |                  |
| Unenroll From Course                                | ✔                | ✔                | ✔                  | ✔                |
| Update Course                                       | ✔                |                  |                    |                  |
| Users In Course                                     | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course) |
| Users To Course Group                               | ✔ (if in course) |                  |                    |                  |
| View Active Students Statistics                     | ✔                | ✔                | ✔                  |                  |
| View Assessment Dashboard Stats                     | ✔                | ✔                | ✔                  |                  |
| View Course Full Details                            | ✔                | ✔                | ✔                  |                  |
| View Course Organizations                           | ✔                | ✔                | ✔                  |                  |
| View Course with Exercises                          | ✔                | ✔                | ✔                  |                  |
| View Exercise Categories                            | ✔                | ✔                |                    |                  |
| View Exercise Due Dates                             | ✔                | ✔                | ✔                  |                  |
| View Existing Exercise Details                      | ✔                | ✔                |                    |                  |
| View Import Summary                                 | ✔                |                  |                    |                  |
| View Lifetime Statistics                            | ✔                | ✔                | ✔                  |                  |
| View Locked Submissions                             | ✔                | ✔                | ✔                  |                  |
| View Management Detail                              | ✔                | ✔                | ✔                  |                  |
<!-- /GENERATED:Course Access -->

## Course (manually managed - to be migrated)
...
| Feature                                                             | Super Admin | Admin | Instructor       | Editor           | Teaching Assistant | Student                    |
|---------------------------------------------------------------------|-------------|-------|------------------|------------------|--------------------|----------------------------|
| All Exercises On Page                                               |             |       | ✔                | ✔                |                    |                            |
| All Exercises With S C A On Page                                    |             |       | ✔                | ✔                |                    |                            |
| All Sessions                                                        |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Auxiliary Repositories                                              |             |       | ✔                | ✔                | ✔                  |                            |
| Build Config                                                        |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Build Logs                                                          |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Check If Participation Hash Result                                  |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Check Plagiarism                                                    |             |       | ✔                | ✔                |                    |                            |
| Check Plagiarism With J Plag Report                                 |             |       | ✔                | ✔                |                    |                            |
| Commit Changes                                                      |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Commit History For Participation Repo                               |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Commit History For Template Solution Test Or Aux Repo               |             |       | ✔                | ✔                | ✔                  |                            |
| Current Session Or Create If Not Exists                             |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Deletion Summary                                                    |             |       | ✔ (if in course) |                  |                    |                            |
| File                                                                |             |       | ✔                | ✔                | ✔                  | ✔                          |
| File                                                                |             |       | ✔                | ✔                | ✔                  | ✔                          |
| File                                                                |             |       | ✔                | ✔                | ✔                  | ✔                          |
| File For Plagiarism View                                            |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Files                                                               |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Files At Commit                                                     |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Files For Plagiarism View                                           |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Files With Content                                                  |             |       | ✔                | ✔                | ✔                  |                            |
| Files With Information About Change                                 |             |       | ✔                | ✔                | ✔                  |                            |
| Folder                                                              |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Generate Structure Oracle For Exercise                              |             |       | ✔                | ✔                |                    |                            |
| Grading Statistics                                                  |             |       | ✔                | ✔                |                    |                            |
| Instructor Auxiliary Repository                                     |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                            |
| Instructor Exercise                                                 |             |       | ✔                |                  |                    |                            |
| Instructor Repository                                               |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                            |
| Latest Pending Submission                                           |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Latest Pending Submissions By Exercise Id                           |             |       | ✔                | ✔                | ✔                  |                            |
| Latest Result With Feedbacks For Programming Exercise Participation |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Participation Files                                                 |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Participation Repository Files                                      |             |       | ✔                |                  |                    |                            |
| Participation Repository Files For Commits Details View             |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Participation With All Results For Student Participation            |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Participation With Latest Result For Student Participation          |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Plagiarism Result                                                   |             |       | ✔                | ✔                |                    |                            |
| Problem Statement                                                   |             |       | ✔                | ✔                |                    |                            |
...
| Programming Exercise                                                |             |       | ✔                |                  |                    |                            |
| Programming Exercise                                                |             |       | ✔                | ✔                |                    |                            |
| Programming Exercise From File                                      |             |       | ✔                | ✔                |                    |                            |
| Programming Exercise Timeline                                       |             |       | ✔                | ✔                |                    |                            |
| Programming Exercise With Auxiliary Repository                      |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                            |
| Programming Exercise With Setup Participations                      |             |       | ✔                | ✔                |                    |                            |
| Programming Exercise With Template And Solution Participation       |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   |                            |
| Programming Exercises For Course                                    |             |       | ✔                | ✔                | ✔                  |                            |
| Pull Changes                                                        |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Re Evaluate And Update Programming Exercise                         |             |       | ✔                | ✔                |                    |                            |
| Re Evaluate Graded Results                                          |             |       | ✔                |                  |                    |                            |
| Redirect Get Solution Repository Files                              |             |       | ✔                | ✔                | ✔                  |                            |
| Redirect Get Template Repository Files                              |             |       | ✔                | ✔                | ✔                  |                            |
| Rename File                                                         |             |       | ✔                | ✔                | ✔                  | ✔                          |
...
| Session For Exercise                                                |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Status                                                              |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Student Participation By Repo Name                                  |             |       | ✔                | ✔                | ✔                  | ✔                          |
| Student Repository                                                  |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Student Requested Repository                                        |             |       | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if in course)           |
| Submissions By Participation Ids                                    |             |       | ✔                | ✔                | ✔                  |                            |
| Submissions By Student Logins                                       |             |       | ✔                | ✔                | ✔                  |                            |
| Tasks                                                               |             |       | ✔                | ✔                | ✔                  |                            |
| Tasks                                                               |             |       | ✔                | ✔                |                    |                            |
| Tasks With Unassigned Task                                          |             |       | ✔                | ✔                | ✔                  |                            |
| Test Case State                                                     |             |       | ✔                | ✔                | ✔                  |                            |
| Test Cases                                                          |             |       | ✔                | ✔                | ✔                  |                            |
| Test Cases                                                          |             |       | ✔                | ✔                |                    |                            |
| Vcs Access Log For Exercise Repository                              |             |       | ✔ (if in course) |                  |                    |                            |
| Vcs Access Log For Participation Repo                               |             |       | ✔                |                  |                    |                            |
| View Programming Exercise                                           | ✔           | ✔     | ✔ (if in course) | ✔ (if in course) | ✔ (if in course)   | ✔ (if enrolled + released) |
<!-- /GENERATED:ProgrammingExercises -->
