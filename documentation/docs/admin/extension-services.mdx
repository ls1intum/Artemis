...
Once everything is set up correctly, you should see the **Export to Sharing** button in the **Programming Exercise Details** dialog in Artemis.

Similarly, an **Export to Artemis** button should appear on the sharing platform for any programming exercise available there.
