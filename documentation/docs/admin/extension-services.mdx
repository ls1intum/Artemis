...
The <a href="https://github.com/ls1intum/edutelligence/tree/main/athena">Athena</a> service, part of the EduTelligence suite, provides AI-based feedback generation for text, modeling, and programming exercises. It supports two modes:

- **Formative Feedback Requests** — Students can request preliminary AI feedback before the due date.
- **Grading Feedback Suggestions** — Athena suggests feedback to tutors while assessing student submissions.

Both modes are toggled per course by an administrator. See [AI Assisted Feedback](/instructor/course-management/course-configuration#ai-assisted-feedback) in the Course Configuration documentation.
...
The module names under `artemis.athena.modules` are configured at the application level and apply to all courses. They are not configurable per course or per exercise. For a list of available modules, refer to the <a href="https://github.com/ls1intum/edutelligence/tree/main/athena">Athena documentation</a>.
