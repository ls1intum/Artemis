...
Use a deployment-managed shared secret. For the service-side module contract and request lifecycle, refer to the [Athena request lifecycle](https://ls1intum.github.io/edutelligence/athena/docs/dev/module/request-lifecycle).
