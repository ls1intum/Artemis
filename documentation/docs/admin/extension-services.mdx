...
Set the Athena module-feature flag in `src/main/resources/config/application-artemis.yml`:
```yaml
artemis:
  athena:
    enabled: true
...
Set the Apollon module-feature flag in `src/main/resources/config/application-artemis.yml`:
```yaml
artemis:
  apollon:
    enabled: true
