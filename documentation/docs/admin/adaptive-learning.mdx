...
<TumLiveVideo src="https://live.rbg.tum.de/w/artemisintro/46942" title="Manage Standardized Competencies" />
...
<Callout variant={CalloutVariant.info}>
    <p>To obtain a file containing a standardized competency catalog, you can contact the Artemis developer team.</p>
</Callout>
