...
The About page shows the values that are set. See [Telemetry](/admin/telemetry#required-configuration) for the settings and for what the installation reports.
