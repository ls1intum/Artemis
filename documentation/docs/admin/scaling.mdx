...
More build agents can be added to the build system, guides can be found here for
<a href="#jenkins_build_agents">Jenkins</a>.
...
Details regarding the scaling of Artemis can be found in <a href="https://ls1intum.github.io/Artemis/admin/production-setup/multiple-artemis-instances">corresponding section of the documentation</a>.


<Image
  src={deploymentSingleMulti}
  alt={"Single server vs multi server deployment"}
