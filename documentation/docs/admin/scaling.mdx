...
Details regarding the scaling of Artemis can be found in <a href="/admin/production-setup/multiple-artemis-instances">corresponding section of the documentation</a>.
