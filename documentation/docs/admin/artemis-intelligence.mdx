...
For Azure OpenAI, set `base-url: https://<your-resource>.openai.azure.com` and `chat.deployment-name` instead — see the [Hyperion Admin Setup](/admin/hyperion) for a complete example.
