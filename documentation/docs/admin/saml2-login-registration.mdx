...
info:
    saml2:
        ...
        # Name of the identity provider (e.g., University X Account). No longer read: the sign-in page uses buttonLabel
        identityProviderName: 'Shibboleth Account'
        # No longer read. The sign-in page decides per account whether to offer a password field, from the account's internal flag
