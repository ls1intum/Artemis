...
/** Applies Artemis's feature-package and service conventions to the independently bootable worker artifact. */
...
class AiWorkerArchitectureTest {
    ...
    private static final JavaClasses CLASSES = new ClassFileImporter().withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("de.tum.cit.aet.artemis.aiworker", "de.tum.cit.aet.artemis.hyperion");
