...
class JUnitReportParserTest {
    ...
    private final List<TestCaseResult> failedTests = new ArrayList<>();

    private final List<TestCaseResult> successfulTests = new ArrayList<>();
    ...
    void testParseResultXmlInnerText() throws IOException {
        ...
        new JUnitReportParser(20_000).processTestResultFile(exampleXml, failedTests, successfulTests);
    ...
    void testSuccessfulTests() throws IOException {
        ...
        assertThat(successfulTests).map(TestCaseResult::name).containsExactlyInAnyOrder("testMergeSort()", "testUseBubbleSortForSmallList()", "testBubbleSort()",
    ...
    void testWithTestSuitesWrapper() throws Exception {
        ...
        new JUnitReportParser(20_000).processTestResultFile(input, failedTests, successfulTests);
        assertThat(failedTests).isEmpty();
    ...
    void testNestedTestsuite() throws IOException {
        ...
        // @formatter:off
        assertThat(successfulTests).extracting(TestCaseResult::name).containsExactlyInAnyOrder(
    ...
    void testNestedTestsuiteMissingNames() throws IOException {
        ...
        assertThat(successfulTests).extracting(TestCaseResult::name).containsExactlyInAnyOrder("Test1", "Test2", "Test3");
        assertThat(failedTests).isEmpty();
    }
    ...
    void testXmlProlog() throws IOException {
        ...
        assertThat(successfulTests).singleElement().extracting(TestCaseResult::name).isEqualTo("Test");
        assertThat(failedTests).isEmpty();
    }
    ...
    void testRootTestsuiteNameIgnored() throws IOException {
        ...
        assertThat(successfulTests).singleElement().extracting(TestCaseResult::name).isEqualTo("Suite.Test");
        assertThat(failedTests).isEmpty();
    }
    ...
    void testMixedNestedTestsuiteTestcase() throws IOException {
        ...
        assertThat(successfulTests).extracting(TestCaseResult::name).containsExactlyInAnyOrder("Test", "Suite.Test");
        assertThat(failedTests).isEmpty();
    }
}
