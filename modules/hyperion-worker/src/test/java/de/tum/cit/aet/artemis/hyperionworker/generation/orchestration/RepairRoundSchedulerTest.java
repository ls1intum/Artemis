...
class RepairRoundSchedulerTest {
    ...
    class FindingDrainAccounting {
        ...
        private RepairRound round(int attempt, SpecFidelityReport.Finding... findings) {
        ...
        void theFirstRoundHasNothingToCarryOverOrDrain() {
            RepairRound first = round(1, finding(SpecFidelityReport.Kind.EXECUTABLE_WEAK_TEST_ORACLE, "a wrong parser passes"));
        ...
        void anUnchangedFindingIsCarriedOverRatherThanCountedTwice() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.EXECUTABLE_WEAK_TEST_ORACLE, "a wrong parser passes"));
        ...
        void aRepairedFindingIsDrainedAndAReplacementIsFresh() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.TEMPLATE_QUALITY_GAP, "the starter has no anchor"));
        ...
        void aRewrittenDetailDoesNotMakeTheSameDefectLookFresh() {
            ...
            RepairRound second = scheduler.recordReviewRound(new SpecFidelityReport(List.of(
        ...
        void casingAndPunctuationDoNotMakeTheSameDefectLookFresh() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.UNCOVERED_REQUIREMENT, "  cjk   graphemes are not counted  "));
        ...
        void aCitedSpecificationRuleLabelDoesNotMakeTheSameDefectLookFresh() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.UNCOVERED_REQUIREMENT, "reverse must handle the empty string"));
        ...
        void theSameRequirementUnderADifferentKindIsADifferentDefect() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.EXECUTABLE_WEAK_TEST_ORACLE, "empty input is rejected"));
        ...
        void aRephrasedFindingIsKnowinglyCountedAsOneDrainedAndOneFresh() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.UNCOVERED_REQUIREMENT, "a surrogate pair counts as two"));
        ...
        void twoRequirementsThatDifferOnlyBeyondTheIdentityBoundAreOneIdentity() {
            ...
            RepairRound second = round(2, finding(SpecFidelityReport.Kind.UNCOVERED_REQUIREMENT, sharedPrefix + "beta"));
    ...
    class RoundMessages {
        ...
        private static RepairRound round(int index, int carriedOver, int drained, int fresh) {
            return new RepairRound(index, index, carriedOver + fresh, 0, carriedOver, drained, fresh);
        }
