...
class SandboxAgentToolsTest {
    ...
    void search_returnsMatchingLinesWithoutDirtyingTheWorkspace() {
        FakeInteractiveSandbox sandbox = FakeInteractiveSandbox.returning(
                new SandboxExecResult(0, "/workspace/problem-statement.md:2:Elevator list is empty\n/workspace/problem-statement.md:3:last Elevator list is empty\n", "", false));
    ...
    void search_acceptsADirectoryPath() {
        FakeInteractiveSandbox sandbox = FakeInteractiveSandbox.returning(new SandboxExecResult(0,
    ...
    void search_acceptsABlankPathAsTheWorkspaceRoot() {
        FakeInteractiveSandbox sandbox = FakeInteractiveSandbox.returning(new SandboxExecResult(0, "/workspace/solution/src/Example.java:4:find me\n", "", false));
    ...
    void deleteFile_removesOnlyGeneratedWorkspaceFiles() {
        FakeInteractiveSandbox sandbox = FakeInteractiveSandbox.returning(new SandboxExecResult(0, "DELETED", "", false));
        SandboxAgentTools tools = new SandboxAgentTools(sandbox, "s");
    ...
    void deleteFile_reportsAnAbsentPathAsANoOp() {
        FakeInteractiveSandbox sandbox = FakeInteractiveSandbox.returning(new SandboxExecResult(0, "ABSENT", "", false));
        SandboxAgentTools tools = new SandboxAgentTools(sandbox, "s");
    ...
    void bash_timeoutFailsBecauseTheSandboxWasTerminated() {
        SandboxAgentTools tools = new SandboxAgentTools(FakeInteractiveSandbox.returning(new SandboxExecResult(-1, "", "", true)), "s");
    ...
    private static SandboxAgentTools stagedTools(InteractiveSandbox sandbox, GenerationInput exercise, StageCheckService stageCheckService) {
