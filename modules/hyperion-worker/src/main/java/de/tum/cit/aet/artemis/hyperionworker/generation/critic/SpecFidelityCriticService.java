...
import static de.tum.cit.aet.artemis.hyperionworker.generation.critic.ReviewGuardrails.MAX_REQUIREMENT_CHARS;
import static de.tum.cit.aet.artemis.hyperionworker.generation.critic.ReviewGuardrails.MAX_REVIEW_FINDINGS;
...
public class SpecFidelityCriticService {
    ...
    public ReferenceWitnessReview adjudicateReferenceWitnesses(String specificationContract, String solutionSources,
            List<de.tum.cit.aet.artemis.hyperionworker.generation.verification.ContractWitnessOutcome> outcomes, @Nullable Consumer<ChatResponse> usageSink,
            BooleanSupplier cancelled) {
