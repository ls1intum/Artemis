...
final class AuthoringStageCapture {
    ...
    record CandidateReadBack(Map<RepositoryRole, GenerationWorkspaceService.RepositoryExtraction> repositories, String problemStatement, @Nullable String testPlanJson) {
    }
    ...
    AuthoringStageCapture(GenerationOrchestrationService service, GenerationWorkspaceService workspace, InteractiveSandbox sandbox, String sessionId,
            ...
            Map<RepositoryRole, Map<String, String>> baselineRepositoryFiles, @Nullable String baselineProblemStatement) {
    ...
    void recordStageBoundary(GenerationStage stage) {
        ...
        try {
            Map<RepositoryRole, Map<String, String>> files = GenerationOrchestrationService.changedCapturedRepositoryFiles(baselineRepositoryFiles,
    ...
    CandidateReadBack readBackCandidate() {
        ...
        try {
            Map<RepositoryRole, GenerationWorkspaceService.RepositoryExtraction> repositories = new EnumMap<>(RepositoryRole.class);
