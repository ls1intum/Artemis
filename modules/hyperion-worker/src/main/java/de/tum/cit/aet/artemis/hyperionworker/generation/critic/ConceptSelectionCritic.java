...
import static de.tum.cit.aet.artemis.hyperionworker.generation.critic.ReviewGuardrails.extractJsonPayload;
import static de.tum.cit.aet.artemis.hyperionworker.generation.critic.ReviewGuardrails.requireReviewTextSafe;
import static de.tum.cit.aet.artemis.hyperionworker.generation.critic.ReviewGuardrails.truncateLearningEvidence;
...
import de.tum.cit.aet.artemis.hyperionworker.generation.critic.SpecFidelityCriticService.ConceptSelectionReview;
...
class ConceptSelectionCritic {
    ...
    ConceptSelectionCritic(ReviewerClient reviewer, JsonMapper objectMapper) {
