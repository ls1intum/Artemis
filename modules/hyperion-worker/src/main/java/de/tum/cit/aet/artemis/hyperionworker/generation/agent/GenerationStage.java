 ...
 * ({@link AgentSystemPromptService#buildStage(de.tum.cit.aet.artemis.hyperionworker.generation.GenerationInput, GenerationStage)}). The orchestrator runs the stages in this
