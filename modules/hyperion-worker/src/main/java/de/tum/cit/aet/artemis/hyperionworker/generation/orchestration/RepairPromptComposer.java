...
final class RepairPromptComposer {
    ...
    RepairPromptComposer(int maxGenerationAttempts, Mode mode, String authoringBrief, SpecFidelityCriticService specFidelityCritic) {
    ...
    String semanticRepair(int completedAttempt, @Nullable String specSnapshot, SemanticRepairBatch batch) {
        String scopeGuidance = mode == Mode.ADAPT ? " Preserve all content outside the requested adaptation." : "";
